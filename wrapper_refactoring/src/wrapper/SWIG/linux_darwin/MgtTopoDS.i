...
class Handle_MgtTopoDS_TranslateTool : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool(const MgtTopoDS_TranslateTool *aHandle);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool(const MgtTopoDS_TranslateTool *anItem);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool & operator=(const MgtTopoDS_TranslateTool *aHandle);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool & operator=(const MgtTopoDS_TranslateTool *anItem);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool const DownCast(const Standard_Transient *AnObject);
...
class Handle_MgtTopoDS_TranslateTool1 : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool1(const MgtTopoDS_TranslateTool1 *aHandle);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool1(const MgtTopoDS_TranslateTool1 *anItem);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool1 & operator=(const MgtTopoDS_TranslateTool1 *aHandle);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool1 & operator=(const MgtTopoDS_TranslateTool1 *anItem);
		%feature("autodoc", "1");
		Handle_MgtTopoDS_TranslateTool1 const DownCast(const Standard_Transient *AnObject);
...
class MgtTopoDS_TranslateTool : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void UpdateShape(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		void UpdateShape(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		virtual		void UpdateWire(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateWire(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		virtual		void UpdateShell(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateShell(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateSolid(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateSolid(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateCompSolid(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateCompSolid(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateCompound(const TopoDS_Shape &S1, const PTopoDS_HShape *S2) const;
		%feature("autodoc", "1");
		virtual		void UpdateCompound(const PTopoDS_HShape *S1, TopoDS_Shape & S2) const;
		%feature("autodoc", "1");
...
class MgtTopoDS {
	public:
		...
		MgtTopoDS();
		%feature("autodoc", "1");
		Handle_PTopoDS_HShape Translate(const TopoDS_Shape &S, const MgtTopoDS_TranslateTool *T, PTColStd_TransientPersistentMap & M);
		%feature("autodoc", "1");
		void Translate(const PTopoDS_HShape *S, const MgtTopoDS_TranslateTool *T, PTColStd_PersistentTransientMap & M, TopoDS_Shape & Sh);
		%feature("autodoc", "1");
		void Translate1(const TopoDS_Shape &aShape, const MgtTopoDS_TranslateTool1 *T, PTColStd_TransientPersistentMap & M, PTopoDS_Shape1 & aPShape);
		%feature("autodoc", "1");
		void Translate1(const PTopoDS_Shape1 &aPShape, const MgtTopoDS_TranslateTool1 *T, PTColStd_PersistentTransientMap & M, TopoDS_Shape & aShape);
