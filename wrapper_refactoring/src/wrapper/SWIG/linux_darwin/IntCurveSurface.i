...
class Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg(const IntCurveSurface_SequenceNodeOfSequenceOfSeg *aHandle);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg(const IntCurveSurface_SequenceNodeOfSequenceOfSeg *anItem);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg & operator=(const IntCurveSurface_SequenceNodeOfSequenceOfSeg *aHandle);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg & operator=(const IntCurveSurface_SequenceNodeOfSequenceOfSeg *anItem);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg const DownCast(const Standard_Transient *AnObject);
...
class Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt(const IntCurveSurface_SequenceNodeOfSequenceOfPnt *aHandle);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt(const IntCurveSurface_SequenceNodeOfSequenceOfPnt *anItem);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt & operator=(const IntCurveSurface_SequenceNodeOfSequenceOfPnt *aHandle);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt & operator=(const IntCurveSurface_SequenceNodeOfSequenceOfPnt *anItem);
		%feature("autodoc", "1");
		Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt const DownCast(const Standard_Transient *AnObject);
...
class IntCurveSurface_HInter : public IntCurveSurface_Intersection {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Adaptor3d_HCurve *Curve, const Adaptor3d_HSurface *Surface);
		%feature("autodoc", "1");
		void Perform(const Adaptor3d_HCurve *Curve, const IntCurveSurface_ThePolygonOfHInter &Polygon, const Adaptor3d_HSurface *Surface);
		%feature("autodoc", "1");
		void Perform(const Adaptor3d_HCurve *Curve, const IntCurveSurface_ThePolygonOfHInter &ThePolygon, const Adaptor3d_HSurface *Surface, const IntCurveSurface_ThePolyhedronOfHInter &Polyhedron);
		%feature("autodoc", "1");
		void Perform(const Adaptor3d_HCurve *Curve, const IntCurveSurface_ThePolygonOfHInter &ThePolygon, const Adaptor3d_HSurface *Surface, const IntCurveSurface_ThePolyhedronOfHInter &Polyhedron, Bnd_BoundSortBox & BndBSB);
		%feature("autodoc", "1");
		void Perform(const Adaptor3d_HCurve *Curve, const Adaptor3d_HSurface *Surface, const IntCurveSurface_ThePolyhedronOfHInter &Polyhedron);
...
class IntCurveSurface_TheQuadCurvExactHInter {
	public:
		%feature("autodoc", "1");
		IntCurveSurface_TheQuadCurvExactHInter(const Adaptor3d_HSurface *S, const Adaptor3d_HCurve *C);
		%feature("autodoc", "1");
		Standard_Boolean IsDone() const;
		%feature("autodoc", "1");
...
class IntCurveSurface_TheHSurfaceTool {
	public:
		...
		%feature("autodoc", "1");
		Handle_Adaptor3d_HSurface BasisSurface(const Adaptor3d_HSurface *S);
		%feature("autodoc", "1");
		Standard_Real OffsetValue(const Adaptor3d_HSurface *S);
		%feature("autodoc", "1");
...
class IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter : public math_FunctionWithDerivative {
	public:
		%feature("autodoc", "1");
		IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter(const IntSurf_Quadric &Q, const Adaptor3d_HCurve *C);
...
class IntCurveSurface_ThePolygonOfHInter {
	public:
		%feature("autodoc", "1");
		IntCurveSurface_ThePolygonOfHInter(const Adaptor3d_HCurve *Curve, const Standard_Integer NbPnt);
		%feature("autodoc", "1");
		IntCurveSurface_ThePolygonOfHInter(const Adaptor3d_HCurve *Curve, const Standard_Real U1, const Standard_Real U2, const Standard_Integer NbPnt);
		%feature("autodoc", "1");
		IntCurveSurface_ThePolygonOfHInter(const Adaptor3d_HCurve *Curve, const TColStd_Array1OfReal &Upars);
		%feature("autodoc", "1");
...
class IntCurveSurface_TheCSFunctionOfHInter : public math_FunctionSetWithDerivatives {
	public:
		%feature("autodoc", "1");
		IntCurveSurface_TheCSFunctionOfHInter(const Adaptor3d_HSurface *S, const Adaptor3d_HCurve *C);
		%feature("autodoc", "1");
...
class IntCurveSurface_TheHCurveTool {
	public:
		...
		%feature("autodoc", "1");
		void SamplePars(const Adaptor3d_HCurve *C, const Standard_Real U0, const Standard_Real U1, const Standard_Real Defl, const Standard_Integer NbMin, Handle_TColStd_HArray1OfReal & Pars);
