...
class Handle_IGESSelect_SignLevelNumber : public Handle_IFSelect_Signature {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SignLevelNumber(const IGESSelect_SignLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignLevelNumber(const IGESSelect_SignLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignLevelNumber & operator=(const IGESSelect_SignLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignLevelNumber & operator=(const IGESSelect_SignLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignLevelNumber const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_FileModifier : public Handle_IFSelect_GeneralModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_FileModifier(const IGESSelect_FileModifier *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_FileModifier(const IGESSelect_FileModifier *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_FileModifier & operator=(const IGESSelect_FileModifier *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_FileModifier & operator=(const IGESSelect_FileModifier *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_FileModifier const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_FloatFormat : public Handle_IGESSelect_FileModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_FloatFormat(const IGESSelect_FloatFormat *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_FloatFormat(const IGESSelect_FloatFormat *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_FloatFormat & operator=(const IGESSelect_FloatFormat *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_FloatFormat & operator=(const IGESSelect_FloatFormat *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_FloatFormat const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SplineToBSpline : public Handle_IFSelect_Transformer {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SplineToBSpline(const IGESSelect_SplineToBSpline *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SplineToBSpline(const IGESSelect_SplineToBSpline *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SplineToBSpline & operator=(const IGESSelect_SplineToBSpline *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SplineToBSpline & operator=(const IGESSelect_SplineToBSpline *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SplineToBSpline const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_ModelModifier : public Handle_IFSelect_Modifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_ModelModifier(const IGESSelect_ModelModifier *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ModelModifier(const IGESSelect_ModelModifier *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ModelModifier & operator=(const IGESSelect_ModelModifier *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ModelModifier & operator=(const IGESSelect_ModelModifier *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ModelModifier const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_ChangeLevelList : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelList(const IGESSelect_ChangeLevelList *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelList(const IGESSelect_ChangeLevelList *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelList & operator=(const IGESSelect_ChangeLevelList *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelList & operator=(const IGESSelect_ChangeLevelList *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelList const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_UpdateCreationDate : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateCreationDate(const IGESSelect_UpdateCreationDate *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateCreationDate(const IGESSelect_UpdateCreationDate *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateCreationDate & operator=(const IGESSelect_UpdateCreationDate *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateCreationDate & operator=(const IGESSelect_UpdateCreationDate *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateCreationDate const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectPCurves : public Handle_IFSelect_SelectExplore {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectPCurves(const IGESSelect_SelectPCurves *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectPCurves(const IGESSelect_SelectPCurves *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectPCurves & operator=(const IGESSelect_SelectPCurves *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectPCurves & operator=(const IGESSelect_SelectPCurves *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectPCurves const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectVisibleStatus : public Handle_IFSelect_SelectExtract {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectVisibleStatus(const IGESSelect_SelectVisibleStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectVisibleStatus(const IGESSelect_SelectVisibleStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectVisibleStatus & operator=(const IGESSelect_SelectVisibleStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectVisibleStatus & operator=(const IGESSelect_SelectVisibleStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectVisibleStatus const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SetGlobalParameter : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SetGlobalParameter(const IGESSelect_SetGlobalParameter *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetGlobalParameter(const IGESSelect_SetGlobalParameter *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetGlobalParameter & operator=(const IGESSelect_SetGlobalParameter *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetGlobalParameter & operator=(const IGESSelect_SetGlobalParameter *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetGlobalParameter const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_WorkLibrary : public Handle_IFSelect_WorkLibrary {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_WorkLibrary(const IGESSelect_WorkLibrary *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_WorkLibrary(const IGESSelect_WorkLibrary *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_WorkLibrary & operator=(const IGESSelect_WorkLibrary *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_WorkLibrary & operator=(const IGESSelect_WorkLibrary *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_WorkLibrary const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectName : public Handle_IFSelect_SelectExtract {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectName(const IGESSelect_SelectName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectName(const IGESSelect_SelectName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectName & operator=(const IGESSelect_SelectName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectName & operator=(const IGESSelect_SelectName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectName const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_IGESTypeForm : public Handle_IFSelect_Signature {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESTypeForm(const IGESSelect_IGESTypeForm *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESTypeForm(const IGESSelect_IGESTypeForm *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESTypeForm & operator=(const IGESSelect_IGESTypeForm *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESTypeForm & operator=(const IGESSelect_IGESTypeForm *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESTypeForm const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_ChangeLevelNumber : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelNumber(const IGESSelect_ChangeLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelNumber(const IGESSelect_ChangeLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelNumber & operator=(const IGESSelect_ChangeLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelNumber & operator=(const IGESSelect_ChangeLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ChangeLevelNumber const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectFromSingleView : public Handle_IFSelect_SelectDeduct {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromSingleView(const IGESSelect_SelectFromSingleView *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromSingleView(const IGESSelect_SelectFromSingleView *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromSingleView & operator=(const IGESSelect_SelectFromSingleView *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromSingleView & operator=(const IGESSelect_SelectFromSingleView *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromSingleView const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectLevelNumber : public Handle_IFSelect_SelectExtract {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectLevelNumber(const IGESSelect_SelectLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectLevelNumber(const IGESSelect_SelectLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectLevelNumber & operator=(const IGESSelect_SelectLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectLevelNumber & operator=(const IGESSelect_SelectLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectLevelNumber const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_UpdateFileName : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateFileName(const IGESSelect_UpdateFileName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateFileName(const IGESSelect_UpdateFileName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateFileName & operator=(const IGESSelect_UpdateFileName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateFileName & operator=(const IGESSelect_UpdateFileName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateFileName const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_RemoveCurves : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_RemoveCurves(const IGESSelect_RemoveCurves *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RemoveCurves(const IGESSelect_RemoveCurves *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RemoveCurves & operator=(const IGESSelect_RemoveCurves *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RemoveCurves & operator=(const IGESSelect_RemoveCurves *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RemoveCurves const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectSingleViewFrom : public Handle_IFSelect_SelectDeduct {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSingleViewFrom(const IGESSelect_SelectSingleViewFrom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSingleViewFrom(const IGESSelect_SelectSingleViewFrom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSingleViewFrom & operator=(const IGESSelect_SelectSingleViewFrom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSingleViewFrom & operator=(const IGESSelect_SelectSingleViewFrom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSingleViewFrom const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_EditHeader : public Handle_IFSelect_Editor {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_EditHeader(const IGESSelect_EditHeader *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditHeader(const IGESSelect_EditHeader *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditHeader & operator=(const IGESSelect_EditHeader *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditHeader & operator=(const IGESSelect_EditHeader *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditHeader const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_ComputeStatus : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_ComputeStatus(const IGESSelect_ComputeStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ComputeStatus(const IGESSelect_ComputeStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ComputeStatus & operator=(const IGESSelect_ComputeStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ComputeStatus & operator=(const IGESSelect_ComputeStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ComputeStatus const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_RebuildDrawings : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildDrawings(const IGESSelect_RebuildDrawings *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildDrawings(const IGESSelect_RebuildDrawings *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildDrawings & operator=(const IGESSelect_RebuildDrawings *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildDrawings & operator=(const IGESSelect_RebuildDrawings *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildDrawings const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectFromDrawing : public Handle_IFSelect_SelectDeduct {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromDrawing(const IGESSelect_SelectFromDrawing *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromDrawing(const IGESSelect_SelectFromDrawing *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromDrawing & operator=(const IGESSelect_SelectFromDrawing *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromDrawing & operator=(const IGESSelect_SelectFromDrawing *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFromDrawing const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_Dumper : public Handle_IFSelect_SessionDumper {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_Dumper(const IGESSelect_Dumper *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_Dumper(const IGESSelect_Dumper *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_Dumper & operator=(const IGESSelect_Dumper *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_Dumper & operator=(const IGESSelect_Dumper *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_Dumper const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_CounterOfLevelNumber : public Handle_IFSelect_SignCounter {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_CounterOfLevelNumber(const IGESSelect_CounterOfLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_CounterOfLevelNumber(const IGESSelect_CounterOfLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_CounterOfLevelNumber & operator=(const IGESSelect_CounterOfLevelNumber *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_CounterOfLevelNumber & operator=(const IGESSelect_CounterOfLevelNumber *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_CounterOfLevelNumber const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SetLabel : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SetLabel(const IGESSelect_SetLabel *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetLabel(const IGESSelect_SetLabel *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetLabel & operator=(const IGESSelect_SetLabel *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetLabel & operator=(const IGESSelect_SetLabel *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetLabel const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_EditDirPart : public Handle_IFSelect_Editor {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_EditDirPart(const IGESSelect_EditDirPart *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditDirPart(const IGESSelect_EditDirPart *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditDirPart & operator=(const IGESSelect_EditDirPart *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditDirPart & operator=(const IGESSelect_EditDirPart *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_EditDirPart const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectBypassSubfigure : public Handle_IFSelect_SelectExplore {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassSubfigure(const IGESSelect_SelectBypassSubfigure *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassSubfigure(const IGESSelect_SelectBypassSubfigure *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassSubfigure & operator=(const IGESSelect_SelectBypassSubfigure *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassSubfigure & operator=(const IGESSelect_SelectBypassSubfigure *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassSubfigure const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectBasicGeom : public Handle_IFSelect_SelectExplore {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBasicGeom(const IGESSelect_SelectBasicGeom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBasicGeom(const IGESSelect_SelectBasicGeom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBasicGeom & operator=(const IGESSelect_SelectBasicGeom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBasicGeom & operator=(const IGESSelect_SelectBasicGeom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBasicGeom const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_DispPerDrawing : public Handle_IFSelect_Dispatch {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerDrawing(const IGESSelect_DispPerDrawing *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerDrawing(const IGESSelect_DispPerDrawing *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerDrawing & operator=(const IGESSelect_DispPerDrawing *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerDrawing & operator=(const IGESSelect_DispPerDrawing *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerDrawing const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_AddFileComment : public Handle_IGESSelect_FileModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_AddFileComment(const IGESSelect_AddFileComment *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddFileComment(const IGESSelect_AddFileComment *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddFileComment & operator=(const IGESSelect_AddFileComment *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddFileComment & operator=(const IGESSelect_AddFileComment *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddFileComment const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_ViewSorter : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_ViewSorter(const IGESSelect_ViewSorter *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ViewSorter(const IGESSelect_ViewSorter *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ViewSorter & operator=(const IGESSelect_ViewSorter *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_ViewSorter & operator=(const IGESSelect_ViewSorter *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_ViewSorter const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectFaces : public Handle_IFSelect_SelectExplore {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFaces(const IGESSelect_SelectFaces *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFaces(const IGESSelect_SelectFaces *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFaces & operator=(const IGESSelect_SelectFaces *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFaces & operator=(const IGESSelect_SelectFaces *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectFaces const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SetVersion5 : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SetVersion5(const IGESSelect_SetVersion5 *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetVersion5(const IGESSelect_SetVersion5 *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetVersion5 & operator=(const IGESSelect_SetVersion5 *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetVersion5 & operator=(const IGESSelect_SetVersion5 *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SetVersion5 const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectSubordinate : public Handle_IFSelect_SelectExtract {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSubordinate(const IGESSelect_SelectSubordinate *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSubordinate(const IGESSelect_SelectSubordinate *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSubordinate & operator=(const IGESSelect_SelectSubordinate *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSubordinate & operator=(const IGESSelect_SelectSubordinate *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectSubordinate const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_IGESName : public Handle_IFSelect_Signature {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESName(const IGESSelect_IGESName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESName(const IGESSelect_IGESName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESName & operator=(const IGESSelect_IGESName *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESName & operator=(const IGESSelect_IGESName *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_IGESName const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_AddGroup : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_AddGroup(const IGESSelect_AddGroup *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddGroup(const IGESSelect_AddGroup *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddGroup & operator=(const IGESSelect_AddGroup *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddGroup & operator=(const IGESSelect_AddGroup *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AddGroup const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_DispPerSingleView : public Handle_IFSelect_Dispatch {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerSingleView(const IGESSelect_DispPerSingleView *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerSingleView(const IGESSelect_DispPerSingleView *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerSingleView & operator=(const IGESSelect_DispPerSingleView *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerSingleView & operator=(const IGESSelect_DispPerSingleView *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_DispPerSingleView const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectBypassGroup : public Handle_IFSelect_SelectExplore {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassGroup(const IGESSelect_SelectBypassGroup *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassGroup(const IGESSelect_SelectBypassGroup *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassGroup & operator=(const IGESSelect_SelectBypassGroup *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassGroup & operator=(const IGESSelect_SelectBypassGroup *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectBypassGroup const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_RebuildGroups : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildGroups(const IGESSelect_RebuildGroups *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildGroups(const IGESSelect_RebuildGroups *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildGroups & operator=(const IGESSelect_RebuildGroups *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildGroups & operator=(const IGESSelect_RebuildGroups *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_RebuildGroups const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SignStatus : public Handle_IFSelect_Signature {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SignStatus(const IGESSelect_SignStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignStatus(const IGESSelect_SignStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignStatus & operator=(const IGESSelect_SignStatus *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignStatus & operator=(const IGESSelect_SignStatus *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignStatus const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SignColor : public Handle_IFSelect_Signature {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SignColor(const IGESSelect_SignColor *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignColor(const IGESSelect_SignColor *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignColor & operator=(const IGESSelect_SignColor *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignColor & operator=(const IGESSelect_SignColor *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SignColor const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_AutoCorrect : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_AutoCorrect(const IGESSelect_AutoCorrect *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AutoCorrect(const IGESSelect_AutoCorrect *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AutoCorrect & operator=(const IGESSelect_AutoCorrect *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_AutoCorrect & operator=(const IGESSelect_AutoCorrect *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_AutoCorrect const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_Activator : public Handle_IFSelect_Activator {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_Activator(const IGESSelect_Activator *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_Activator(const IGESSelect_Activator *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_Activator & operator=(const IGESSelect_Activator *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_Activator & operator=(const IGESSelect_Activator *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_Activator const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_UpdateLastChange : public Handle_IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateLastChange(const IGESSelect_UpdateLastChange *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateLastChange(const IGESSelect_UpdateLastChange *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateLastChange & operator=(const IGESSelect_UpdateLastChange *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateLastChange & operator=(const IGESSelect_UpdateLastChange *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_UpdateLastChange const DownCast(const Standard_Transient *AnObject);
...
class Handle_IGESSelect_SelectDrawingFrom : public Handle_IFSelect_SelectDeduct {
	public:
		...
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectDrawingFrom(const IGESSelect_SelectDrawingFrom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectDrawingFrom(const IGESSelect_SelectDrawingFrom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectDrawingFrom & operator=(const IGESSelect_SelectDrawingFrom *aHandle);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectDrawingFrom & operator=(const IGESSelect_SelectDrawingFrom *anItem);
		%feature("autodoc", "1");
		Handle_IGESSelect_SelectDrawingFrom const DownCast(const Standard_Transient *AnObject);
...
class IGESSelect_ModelModifier : public IFSelect_Modifier {
	public:
		...
		%feature("autodoc", "1");
		virtual		void PerformProtocol(IFSelect_ContextModif & ctx, const IGESData_IGESModel *target, const IGESData_Protocol *proto, Interface_CopyTool & TC) const;
		%feature("autodoc", "1");
		virtual		void Performing(IFSelect_ContextModif & ctx, const IGESData_IGESModel *target, Interface_CopyTool & TC) const;
		%feature("autodoc", "1");
...
class IGESSelect_ChangeLevelNumber : public IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		void SetOldNumber(const IFSelect_IntParam *param);
		%feature("autodoc", "1");
		Handle_IFSelect_IntParam NewNumber() const;
		%feature("autodoc", "1");
		void SetNewNumber(const IFSelect_IntParam *param);
		%feature("autodoc", "1");
		virtual		void Performing(IFSelect_ContextModif & ctx, const IGESData_IGESModel *target, Interface_CopyTool & TC) const;
		%feature("autodoc", "1");
		virtual		TCollection_AsciiString Label() const;
...
class IGESSelect_SetGlobalParameter : public IGESSelect_ModelModifier {
	public:
		...
		%feature("autodoc", "1");
		void SetValue(const TCollection_HAsciiString *text);
		%feature("autodoc", "1");
...
class IGESSelect_ViewSorter : public MMgt_TShared {
	public:
		...
		void Clear();
		%feature("autodoc", "1");
		Standard_Boolean Add(const Standard_Transient *ent);
		%feature("autodoc", "1");
		Standard_Boolean AddEntity(const IGESData_IGESEntity *igesent);
		%feature("autodoc", "1");
...
class IGESSelect_CounterOfLevelNumber : public IFSelect_SignCounter {
	public:
		...
		%feature("autodoc", "1");
		void AddLevel(const Standard_Transient *ent, const Standard_Integer level);
		%feature("autodoc", "1");
...
class IGESSelect {
	public:
		...
		Standard_Integer WhatIges(const IGESData_IGESEntity *ent, const Interface_Graph &G, Handle_IGESData_IGESEntity & sup, Standard_Integer &OutValue);
...
class IGESSelect_SelectBasicGeom : public IFSelect_SelectExplore {
	public:
		...
		virtual		TCollection_AsciiString ExploreLabel() const;
		%feature("autodoc", "1");
		Standard_Boolean SubCurves(const IGESData_IGESEntity *ent, Interface_EntityIterator & explored);
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
...
class IGESSelect_AddFileComment : public IGESSelect_FileModifier {
	public:
		...
		%feature("autodoc", "1");
		void AddLines(const TColStd_HSequenceOfHAsciiString *lines);
		%feature("autodoc", "1");
...
class IGESSelect_SelectLevelNumber : public IFSelect_SelectExtract {
	public:
		...
		%feature("autodoc", "1");
		void SetLevelNumber(const IFSelect_IntParam *levnum);
		%feature("autodoc", "1");
