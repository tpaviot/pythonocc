...
typedef int (*Aspect_TransactionCallbackProc)(
  cbReason  /* call data */,
  void*     /* user data */
);
...
Standard_EXPORT void SetTransactionCallBack(const Aspect_TransactionCallbackProc& aCB,const Standard_Address aClientData);
...
Aspect_TransactionCallbackProc myCB;
