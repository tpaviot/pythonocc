...
%extend IGESGeom_Array1OfCurveOnSurface {
	...
	printf("Call custom destructor for instance of IGESGeom_Array1OfCurveOnSurface\n");
	}
};
...
%extend IGESGeom {
	~IGESGeom() {
	printf("Call custom destructor for instance of IGESGeom\n");
	}
};
...
%extend IGESGeom_Array1OfBoundary {
	...
	printf("Call custom destructor for instance of IGESGeom_Array1OfBoundary\n");
	}
};
...
%extend IGESGeom_Array1OfTransformationMatrix {
	...
	printf("Call custom destructor for instance of IGESGeom_Array1OfTransformationMatrix\n");
	}
};
