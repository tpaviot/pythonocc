...
""" This module enable the parameterization of basic topologies:
vertices, edges, faces. This module
uses the Topology module and aims at being able to transfer dumb OCC
topology to smart PAF topology.
"""
...
def vertex_to_paf(parameters, vertex):
    ...
    @param parameters: the set of parameters in which the vertex has to
    be transfered
    ...
    x, y, z = pnt.Coord()
    # Create 3 parameters. The name of each parameter is set up according to
    # the pnt id in order
    # to be *sure* (is it the case with the id function?) to have unique
    # identifiers for parameters
    # For instance, passing a vertex to this function will result in the
    # creation of 3 parameters:
    # x_4500056400
    # y_4500056400
    # z_4500056400
...
def edge_to_paf(parameters, edge):
    ...
    for vertex in vertices:
        ...
        # TODO: algorithm is not good. One should move only vertices that were
        # not already moved.
...
def geomobject_from_topods(my_context, topods_shape):
    """
    adds a TopoDS_Shape *topods_shape* the the ParametricModelingContext
    *paf_context*
...
if __name__ == '__main__':
    ...
    p = Parameters()
    # Create and initialize a parametric contex
    ...
    # Move each edge to the PAF. Uncomment the 2 lines below
    # and you will see a parameterized box (only vertices
    # and edges)
    for edge in t.edges():
        edge_to_paf(p, edge)
