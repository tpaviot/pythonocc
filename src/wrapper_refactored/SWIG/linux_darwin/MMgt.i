...
class Handle_MMgt_TShared : public Handle_Standard_Transient {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_MMgt_TShared & assign(const Handle_MMgt_TShared & aHandle);
        %feature("autodoc", "1");
        const Handle_MMgt_TShared & assign(const MMgt_TShared * anItem);
        %feature("autodoc", "1");
...
class MMgt_StackManager  {
    public:
        %feature("autodoc", "1");
        MMgt_StackManager(const MMgt_StackManager & arg0);
        %feature("autodoc", "1");
        MMgt_StackManager();
        %feature("autodoc", "1");
...
class MMgt_TShared : public Standard_Transient {
    public:
        %feature("autodoc", "1");
        MMgt_TShared(const MMgt_TShared & arg0);
        %feature("autodoc", "1");
        MMgt_TShared();
        %feature("autodoc", "1");
