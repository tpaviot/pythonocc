...
class TCollection_AsciiString  {
    public:
        ...
        %feature("autodoc", "1");
        void assign(const char * fromwhere);
        %feature("autodoc", "1");
        void Copy(const TCollection_AsciiString & fromwhere);
        %feature("autodoc", "1");
        void assign(const TCollection_AsciiString & fromwhere);
        %feature("autodoc", "1");
        void Destroy();
        %feature("autodoc", "1");
...
class Handle_TCollection_SeqNode : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_TCollection_SeqNode & assign(const Handle_TCollection_SeqNode & aHandle);
        %feature("autodoc", "1");
        const Handle_TCollection_SeqNode & assign(const TCollection_SeqNode * anItem);
        %feature("autodoc", "1");
...
class TCollection_MapNode : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        TCollection_MapNode(const TCollection_MapNode & arg0);
        %feature("autodoc", "1");
        TCollection_MapNode(const TCollection_MapNodePtr & n);
        %feature("autodoc", "1");
        const TCollection_MapNodePtr & Next() const;
        %feature("autodoc", "1");
...
class TCollection_PrivCompareOfInteger  {
    public:
        %feature("autodoc", "1");
        TCollection_PrivCompareOfInteger(const TCollection_PrivCompareOfInteger & arg0);
        %feature("autodoc", "1");
...
class TCollection_BasicMapIterator  {
    public:
        %feature("autodoc", "1");
        TCollection_BasicMapIterator(const TCollection_BasicMapIterator & arg0);
        %feature("autodoc", "1");
        void Reset();
        %feature("autodoc", "1");
...
class TCollection_ExtendedString  {
    public:
        ...
        %feature("autodoc", "1");
        void assign(const TCollection_ExtendedString & fromwhere);
        %feature("autodoc", "1");
        void Destroy();
        %feature("autodoc", "1");
...
class TCollection_Array2Descriptor  {
    public:
        %feature("autodoc", "1");
        TCollection_Array2Descriptor(const TCollection_Array2Descriptor & arg0);
        %feature("autodoc", "1");
...
class Handle_TCollection_HAsciiString : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_TCollection_HAsciiString & assign(const Handle_TCollection_HAsciiString & aHandle);
        %feature("autodoc", "1");
        const Handle_TCollection_HAsciiString & assign(const TCollection_HAsciiString * anItem);
        %feature("autodoc", "1");
...
class TCollection_HExtendedString : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        TCollection_HExtendedString(const TCollection_HExtendedString & arg0);
        %feature("autodoc", "1");
...
class Handle_TCollection_AVLBaseNode : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_TCollection_AVLBaseNode & assign(const Handle_TCollection_AVLBaseNode & aHandle);
        %feature("autodoc", "1");
        const Handle_TCollection_AVLBaseNode & assign(const TCollection_AVLBaseNode * anItem);
        %feature("autodoc", "1");
...
class Handle_TCollection_MapNode : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_TCollection_MapNode & assign(const Handle_TCollection_MapNode & aHandle);
        %feature("autodoc", "1");
        const Handle_TCollection_MapNode & assign(const TCollection_MapNode * anItem);
        %feature("autodoc", "1");
...
class TCollection_Array1Descriptor  {
    public:
        %feature("autodoc", "1");
        TCollection_Array1Descriptor(const TCollection_Array1Descriptor & arg0);
        %feature("autodoc", "1");
...
class TCollection  {
    public:
        %feature("autodoc", "1");
        TCollection(const TCollection & arg0);
        %feature("autodoc", "1");
        TCollection();
        %feature("autodoc", "1");
...
class Handle_TCollection_HExtendedString : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_TCollection_HExtendedString & assign(const Handle_TCollection_HExtendedString & aHandle);
        %feature("autodoc", "1");
        const Handle_TCollection_HExtendedString & assign(const TCollection_HExtendedString * anItem);
        %feature("autodoc", "1");
...
class TCollection_AVLBaseNode : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        TCollection_AVLBaseNode(const TCollection_AVLBaseNode & arg0);
        %feature("autodoc", "1");
        ...
        %feature("autodoc", "1");
        const TCollection_AVLBaseNodePtr & Right() const;
        %feature("autodoc", "1");
        const TCollection_AVLBaseNodePtr & Left() const;
        %feature("autodoc","1");
        %extend {
            const Standard_Integer   GetCount(){ 
               return (const Standard_Integer  ) $self->Count(); 
            }
        };
        %feature("autodoc","1");
        %extend {
            void SetCount(const Standard_Integer   value ){ 
               $self->Count() = value; 
            }
        };
        %feature("autodoc", "1");
...
class TCollection_CompareOfReal : public TCollection_PrivCompareOfReal {
    public:
        %feature("autodoc", "1");
        TCollection_CompareOfReal(const TCollection_CompareOfReal & arg0);
        %feature("autodoc", "1");
...
class TCollection_SeqNode : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        TCollection_SeqNode(const TCollection_SeqNode & arg0);
        %feature("autodoc", "1");
        TCollection_SeqNode(const TCollection_SeqNodePtr & n, const TCollection_SeqNodePtr & p);
        %feature("autodoc", "1");
        const TCollection_SeqNodePtr & Next() const;
        %feature("autodoc", "1");
        const TCollection_SeqNodePtr & Previous() const;
        %feature("autodoc", "1");
        virtual Handle_Standard_Type const & DynamicType() const; 
};
...
class TCollection_PrivCompareOfReal  {
    public:
        %feature("autodoc", "1");
        TCollection_PrivCompareOfReal(const TCollection_PrivCompareOfReal & arg0);
        %feature("autodoc", "1");
...
class TCollection_BasicMap  {
    public:
        %feature("autodoc", "1");
        TCollection_BasicMap(const TCollection_BasicMap & arg0);
        %feature("autodoc", "1");
...
class TCollection_CompareOfInteger : public TCollection_PrivCompareOfInteger {
    public:
        %feature("autodoc", "1");
        TCollection_CompareOfInteger(const TCollection_CompareOfInteger & arg0);
        %feature("autodoc", "1");
...
class TCollection_HAsciiString : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        TCollection_HAsciiString(const TCollection_HAsciiString & arg0);
        %feature("autodoc", "1");
