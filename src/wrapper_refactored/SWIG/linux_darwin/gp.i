...
class gp_Mat2d  {
    public:
        ...
        %feature("autodoc","1");
        %extend {
            const Standard_Real   Get_CSFDB_Getgp_Mat2dmatrix(const Standard_Integer i1, const Standard_Integer i2){ 
               return (const Standard_Real  ) $self->_CSFDB_Getgp_Mat2dmatrix(i1, i2); 
            }
        };
        %feature("autodoc","1");
        %extend {
            void Set_CSFDB_Getgp_Mat2dmatrix(const Standard_Real   value, const Standard_Integer i1, const Standard_Integer i2){ 
...
class Handle_gp_VectorWithNullMagnitude : public Handle_Standard_DomainError {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_gp_VectorWithNullMagnitude & assign(const Handle_gp_VectorWithNullMagnitude & aHandle);
        %feature("autodoc", "1");
        const Handle_gp_VectorWithNullMagnitude & assign(const gp_VectorWithNullMagnitude * anItem);
        %feature("autodoc", "1");
...
class gp_Mat  {
    public:
        ...
        %feature("autodoc","1");
        %extend {
            const Standard_Real   Get_CSFDB_Getgp_Matmatrix(const Standard_Integer i1, const Standard_Integer i2){ 
               return (const Standard_Real  ) $self->_CSFDB_Getgp_Matmatrix(i1, i2); 
            }
        };
        %feature("autodoc","1");
        %extend {
            void Set_CSFDB_Getgp_Matmatrix(const Standard_Real   value, const Standard_Integer i1, const Standard_Integer i2){ 
...
class gp_GTrsf  {
    public:
        ...
        Standard_Real Value(const Standard_Integer Row, const Standard_Integer Col) const;
        %feature("autodoc", "1");
        Standard_Real __call__(const Standard_Integer Row, const Standard_Integer Col) const;
        %feature("autodoc", "1");
        void Invert();
        %feature("autodoc", "1");
