...
class Handle_Geom_UndefinedValue : public Handle_Standard_DomainError {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_UndefinedValue & assign(const Handle_Geom_UndefinedValue & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_UndefinedValue & assign(const Geom_UndefinedValue * anItem);
        %feature("autodoc", "1");
        static const Handle_Geom_UndefinedValue  DownCast(const Handle_Standard_Transient & AnObject); 
};
...
class Handle_Geom_VectorWithMagnitude : public Handle_Geom_Vector {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_VectorWithMagnitude & assign(const Handle_Geom_VectorWithMagnitude & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_VectorWithMagnitude & assign(const Geom_VectorWithMagnitude * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Axis1Placement : public Handle_Geom_AxisPlacement {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Axis1Placement & assign(const Handle_Geom_Axis1Placement & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Axis1Placement & assign(const Geom_Axis1Placement * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Vector : public Handle_Geom_Geometry {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Vector & assign(const Handle_Geom_Vector & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Vector & assign(const Geom_Vector * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Transformation : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Transformation & assign(const Handle_Geom_Transformation & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Transformation & assign(const Geom_Transformation * anItem);
        %feature("autodoc", "1");
...
class Geom_SequenceNodeOfSequenceOfSurface : public TCollection_SeqNode {
    public:
        %feature("autodoc", "1");
        Geom_SequenceNodeOfSequenceOfSurface(const Geom_SequenceNodeOfSequenceOfSurface & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_RectangularTrimmedSurface : public Handle_Geom_BoundedSurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_RectangularTrimmedSurface & assign(const Handle_Geom_RectangularTrimmedSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_RectangularTrimmedSurface & assign(const Geom_RectangularTrimmedSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_SurfaceOfLinearExtrusion : public Geom_SweptSurface {
    public:
        %feature("autodoc", "1");
        Geom_SurfaceOfLinearExtrusion(const Geom_SurfaceOfLinearExtrusion & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Point : public Handle_Geom_Geometry {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Point & assign(const Handle_Geom_Point & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Point & assign(const Geom_Point * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_ConicalSurface : public Handle_Geom_ElementarySurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_ConicalSurface & assign(const Handle_Geom_ConicalSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_ConicalSurface & assign(const Geom_ConicalSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_SurfaceOfRevolution : public Geom_SweptSurface {
    public:
        %feature("autodoc", "1");
        Geom_SurfaceOfRevolution(const Geom_SurfaceOfRevolution & arg0);
        %feature("autodoc", "1");
...
class Geom_Circle : public Geom_Conic {
    public:
        %feature("autodoc", "1");
        Geom_Circle(const Geom_Circle & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_SphericalSurface : public Handle_Geom_ElementarySurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SphericalSurface & assign(const Handle_Geom_SphericalSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SphericalSurface & assign(const Geom_SphericalSurface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_CartesianPoint : public Handle_Geom_Point {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_CartesianPoint & assign(const Handle_Geom_CartesianPoint & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_CartesianPoint & assign(const Geom_CartesianPoint * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_BSplineSurface : public Handle_Geom_BoundedSurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BSplineSurface & assign(const Handle_Geom_BSplineSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BSplineSurface & assign(const Geom_BSplineSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_BezierCurve : public Geom_BoundedCurve {
    public:
        %feature("autodoc", "1");
        Geom_BezierCurve(const Geom_BezierCurve & arg0);
        %feature("autodoc", "1");
...
class Geom_Ellipse : public Geom_Conic {
    public:
        %feature("autodoc", "1");
        Geom_Ellipse(const Geom_Ellipse & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_CylindricalSurface : public Handle_Geom_ElementarySurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_CylindricalSurface & assign(const Handle_Geom_CylindricalSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_CylindricalSurface & assign(const Geom_CylindricalSurface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Conic : public Handle_Geom_Curve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Conic & assign(const Handle_Geom_Conic & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Conic & assign(const Geom_Conic * anItem);
        %feature("autodoc", "1");
...
class Geom_SequenceNodeOfSequenceOfBSplineSurface : public TCollection_SeqNode {
    public:
        %feature("autodoc", "1");
        Geom_SequenceNodeOfSequenceOfBSplineSurface(const Geom_SequenceNodeOfSequenceOfBSplineSurface & arg0);
        %feature("autodoc", "1");
...
class Geom_Curve : public Geom_Geometry {
    public:
        %feature("autodoc", "1");
        Geom_Curve(const Geom_Curve & arg0);
        %feature("autodoc", "1");
        Geom_Curve();
        %feature("autodoc", "1");
        virtual void Reverse();
...
class Geom_BoundedSurface : public Geom_Surface {
    public:
        %feature("autodoc", "1");
        Geom_BoundedSurface(const Geom_BoundedSurface & arg0);
        %feature("autodoc", "1");
        Geom_BoundedSurface();
        %feature("autodoc", "1");
        virtual Handle_Standard_Type const & DynamicType() const; 
...
class Handle_Geom_BezierSurface : public Handle_Geom_BoundedSurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BezierSurface & assign(const Handle_Geom_BezierSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BezierSurface & assign(const Geom_BezierSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_SphericalSurface : public Geom_ElementarySurface {
    public:
        %feature("autodoc", "1");
        Geom_SphericalSurface(const Geom_SphericalSurface & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Direction : public Handle_Geom_Vector {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Direction & assign(const Handle_Geom_Direction & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Direction & assign(const Geom_Direction * anItem);
        %feature("autodoc", "1");
...
class Geom_Geometry : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        Geom_Geometry(const Geom_Geometry & arg0);
        %feature("autodoc", "1");
        Geom_Geometry();
        %feature("autodoc", "1");
...
class Geom_Axis2Placement : public Geom_AxisPlacement {
    public:
        %feature("autodoc", "1");
        Geom_Axis2Placement(const Geom_Axis2Placement & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_BoundedCurve : public Handle_Geom_Curve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BoundedCurve & assign(const Handle_Geom_BoundedCurve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BoundedCurve & assign(const Geom_BoundedCurve * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_HSequenceOfSurface : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_HSequenceOfSurface & assign(const Handle_Geom_HSequenceOfSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_HSequenceOfSurface & assign(const Geom_HSequenceOfSurface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_BezierCurve : public Handle_Geom_BoundedCurve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BezierCurve & assign(const Handle_Geom_BezierCurve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BezierCurve & assign(const Geom_BezierCurve * anItem);
        %feature("autodoc", "1");
...
class Geom_Vector : public Geom_Geometry {
    public:
        %feature("autodoc", "1");
        Geom_Vector(const Geom_Vector & arg0);
        %feature("autodoc", "1");
        Geom_Vector();
        %feature("autodoc", "1");
        void Reverse();
...
class Geom_Parabola : public Geom_Conic {
    public:
        %feature("autodoc", "1");
        Geom_Parabola(const Geom_Parabola & arg0);
        %feature("autodoc", "1");
...
class Geom_Transformation : public MMgt_TShared {
    public:
        %feature("autodoc", "1");
        Geom_Transformation(const Geom_Transformation & arg0);
        %feature("autodoc", "1");
        Geom_Transformation();
        %feature("autodoc", "1");
...
class Geom_Hyperbola : public Geom_Conic {
    public:
        %feature("autodoc", "1");
        Geom_Hyperbola(const Geom_Hyperbola & arg0);
        %feature("autodoc", "1");
...
class Geom_CartesianPoint : public Geom_Point {
    public:
        %feature("autodoc", "1");
        Geom_CartesianPoint(const Geom_CartesianPoint & arg0);
        %feature("autodoc", "1");
...
class Geom_BoundedCurve : public Geom_Curve {
    public:
        %feature("autodoc", "1");
        Geom_BoundedCurve(const Geom_BoundedCurve & arg0);
        %feature("autodoc", "1");
        Geom_BoundedCurve();
        %feature("autodoc", "1");
        virtual gp_Pnt EndPoint() const;
...
class Handle_Geom_Axis2Placement : public Handle_Geom_AxisPlacement {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Axis2Placement & assign(const Handle_Geom_Axis2Placement & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Axis2Placement & assign(const Geom_Axis2Placement * anItem);
        %feature("autodoc", "1");
...
class Geom_ConicalSurface : public Geom_ElementarySurface {
    public:
        %feature("autodoc", "1");
        Geom_ConicalSurface(const Geom_ConicalSurface & arg0);
        %feature("autodoc", "1");
...
class Geom_RectangularTrimmedSurface : public Geom_BoundedSurface {
    public:
        %feature("autodoc", "1");
        Geom_RectangularTrimmedSurface(const Geom_RectangularTrimmedSurface & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Geometry : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Geometry & assign(const Handle_Geom_Geometry & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Geometry & assign(const Geom_Geometry * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Surface : public Handle_Geom_Geometry {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Surface & assign(const Handle_Geom_Surface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Surface & assign(const Geom_Surface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_Plane : public Handle_Geom_ElementarySurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Plane & assign(const Handle_Geom_Plane & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Plane & assign(const Geom_Plane * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_SurfaceOfRevolution : public Handle_Geom_SweptSurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SurfaceOfRevolution & assign(const Handle_Geom_SurfaceOfRevolution & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SurfaceOfRevolution & assign(const Geom_SurfaceOfRevolution * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_ToroidalSurface : public Handle_Geom_ElementarySurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_ToroidalSurface & assign(const Handle_Geom_ToroidalSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_ToroidalSurface & assign(const Geom_ToroidalSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_Point : public Geom_Geometry {
    public:
        %feature("autodoc", "1");
        Geom_Point(const Geom_Point & arg0);
        %feature("autodoc", "1");
        Geom_Point();
        %feature("autodoc", "1");
        virtual void Coord(Standard_Real & OutValue, Standard_Real & OutValue, Standard_Real & OutValue) const;
...
class Handle_Geom_ElementarySurface : public Handle_Geom_Surface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_ElementarySurface & assign(const Handle_Geom_ElementarySurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_ElementarySurface & assign(const Geom_ElementarySurface * anItem);
        %feature("autodoc", "1");
...
class Geom_AxisPlacement : public Geom_Geometry {
    public:
        %feature("autodoc", "1");
        Geom_AxisPlacement(const Geom_AxisPlacement & arg0);
        %feature("autodoc", "1");
        Geom_AxisPlacement();
        %feature("autodoc", "1");
        void SetAxis(const gp_Ax1 A1);
...
class Geom_BezierSurface : public Geom_BoundedSurface {
    public:
        %feature("autodoc", "1");
        Geom_BezierSurface(const Geom_BezierSurface & arg0);
        %feature("autodoc", "1");
...
class Geom_UndefinedDerivative : public Standard_DomainError {
    public:
        %feature("autodoc", "1");
        Geom_UndefinedDerivative(const Geom_UndefinedDerivative & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Line : public Handle_Geom_Curve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Line & assign(const Handle_Geom_Line & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Line & assign(const Geom_Line * anItem);
        %feature("autodoc", "1");
...
class Geom_OffsetCurve : public Geom_Curve {
    public:
        %feature("autodoc", "1");
        Geom_OffsetCurve(const Geom_OffsetCurve & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_HSequenceOfBSplineSurface : public Handle_MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_HSequenceOfBSplineSurface & assign(const Handle_Geom_HSequenceOfBSplineSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_HSequenceOfBSplineSurface & assign(const Geom_HSequenceOfBSplineSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_Axis1Placement : public Geom_AxisPlacement {
    public:
        %feature("autodoc", "1");
        Geom_Axis1Placement(const Geom_Axis1Placement & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Parabola : public Handle_Geom_Conic {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Parabola & assign(const Handle_Geom_Parabola & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Parabola & assign(const Geom_Parabola * anItem);
        %feature("autodoc", "1");
...
class Geom_SweptSurface : public Geom_Surface {
    public:
        %feature("autodoc", "1");
        Geom_SweptSurface(const Geom_SweptSurface & arg0);
        %feature("autodoc", "1");
        Geom_SweptSurface();
        %feature("autodoc", "1");
        virtual GeomAbs_Shape Continuity() const;
...
class Geom_VectorWithMagnitude : public Geom_Vector {
    public:
        %feature("autodoc", "1");
        Geom_VectorWithMagnitude(const Geom_VectorWithMagnitude & arg0);
        %feature("autodoc", "1");
...
class Geom_Conic : public Geom_Curve {
    public:
        %feature("autodoc", "1");
        Geom_Conic(const Geom_Conic & arg0);
        %feature("autodoc", "1");
        Geom_Conic();
        %feature("autodoc", "1");
        void SetAxis(const gp_Ax1 A1);
...
class Handle_Geom_AxisPlacement : public Handle_Geom_Geometry {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_AxisPlacement & assign(const Handle_Geom_AxisPlacement & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_AxisPlacement & assign(const Geom_AxisPlacement * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_BoundedSurface : public Handle_Geom_Surface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BoundedSurface & assign(const Handle_Geom_BoundedSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BoundedSurface & assign(const Geom_BoundedSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_UndefinedValue : public Standard_DomainError {
    public:
        %feature("autodoc", "1");
        Geom_UndefinedValue(const Geom_UndefinedValue & arg0);
        %feature("autodoc", "1");
        Geom_UndefinedValue();
        %feature("autodoc", "1");
...
class Handle_Geom_SurfaceOfLinearExtrusion : public Handle_Geom_SweptSurface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SurfaceOfLinearExtrusion & assign(const Handle_Geom_SurfaceOfLinearExtrusion & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SurfaceOfLinearExtrusion & assign(const Geom_SurfaceOfLinearExtrusion * anItem);
        %feature("autodoc", "1");
...
class Geom_Line : public Geom_Curve {
    public:
        %feature("autodoc", "1");
        Geom_Line(const Geom_Line & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Circle : public Handle_Geom_Conic {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Circle & assign(const Handle_Geom_Circle & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Circle & assign(const Geom_Circle * anItem);
        %feature("autodoc", "1");
...
class Geom_CylindricalSurface : public Geom_ElementarySurface {
    public:
        %feature("autodoc", "1");
        Geom_CylindricalSurface(const Geom_CylindricalSurface & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_SequenceNodeOfSequenceOfBSplineSurface : public Handle_TCollection_SeqNode {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SequenceNodeOfSequenceOfBSplineSurface & assign(const Handle_Geom_SequenceNodeOfSequenceOfBSplineSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SequenceNodeOfSequenceOfBSplineSurface & assign(const Geom_SequenceNodeOfSequenceOfBSplineSurface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_OffsetCurve : public Handle_Geom_Curve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_OffsetCurve & assign(const Handle_Geom_OffsetCurve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_OffsetCurve & assign(const Geom_OffsetCurve * anItem);
        %feature("autodoc", "1");
...
class Geom_Surface : public Geom_Geometry {
    public:
        %feature("autodoc", "1");
        Geom_Surface(const Geom_Surface & arg0);
        %feature("autodoc", "1");
        Geom_Surface();
        %feature("autodoc", "1");
        virtual void UReverse();
...
class Handle_Geom_OffsetSurface : public Handle_Geom_Surface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_OffsetSurface & assign(const Handle_Geom_OffsetSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_OffsetSurface & assign(const Geom_OffsetSurface * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_BSplineCurve : public Handle_Geom_BoundedCurve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_BSplineCurve & assign(const Handle_Geom_BSplineCurve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_BSplineCurve & assign(const Geom_BSplineCurve * anItem);
        %feature("autodoc", "1");
...
class Geom_Direction : public Geom_Vector {
    public:
        %feature("autodoc", "1");
        Geom_Direction(const Geom_Direction & arg0);
        %feature("autodoc", "1");
...
class Geom_TrimmedCurve : public Geom_BoundedCurve {
    public:
        %feature("autodoc", "1");
        Geom_TrimmedCurve(const Geom_TrimmedCurve & arg0);
        %feature("autodoc", "1");
...
class Geom_SequenceOfSurface : public TCollection_BaseSequence {
    public:
        ...
        void Clear();
        %feature("autodoc", "1");
        Geom_SequenceOfSurface const & Assign(const Geom_SequenceOfSurface & Other);
        %feature("autodoc", "1");
        Geom_SequenceOfSurface const & assign(const Geom_SequenceOfSurface & Other);
        %feature("autodoc", "1");
        ...
        %feature("autodoc", "1");
        Handle_Geom_Surface const & Value(const Standard_Integer Index) const;
        %feature("autodoc", "1");
        Handle_Geom_Surface const & __call__(const Standard_Integer Index) const;
        %feature("autodoc", "1");
        void SetValue(const Standard_Integer Index, const Handle_Geom_Surface & I);
        %feature("autodoc", "1");
        const Handle_Geom_Surface & ChangeValue(const Standard_Integer Index);
        %feature("autodoc", "1");
        const Handle_Geom_Surface & __call__(const Standard_Integer Index);
        %feature("autodoc", "1");
...
class Geom_ToroidalSurface : public Geom_ElementarySurface {
    public:
        %feature("autodoc", "1");
        Geom_ToroidalSurface(const Geom_ToroidalSurface & arg0);
        %feature("autodoc", "1");
...
class Geom_BSplineCurve : public Geom_BoundedCurve {
    public:
        %feature("autodoc", "1");
        Geom_BSplineCurve(const Geom_BSplineCurve & arg0);
        %feature("autodoc", "1");
...
class Geom_Plane : public Geom_ElementarySurface {
    public:
        %feature("autodoc", "1");
        Geom_Plane(const Geom_Plane & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_SweptSurface : public Handle_Geom_Surface {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SweptSurface & assign(const Handle_Geom_SweptSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SweptSurface & assign(const Geom_SweptSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_ElementarySurface : public Geom_Surface {
    public:
        %feature("autodoc", "1");
        Geom_ElementarySurface(const Geom_ElementarySurface & arg0);
        %feature("autodoc", "1");
...
class Geom_SequenceOfBSplineSurface : public TCollection_BaseSequence {
    public:
        ...
        void Clear();
        %feature("autodoc", "1");
        Geom_SequenceOfBSplineSurface const & Assign(const Geom_SequenceOfBSplineSurface & Other);
        %feature("autodoc", "1");
        Geom_SequenceOfBSplineSurface const & assign(const Geom_SequenceOfBSplineSurface & Other);
        %feature("autodoc", "1");
        ...
        %feature("autodoc", "1");
        Handle_Geom_BSplineSurface const & Value(const Standard_Integer Index) const;
        %feature("autodoc", "1");
        Handle_Geom_BSplineSurface const & __call__(const Standard_Integer Index) const;
        %feature("autodoc", "1");
        void SetValue(const Standard_Integer Index, const Handle_Geom_BSplineSurface & I);
        %feature("autodoc", "1");
        const Handle_Geom_BSplineSurface & ChangeValue(const Standard_Integer Index);
        %feature("autodoc", "1");
        const Handle_Geom_BSplineSurface & __call__(const Standard_Integer Index);
        %feature("autodoc", "1");
        void Remove(const Standard_Integer Index);
        %feature("autodoc", "1");
        void Remove(const Standard_Integer FromIndex, const Standard_Integer ToIndex); 
...
class Geom_HSequenceOfSurface : public MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        Handle_Geom_Surface const & Value(const Standard_Integer anIndex) const;
        %feature("autodoc", "1");
        const Handle_Geom_Surface & ChangeValue(const Standard_Integer anIndex);
        %feature("autodoc", "1");
        ...
        %feature("autodoc", "1");
        const Geom_SequenceOfSurface & ChangeSequence();
        %feature("autodoc", "1");
...
class Handle_Geom_Curve : public Handle_Geom_Geometry {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Curve & assign(const Handle_Geom_Curve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Curve & assign(const Geom_Curve * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_UndefinedDerivative : public Handle_Standard_DomainError {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_UndefinedDerivative & assign(const Handle_Geom_UndefinedDerivative & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_UndefinedDerivative & assign(const Geom_UndefinedDerivative * anItem);
        %feature("autodoc", "1");
        static const Handle_Geom_UndefinedDerivative  DownCast(const Handle_Standard_Transient & AnObject); 
};
...
class Handle_Geom_Hyperbola : public Handle_Geom_Conic {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Hyperbola & assign(const Handle_Geom_Hyperbola & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Hyperbola & assign(const Geom_Hyperbola * anItem);
        %feature("autodoc", "1");
...
class Handle_Geom_SequenceNodeOfSequenceOfSurface : public Handle_TCollection_SeqNode {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_SequenceNodeOfSequenceOfSurface & assign(const Handle_Geom_SequenceNodeOfSequenceOfSurface & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_SequenceNodeOfSequenceOfSurface & assign(const Geom_SequenceNodeOfSequenceOfSurface * anItem);
        %feature("autodoc", "1");
...
class Geom_BSplineSurface : public Geom_BoundedSurface {
    public:
        %feature("autodoc", "1");
        Geom_BSplineSurface(const Geom_BSplineSurface & arg0);
        %feature("autodoc", "1");
...
class Handle_Geom_Ellipse : public Handle_Geom_Conic {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_Ellipse & assign(const Handle_Geom_Ellipse & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_Ellipse & assign(const Geom_Ellipse * anItem);
        %feature("autodoc", "1");
...
class Geom_HSequenceOfBSplineSurface : public MMgt_TShared {
    public:
        ...
        %feature("autodoc", "1");
        Handle_Geom_BSplineSurface const & Value(const Standard_Integer anIndex) const;
        %feature("autodoc", "1");
        const Handle_Geom_BSplineSurface & ChangeValue(const Standard_Integer anIndex);
        %feature("autodoc", "1");
        void Remove(const Standard_Integer anIndex);
        %feature("autodoc", "1");
        void Remove(const Standard_Integer fromIndex, const Standard_Integer toIndex);
        ...
        %feature("autodoc", "1");
        const Geom_SequenceOfBSplineSurface & ChangeSequence();
        %feature("autodoc", "1");
...
class Handle_Geom_TrimmedCurve : public Handle_Geom_BoundedCurve {
    public:
        ...
        %feature("autodoc", "1");
        const Handle_Geom_TrimmedCurve & assign(const Handle_Geom_TrimmedCurve & aHandle);
        %feature("autodoc", "1");
        const Handle_Geom_TrimmedCurve & assign(const Geom_TrimmedCurve * anItem);
        %feature("autodoc", "1");
