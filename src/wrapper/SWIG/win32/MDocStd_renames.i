...
%rename(downcast) Handle_MDocStd_ListNodeOfDocEntryList::DownCast;
%rename(downcast) Handle_MDocStd_StdMapNodeOfPersistentMap::DownCast;
%rename(addstoragedrivers) MDocStd::AddStorageDrivers;
%rename(addretrievaldrivers) MDocStd::AddRetrievalDrivers;
%rename(weightwatcher) MDocStd::WeightWatcher;
