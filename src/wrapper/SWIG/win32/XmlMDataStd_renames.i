...
*/
%rename(downcast) Handle_XmlMDataStd_PointDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_IntPackedMapDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_PlacementDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_PlaneDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_RealListDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_AsciiStringDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_ConstraintDriver::DownCast;
%rename(downcast) Handle_XmlMDataStd_AxisDriver::DownCast;
...
%rename(downcast) Handle_XmlMDataStd_GeometryDriver::DownCast;
...
%rename(downcast) Handle_XmlMDataStd_PatternStdDriver::DownCast;
...
%rename(downcast) Handle_XmlMDataStd_ShapeDriver::DownCast;
