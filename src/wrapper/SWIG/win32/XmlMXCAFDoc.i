...
class Handle_XmlMXCAFDoc_LocationDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_LocationDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_GraphNodeDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_GraphNodeDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_VolumeDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_VolumeDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_DocumentToolDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_DocumentToolDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_ColorDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_ColorDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_LayerToolDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_LayerToolDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_AreaDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_AreaDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_CentroidDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_CentroidDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_ColorToolDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_ColorToolDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlMXCAFDoc_ShapeToolDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlMXCAFDoc_ShapeToolDriver const DownCast(const Handle_Standard_Transient &AnObject);
...
class XmlMXCAFDoc_LocationDriver : public XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		void Translate(const TopLoc_Location &theLoc, XmlObjMgt_Element & theParent, XmlObjMgt_SRelocationTable & theMap);
		%feature("autodoc", "1");
		static		Standard_Boolean Translate(const XmlObjMgt_Element &theParent, TopLoc_Location & theLoc, XmlObjMgt_RRelocationTable & theMap);
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
