...
class StdPrs_DeflectionCurve : public Prs3d_Root {
	public:
		...
		%feature("autodoc", "1");
		static		void Add(const Handle_Prs3d_Presentation &aPresentation, Adaptor3d_Curve & aCurve, const Handle_Prs3d_Drawer &aDrawer, const Standard_Boolean drawCurve=1);
		%feature("autodoc", "1");
