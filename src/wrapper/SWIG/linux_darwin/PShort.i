...
%include PShort_required_python_modules.i
...
class Handle_PShort_HArray2OfShortReal : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_HArray2OfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PShort_HSequenceOfShortReal : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_HSequenceOfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PShort_VArrayNodeOfFieldOfHArray2OfShortReal : public Handle_PStandard_ArrayNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_VArrayNodeOfFieldOfHArray2OfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PShort_HArray1OfShortReal : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_HArray1OfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PShort_VArrayNodeOfFieldOfHArray1OfShortReal : public Handle_PStandard_ArrayNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_VArrayNodeOfFieldOfHArray1OfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PShort_SeqNodeOfHSequenceOfShortReal : public Handle_PMMgt_PManaged {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PShort_SeqNodeOfHSequenceOfShortReal const DownCast(const Handle_Standard_Persistent &AnObject);
