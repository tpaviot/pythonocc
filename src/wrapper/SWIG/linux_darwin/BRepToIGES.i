...
class BRepToIGES_BREntity {
	public:
		...
		%feature("autodoc", "1");
		void AddFail(const Standard_Transient *start, const char * amess);
		%feature("autodoc", "1");
		void AddWarning(const Standard_Transient *start, const char * amess);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetShapeResult(const TopoDS_Shape &start, const Standard_Transient *result);
		%feature("autodoc", "1");
		Standard_Boolean HasShapeResult(const Standard_Transient *start) const;
		%feature("autodoc", "1");
		Handle_Standard_Transient GetShapeResult(const Standard_Transient *start) const;
		%feature("autodoc", "1");
		void SetShapeResult(const Standard_Transient *start, const Standard_Transient *result);
		%feature("autodoc", "1");
...
class BRepToIGES_BRWire : public BRepToIGES_BREntity {
	public:
		...
		Handle_IGESData_IGESEntity TransferVertex(const TopoDS_Vertex &myvertex, const TopoDS_Edge &myedge, const Geom_Surface *mysurface, const TopLoc_Location &myloc, Standard_Real &OutValue);
		%feature("autodoc", "1");
