...
%include XmlTObjDrivers_required_python_modules.i
...
class Handle_XmlTObjDrivers_XYZDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlTObjDrivers_XYZDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlTObjDrivers_DocumentStorageDriver : public Handle_XmlLDrivers_DocumentStorageDriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlTObjDrivers_DocumentStorageDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlTObjDrivers_ObjectDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlTObjDrivers_ObjectDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlTObjDrivers_IntSparseArrayDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlTObjDrivers_IntSparseArrayDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XmlTObjDrivers_ModelDriver : public Handle_XmlMDF_ADriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XmlTObjDrivers_ModelDriver DownCast(const Handle_Standard_Transient &AnObject);
