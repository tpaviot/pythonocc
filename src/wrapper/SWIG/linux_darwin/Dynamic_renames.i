...
*/
%rename(downcast) Handle_Dynamic_DynamicInstance::DownCast;
%rename(downcast) Handle_Dynamic_SequenceNodeOfSeqOfMethods::DownCast;
%rename(downcast) Handle_Dynamic_Parameter::DownCast;
...
%rename(downcast) Handle_Dynamic_Variable::DownCast;
%rename(downcast) Handle_Dynamic_AbstractVariableInstance::DownCast;
%rename(downcast) Handle_Dynamic_RealParameter::DownCast;
%rename(downcast) Handle_Dynamic_MethodDefinition::DownCast;
%rename(downcast) Handle_Dynamic_CompiledMethod::DownCast;
%rename(downcast) Handle_Dynamic_InterpretedMethod::DownCast;
