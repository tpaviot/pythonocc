...
class GeomConvert_BSplineSurfaceKnotSplitting {
	public:
		%feature("autodoc", "1");
		GeomConvert_BSplineSurfaceKnotSplitting(const Geom_BSplineSurface *BasisSurface, const Standard_Integer UContinuityRange, const Standard_Integer VContinuityRange);
		%feature("autodoc", "1");
...
class GeomConvert_BSplineCurveKnotSplitting {
	public:
		%feature("autodoc", "1");
		GeomConvert_BSplineCurveKnotSplitting(const Geom_BSplineCurve *BasisCurve, const Standard_Integer ContinuityRange);
		%feature("autodoc", "1");
...
class GeomConvert {
	public:
		...
		GeomConvert();
		%feature("autodoc", "1");
		Handle_Geom_BSplineCurve SplitBSplineCurve(const Geom_BSplineCurve *C, const Standard_Integer FromK1, const Standard_Integer ToK2, const Standard_Boolean SameOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineCurve SplitBSplineCurve(const Geom_BSplineCurve *C, const Standard_Real FromU1, const Standard_Real ToU2, const Standard_Real ParametricTolerance, const Standard_Boolean SameOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineSurface SplitBSplineSurface(const Geom_BSplineSurface *S, const Standard_Integer FromUK1, const Standard_Integer ToUK2, const Standard_Integer FromVK1, const Standard_Integer ToVK2, const Standard_Boolean SameUOrientation=1, const Standard_Boolean SameVOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineSurface SplitBSplineSurface(const Geom_BSplineSurface *S, const Standard_Integer FromK1, const Standard_Integer ToK2, const Standard_Boolean USplit, const Standard_Boolean SameOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineSurface SplitBSplineSurface(const Geom_BSplineSurface *S, const Standard_Real FromU1, const Standard_Real ToU2, const Standard_Real FromV1, const Standard_Real ToV2, const Standard_Real ParametricTolerance, const Standard_Boolean SameUOrientation=1, const Standard_Boolean SameVOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineSurface SplitBSplineSurface(const Geom_BSplineSurface *S, const Standard_Real FromParam1, const Standard_Real ToParam2, const Standard_Boolean USplit, const Standard_Real ParametricTolerance, const Standard_Boolean SameOrientation=1);
		%feature("autodoc", "1");
		Handle_Geom_BSplineCurve CurveToBSplineCurve(const Geom_Curve *C, const Convert_ParameterisationType Parameterisation=Convert_TgtThetaOver2);
		%feature("autodoc", "1");
		Handle_Geom_BSplineSurface SurfaceToBSplineSurface(const Geom_Surface *S);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void C0BSplineToArrayOfC1BSplineCurve(const Geom_BSplineCurve *BS, Handle_TColGeom_HArray1OfBSplineCurve & tabBS, const Standard_Real tolerance);
		%feature("autodoc", "1");
		void C0BSplineToArrayOfC1BSplineCurve(const Geom_BSplineCurve *BS, Handle_TColGeom_HArray1OfBSplineCurve & tabBS, const Standard_Real AngularTolerance, const Standard_Real tolerance);
...
class GeomConvert_ApproxCurve {
	public:
		%feature("autodoc", "1");
		GeomConvert_ApproxCurve(const Geom_Curve *Curve, const Standard_Real Tol3d, const GeomAbs_Shape Order, const Standard_Integer MaxSegments, const Standard_Integer MaxDegree);
		%feature("autodoc", "1");
...
class GeomConvert_BSplineCurveToBezierCurve {
	public:
		%feature("autodoc", "1");
		GeomConvert_BSplineCurveToBezierCurve(const Geom_BSplineCurve *BasisCurve);
		%feature("autodoc", "1");
		GeomConvert_BSplineCurveToBezierCurve(const Geom_BSplineCurve *BasisCurve, const Standard_Real U1, const Standard_Real U2, const Standard_Real ParametricTolerance);
		%feature("autodoc", "1");
...
class GeomConvert_BSplineSurfaceToBezierSurface {
	public:
		%feature("autodoc", "1");
		GeomConvert_BSplineSurfaceToBezierSurface(const Geom_BSplineSurface *BasisSurface);
		%feature("autodoc", "1");
		GeomConvert_BSplineSurfaceToBezierSurface(const Geom_BSplineSurface *BasisSurface, const Standard_Real U1, const Standard_Real U2, const Standard_Real V1, const Standard_Real V2, const Standard_Real ParametricTolerance);
		%feature("autodoc", "1");
...
class GeomConvert_CompCurveToBSplineCurve {
	public:
		%feature("autodoc", "1");
		GeomConvert_CompCurveToBSplineCurve(const Geom_BoundedCurve *BasisCurve, const Convert_ParameterisationType Parameterisation=Convert_TgtThetaOver2);
		%feature("autodoc", "1");
		Standard_Boolean Add(const Geom_BoundedCurve *NewCurve, const Standard_Real Tolerance, const Standard_Boolean After=0, const Standard_Boolean WithRatio=1, const Standard_Integer MinM=0);
		%feature("autodoc", "1");
...
class GeomConvert_ApproxSurface {
	public:
		%feature("autodoc", "1");
		GeomConvert_ApproxSurface(const Geom_Surface *Surf, const Standard_Real Tol3d, const GeomAbs_Shape UContinuity, const GeomAbs_Shape VContinuity, const Standard_Integer MaxDegU, const Standard_Integer MaxDegV, const Standard_Integer MaxSegments, const Standard_Integer PrecisCode);
		%feature("autodoc", "1");
