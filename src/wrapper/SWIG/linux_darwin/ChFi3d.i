...
class ChFi3d_SearchSing : public math_FunctionWithDerivative {
	public:
		%feature("autodoc", "1");
		ChFi3d_SearchSing(const Geom_Curve *C1, const Geom_Curve *C2);
...
class ChFi3d_Builder {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean SplitKPart(const ChFiDS_SurfData *Data, ChFiDS_SequenceOfSurfData & SetData, const ChFiDS_Spine *Spine, const Standard_Integer Iedge, const Adaptor3d_HSurface *S1, const Adaptor3d_TopolTool *I1, const Adaptor3d_HSurface *S2, const Adaptor3d_TopolTool *I2, Standard_Boolean & Intf, Standard_Boolean & Intl);
		%feature("autodoc", "1");
...
class ChFi3d_ChBuilder : public ChFi3d_Builder {
	public:
		...
		virtual		void SimulSurf(Handle_ChFiDS_SurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const BRepAdaptor_HCurve2d *PC1, const BRepAdaptor_HSurface *Sref1, const BRepAdaptor_HCurve2d *PCref1, Standard_Boolean & Decroch1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const TopAbs_Orientation Or2, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP, const Standard_Boolean RecS, const Standard_Boolean RecRst, const math_Vector &Soldep);
		...
		virtual		void SimulSurf(Handle_ChFiDS_SurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const TopAbs_Orientation Or1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const BRepAdaptor_HCurve2d *PC2, const BRepAdaptor_HSurface *Sref2, const BRepAdaptor_HCurve2d *PCref2, Standard_Boolean & Decroch2, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP, const Standard_Boolean RecS, const Standard_Boolean RecRst, const math_Vector &Soldep);
		...
		virtual		void SimulSurf(Handle_ChFiDS_SurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const BRepAdaptor_HCurve2d *PC1, const BRepAdaptor_HSurface *Sref1, const BRepAdaptor_HCurve2d *PCref1, Standard_Boolean & Decroch1, const TopAbs_Orientation Or1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const BRepAdaptor_HCurve2d *PC2, const BRepAdaptor_HSurface *Sref2, const BRepAdaptor_HCurve2d *PCref2, Standard_Boolean & Decroch2, const TopAbs_Orientation Or2, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP1, const Standard_Boolean RecRst1, const Standard_Boolean RecP2, const Standard_Boolean RecRst2, const math_Vector &Soldep);
		...
		virtual		Standard_Boolean PerformSurf(ChFiDS_SequenceOfSurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const Standard_Real MaxStep, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecOnS1, const Standard_Boolean RecOnS2, const math_Vector &Soldep, Standard_Boolean & Intf, Standard_Boolean & Intl);
		...
		virtual		void PerformSurf(ChFiDS_SequenceOfSurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const BRepAdaptor_HCurve2d *PC1, const BRepAdaptor_HSurface *Sref1, const BRepAdaptor_HCurve2d *PCref1, Standard_Boolean & Decroch1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const TopAbs_Orientation Or2, const Standard_Real MaxStep, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP, const Standard_Boolean RecS, const Standard_Boolean RecRst, const math_Vector &Soldep);
		...
		virtual		void PerformSurf(ChFiDS_SequenceOfSurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const TopAbs_Orientation Or1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const BRepAdaptor_HCurve2d *PC2, const BRepAdaptor_HSurface *Sref2, const BRepAdaptor_HCurve2d *PCref2, Standard_Boolean & Decroch2, const Standard_Real MaxStep, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP, const Standard_Boolean RecS, const Standard_Boolean RecRst, const math_Vector &Soldep);
		%feature("autodoc","PerformSurf(const Guide, const Spine, Standard_Integer Choix, const S1, const I1, const PC1, const Sref1, const PCref1, TopAbs_Orientation Or1, const S2, const I2, const PC2, const Sref2, const PCref2, TopAbs_Orientation Or2, Standard_Real MaxStep, Standard_Real Fleche, Standard_Real TolGuide, Standard_Boolean Inside, Standard_Boolean Appro, Standard_Boolean Forward, Standard_Boolean RecP1, Standard_Boolean RecRst1, Standard_Boolean RecP2, Standard_Boolean RecRst2, const Soldep) -> [Standard_Real, Standard_Real]");

		virtual		void PerformSurf(ChFiDS_SequenceOfSurfData & Data, const ChFiDS_HElSpine *Guide, const ChFiDS_Spine *Spine, const Standard_Integer Choix, const BRepAdaptor_HSurface *S1, const Adaptor3d_TopolTool *I1, const BRepAdaptor_HCurve2d *PC1, const BRepAdaptor_HSurface *Sref1, const BRepAdaptor_HCurve2d *PCref1, Standard_Boolean & Decroch1, const TopAbs_Orientation Or1, const BRepAdaptor_HSurface *S2, const Adaptor3d_TopolTool *I2, const BRepAdaptor_HCurve2d *PC2, const BRepAdaptor_HSurface *Sref2, const BRepAdaptor_HCurve2d *PCref2, Standard_Boolean & Decroch2, const TopAbs_Orientation Or2, const Standard_Real MaxStep, const Standard_Real Fleche, const Standard_Real TolGuide, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean Inside, const Standard_Boolean Appro, const Standard_Boolean Forward, const Standard_Boolean RecP1, const Standard_Boolean RecRst1, const Standard_Boolean RecP2, const Standard_Boolean RecRst2, const math_Vector &Soldep);
		%feature("autodoc", "1");
...
class ChFi3d_FilBuilder : public ChFi3d_Builder {
	public:
		...
		%feature("autodoc", "1");
		void SetRadius(const Law_Function *C, const Standard_Integer IC, const Standard_Integer IinC);
		%feature("autodoc", "1");
