...
class Handle_V2d_BackgroundGraphicObject : public Handle_Graphic2d_GraphicObject {
	public:
		...
		%feature("autodoc", "1");
		Handle_V2d_BackgroundGraphicObject(const V2d_BackgroundGraphicObject *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_BackgroundGraphicObject(const V2d_BackgroundGraphicObject *anItem);
		%feature("autodoc", "1");
		Handle_V2d_BackgroundGraphicObject & operator=(const V2d_BackgroundGraphicObject *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_BackgroundGraphicObject & operator=(const V2d_BackgroundGraphicObject *anItem);
		%feature("autodoc", "1");
		Handle_V2d_BackgroundGraphicObject const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_CircularGraphicGrid : public Handle_Graphic2d_Primitive {
	public:
		...
		%feature("autodoc", "1");
		Handle_V2d_CircularGraphicGrid(const V2d_CircularGraphicGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_CircularGraphicGrid(const V2d_CircularGraphicGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_CircularGraphicGrid & operator=(const V2d_CircularGraphicGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_CircularGraphicGrid & operator=(const V2d_CircularGraphicGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_CircularGraphicGrid const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_CircularGrid : public Handle_Aspect_CircularGrid {
	public:
		...
		%feature("autodoc", "1");
		Handle_V2d_CircularGrid(const V2d_CircularGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_CircularGrid(const V2d_CircularGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_CircularGrid & operator=(const V2d_CircularGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_CircularGrid & operator=(const V2d_CircularGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_CircularGrid const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_RectangularGrid : public Handle_Aspect_RectangularGrid {
	public:
		...
		%feature("autodoc", "1");
		Handle_V2d_RectangularGrid(const V2d_RectangularGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGrid(const V2d_RectangularGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGrid & operator=(const V2d_RectangularGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGrid & operator=(const V2d_RectangularGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGrid const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_View : public Handle_Viewer_View {
	public:
		...
		Handle_V2d_View();
		%feature("autodoc", "1");
		Handle_V2d_View(const V2d_View *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_View(const V2d_View *anItem);
		%feature("autodoc", "1");
		Handle_V2d_View & operator=(const V2d_View *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_View & operator=(const V2d_View *anItem);
		%feature("autodoc", "1");
		Handle_V2d_View const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_Viewer : public Handle_Viewer_Viewer {
	public:
		...
		Handle_V2d_Viewer();
		%feature("autodoc", "1");
		Handle_V2d_Viewer(const V2d_Viewer *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_Viewer(const V2d_Viewer *anItem);
		%feature("autodoc", "1");
		Handle_V2d_Viewer & operator=(const V2d_Viewer *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_Viewer & operator=(const V2d_Viewer *anItem);
		%feature("autodoc", "1");
		Handle_V2d_Viewer const DownCast(const Standard_Transient *AnObject);
...
class Handle_V2d_RectangularGraphicGrid : public Handle_Graphic2d_Primitive {
	public:
		...
		%feature("autodoc", "1");
		Handle_V2d_RectangularGraphicGrid(const V2d_RectangularGraphicGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGraphicGrid(const V2d_RectangularGraphicGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGraphicGrid & operator=(const V2d_RectangularGraphicGrid *aHandle);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGraphicGrid & operator=(const V2d_RectangularGraphicGrid *anItem);
		%feature("autodoc", "1");
		Handle_V2d_RectangularGraphicGrid const DownCast(const Standard_Transient *AnObject);
...
class V2d {
	public:
		...
		V2d();
		%feature("autodoc", "1");
		void Draw(const V2d_Viewer *aViewer);
...
class V2d_RectangularGraphicGrid : public Graphic2d_Primitive {
	public:
		%feature("autodoc", "1");
		V2d_RectangularGraphicGrid(const Graphic2d_GraphicObject *aGraphicObject, const Standard_Real X, const Standard_Real Y, const Standard_Real alpha, const Standard_Real beta, const Standard_Real xo, const Standard_Real yo, const Standard_Integer aTenthColorIndex);
		%feature("autodoc", "1");
...
class V2d_View : public Viewer_View {
	public:
		%feature("autodoc", "1");
		V2d_View(const Aspect_WindowDriver *aWindowDriver, const V2d_Viewer *aViewer, const Quantity_Length aXCenter=0, const Quantity_Length aYCenter=0, const Quantity_Length aSize=1000);
		%feature("autodoc", "1");
		...
		void HasBeenMoved();
		%feature("autodoc", "1");
		void Plot(const PlotMgt_PlotterDriver *aPlotterDriver, const Quantity_Length aXCenter, const Quantity_Length aYCenter, const Quantity_Factor aScale=1.0e+0) const;
		%feature("autodoc", "1");
		void Plot(const PlotMgt_PlotterDriver *aPlotterDriver, const Quantity_Factor aScale=1.0e+0) const;
		%feature("autodoc", "1");
		void PlotScreen(const PlotMgt_PlotterDriver *aPlotterDriver) const;
		%feature("autodoc", "1");
...
class V2d_CircularGraphicGrid : public Graphic2d_Primitive {
	public:
		%feature("autodoc", "1");
		V2d_CircularGraphicGrid(const Graphic2d_GraphicObject *aGraphicObject, const Standard_Real X, const Standard_Real Y, const Standard_Real alpha, const Standard_Real step, const Standard_Integer aDivision, const Standard_Integer PointsColorIndex);
		%feature("autodoc", "1");
		void SetDrawMode(const Aspect_GridDrawMode aDrawMode);
		%feature("autodoc", "1");
		virtual		void Save(Aspect_FStream & aFStream) const;
...
class V2d_BackgroundGraphicObject : public Graphic2d_GraphicObject {
	public:
		%feature("autodoc", "1");
		V2d_BackgroundGraphicObject(const Graphic2d_View *aView);
		%feature("autodoc", "1");
...
class V2d_Viewer : public Viewer_Viewer {
	public:
		%feature("autodoc", "1");
		V2d_Viewer(const Aspect_GraphicDevice *aGraphicDevice, const Standard_ExtString aName, const char * aDomain="");
		%feature("autodoc", "1");
		V2d_Viewer(const Aspect_GraphicDevice *aGraphicDevice, const Graphic2d_View *aView, const Standard_ExtString aName, const char * aDomain="");
		%feature("autodoc", "1");
		void AddView(const V2d_View *aView);
		%feature("autodoc", "1");
		void RemoveView(const V2d_View *aView);
		%feature("autodoc", "1");
		virtual		void Update();
		%feature("autodoc", "1");
		void UpdateNew();
