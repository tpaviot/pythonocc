...
*/
%rename(downcast) Handle_PColPGeom_HArray1OfSurface::DownCast;
%rename(downcast) Handle_PColPGeom_VArrayNodeOfFieldOfHArray2OfBezierSurface::DownCast;
%rename(downcast) Handle_PColPGeom_VArrayNodeOfFieldOfHArray2OfBoundedSurface::DownCast;
...
%rename(downcast) Handle_PColPGeom_HArray2OfBSplineSurface::DownCast;
%rename(downcast) Handle_PColPGeom_HArray1OfBezierCurve::DownCast;
%rename(downcast) Handle_PColPGeom_HArray1OfBSplineCurve::DownCast;
%rename(downcast) Handle_PColPGeom_VArrayNodeOfFieldOfHArray1OfBSplineCurve::DownCast;
%rename(downcast) Handle_PColPGeom_HArray1OfBoundedCurve::DownCast;
%rename(downcast) Handle_PColPGeom_HArray1OfCurve::DownCast;
