...
%rename(getmaovpch) AdvApp2Var_Data::Getmaovpch;
%rename(getmlgdrtl) AdvApp2Var_Data::Getmlgdrtl;
%rename(getmmjcobi) AdvApp2Var_Data::Getmmjcobi;
%rename(getmmcmcnp) AdvApp2Var_Data::Getmmcmcnp;
%rename(getmmapgss) AdvApp2Var_Data::Getmmapgss;
%rename(getmmapgs0) AdvApp2Var_Data::Getmmapgs0;
%rename(getmmapgs1) AdvApp2Var_Data::Getmmapgs1;
%rename(getmmapgs2) AdvApp2Var_Data::Getmmapgs2;
