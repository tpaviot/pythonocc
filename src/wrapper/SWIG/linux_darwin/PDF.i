...
class Handle_PDF_Attribute : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_Attribute DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PDF_TagSource : public Handle_PDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_TagSource DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PDF_Reference : public Handle_PDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_Reference DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PDF_HAttributeArray1 : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_HAttributeArray1 DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PDF_VArrayNodeOfFieldOfHAttributeArray1 : public Handle_PStandard_ArrayNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_VArrayNodeOfFieldOfHAttributeArray1 DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PDF_Data : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PDF_Data DownCast(const Handle_Standard_Persistent &AnObject);
