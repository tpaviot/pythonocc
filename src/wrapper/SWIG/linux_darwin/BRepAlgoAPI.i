...
class BRepAlgoAPI_Section : public BRepAlgoAPI_BooleanOperation {
	public:
		...
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const TopoDS_Shape &Sh, const Geom_Surface *Sf, const Standard_Boolean PerformNow=1);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const Geom_Surface *Sf, const TopoDS_Shape &Sh, const Standard_Boolean PerformNow=1);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const Geom_Surface *Sf1, const Geom_Surface *Sf2, const Standard_Boolean PerformNow=1);
		%feature("autodoc", "1");
