...
%rename(downcast) Handle_STEPCAFControl_DataMapNodeOfDataMapOfShapeTransient::DownCast;
...
%rename(downcast) Handle_STEPCAFControl_DataMapNodeOfDataMapOfShapeLabel::DownCast;
