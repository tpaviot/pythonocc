...
*/
%rename(downcast) Handle_BinMDataStd_PlacementDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_ReferenceArrayDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_PatternStdDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_ByteArrayDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_PointDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_ReferenceListDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_ConstraintDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_PlaneDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_IntegerArrayDriver::DownCast;
%rename(downcast) Handle_BinMDataStd_AxisDriver::DownCast;
...
%rename(downcast) Handle_BinMDataStd_ShapeDriver::DownCast;
...
%rename(downcast) Handle_BinMDataStd_GeometryDriver::DownCast;
