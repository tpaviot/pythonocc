...
%rename(computecurvilinearfaceslengthpresentation) DsgPrs::ComputeCurvilinearFacesLengthPresentation;
%rename(computefacesanglepresentation) DsgPrs::ComputeFacesAnglePresentation;
