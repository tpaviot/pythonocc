...
class Handle_GeomPlate_SequenceNodeOfSequenceOfAij : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_SequenceNodeOfSequenceOfAij DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_HSequenceOfPointConstraint : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_HSequenceOfPointConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_SequenceNodeOfSequenceOfCurveConstraint : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_SequenceNodeOfSequenceOfCurveConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_Surface : public Handle_Geom_Surface {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_Surface DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_HArray1OfSequenceOfReal : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_HArray1OfSequenceOfReal DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_CurveConstraint : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_CurveConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_GeomPlate_HSequenceOfCurveConstraint : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_GeomPlate_HSequenceOfCurveConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class GeomPlate_PointConstraint : public MMgt_TShared {
	public:
		...
		%feature("autodoc","D0() -> gp_Pnt");

		void D0(gp_Pnt &OutValue) const;
		%feature("autodoc","D1() -> [gp_Pnt, gp_Vec, gp_Vec]");

		void D1(gp_Pnt &OutValue, gp_Vec &OutValue, gp_Vec &OutValue) const;
		%feature("autodoc","D2() -> [gp_Pnt, gp_Vec, gp_Vec, gp_Vec, gp_Vec, gp_Vec]");

		void D2(gp_Pnt &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue) const;
		%feature("autodoc", "1");
...
class GeomPlate_CurveConstraint : public MMgt_TShared {
	public:
		...
		%feature("autodoc","D1(Standard_Real U) -> [gp_Pnt, gp_Vec, gp_Vec]");

		void D1(const Standard_Real U, gp_Pnt &OutValue, gp_Vec &OutValue, gp_Vec &OutValue) const;
		%feature("autodoc","D2(Standard_Real U) -> [gp_Pnt, gp_Vec, gp_Vec, gp_Vec, gp_Vec, gp_Vec]");

		void D2(const Standard_Real U, gp_Pnt &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue) const;
		%feature("autodoc", "1");
