...
class BRepMesh_VertexInspector : public NCollection_CellFilter_InspectorXY {
	public:
		...
		%feature("autodoc", "1");
		BRepMesh_Vertex & GetVertex(Standard_Integer );
		%feature("autodoc", "1");
		void SetCurrent(const gp_XY theCurVertex, const Standard_Boolean theExactVal=0);
		%feature("autodoc", "1");
		Standard_Integer const GetCoincidentInd() const;
		%feature("autodoc", "1");
...
class BRepMesh_IncrementalMesh : public BRepMesh_DiscretRoot {
	public:
		...
		%feature("autodoc", "1");
		BRepMesh_IncrementalMesh(const TopoDS_Shape S, const Standard_Real D, const Standard_Boolean Relatif=0, const Standard_Real Ang=5.0e-1, const Standard_Boolean InParallel=0);
		%feature("autodoc", "1");
