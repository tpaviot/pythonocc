...
class BRepLib_FindSurface {
	public:
		...
		BRepLib_FindSurface();
		%feature("autodoc", "1");
		BRepLib_FindSurface(const TopoDS_Shape S, const Standard_Real Tol=-0x00000000000000001, const Standard_Boolean OnlyPlane=0, const Standard_Boolean OnlyClosed=0);
		%feature("autodoc", "1");
		void Init(const TopoDS_Shape S, const Standard_Real Tol=-0x00000000000000001, const Standard_Boolean OnlyPlane=0, const Standard_Boolean OnlyClosed=0);
		%feature("autodoc", "1");
