...
*/
%rename(DownCast) Handle_GEOMImpl_Fillet2dDriver::DownCast;
...
%rename(GetID) GEOMImpl_Fillet2dDriver::GetID;
...
%rename(MakeDraftPrism) GEOMImpl_PrismDriver::MakeDraftPrism;
