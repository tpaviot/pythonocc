...
%include Viewer_required_python_modules.i
...
class Handle_Viewer_BadValue : public Handle_Standard_OutOfRange {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Viewer_BadValue DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Viewer_View : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Viewer_View DownCast(const Handle_Standard_Transient &AnObject);
