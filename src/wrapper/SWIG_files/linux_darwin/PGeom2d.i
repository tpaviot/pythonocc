...
%include PGeom2d_required_python_modules.i
...
class Handle_PGeom2d_Geometry : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Geometry DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Curve : public Handle_PGeom2d_Geometry {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Curve DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Line : public Handle_PGeom2d_Curve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Line DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Conic : public Handle_PGeom2d_Curve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Conic DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Ellipse : public Handle_PGeom2d_Conic {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Ellipse DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_OffsetCurve : public Handle_PGeom2d_Curve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_OffsetCurve DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Point : public Handle_PGeom2d_Geometry {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Point DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Hyperbola : public Handle_PGeom2d_Conic {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Hyperbola DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_TrimmedCurve : public Handle_PGeom2d_BoundedCurve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_TrimmedCurve DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Transformation : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Transformation DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_Parabola : public Handle_PGeom2d_Conic {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_Parabola DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_CartesianPoint : public Handle_PGeom2d_Point {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_CartesianPoint DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_AxisPlacement : public Handle_PGeom2d_Geometry {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_AxisPlacement DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_PGeom2d_BSplineCurve : public Handle_PGeom2d_BoundedCurve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_PGeom2d_BSplineCurve DownCast(const Handle_Standard_Persistent &AnObject);
