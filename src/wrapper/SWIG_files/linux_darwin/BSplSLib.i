...
class BSplSLib {
	public:
		...
		%feature("autodoc","CacheD1(Standard_Real U, Standard_Real V, Standard_Integer UDegree, Standard_Integer VDegree, Standard_Real UCacheParameter, Standard_Real VCacheParameter, Standard_Real USpanLenght, Standard_Real VSpanLength, const Poles, const Weights) -> [gp_Vec, gp_Vec]");

		static		void CacheD1(const Standard_Real U, const Standard_Real V, const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Real UCacheParameter, const Standard_Real VCacheParameter, const Standard_Real USpanLenght, const Standard_Real VSpanLength, const TColgp_Array2OfPnt &Poles, const TColStd_Array2OfReal &Weights, gp_Pnt & Point, gp_Vec &OutValue, gp_Vec &OutValue);
		%feature("autodoc","CoefsD1(Standard_Real U, Standard_Real V, const Poles, const Weights) -> [gp_Vec, gp_Vec]");

		static		void CoefsD1(const Standard_Real U, const Standard_Real V, const TColgp_Array2OfPnt &Poles, const TColStd_Array2OfReal &Weights, gp_Pnt & Point, gp_Vec &OutValue, gp_Vec &OutValue);
		%feature("autodoc","CacheD2(Standard_Real U, Standard_Real V, Standard_Integer UDegree, Standard_Integer VDegree, Standard_Real UCacheParameter, Standard_Real VCacheParameter, Standard_Real USpanLenght, Standard_Real VSpanLength, const Poles, const Weights) -> [gp_Vec, gp_Vec, gp_Vec, gp_Vec, gp_Vec]");

		static		void CacheD2(const Standard_Real U, const Standard_Real V, const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Real UCacheParameter, const Standard_Real VCacheParameter, const Standard_Real USpanLenght, const Standard_Real VSpanLength, const TColgp_Array2OfPnt &Poles, const TColStd_Array2OfReal &Weights, gp_Pnt & Point, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue);
		%feature("autodoc","CoefsD2(Standard_Real U, Standard_Real V, const Poles, const Weights) -> [gp_Vec, gp_Vec, gp_Vec, gp_Vec, gp_Vec]");

		static		void CoefsD2(const Standard_Real U, const Standard_Real V, const TColgp_Array2OfPnt &Poles, const TColStd_Array2OfReal &Weights, gp_Pnt & Point, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue, gp_Vec &OutValue);
		%feature("autodoc", "1");
