...
%include SMDS_renames.i


%include SMDS_required_python_modules.i
...
class SMDS_VolumeTool {
	public:
		...
		%feature("autodoc", "1");
		bool GetBaryCenter(Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue) const;
		%feature("autodoc", "1");
		...
		bool IsFreeFace(int );
		%feature("autodoc", "1");
		bool GetFaceNormal(int , Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue);
		%feature("autodoc", "1");
