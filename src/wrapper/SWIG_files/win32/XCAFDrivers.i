...
class Handle_XCAFDrivers_DocumentRetrievalDriver : public Handle_MDocStd_DocumentRetrievalDriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XCAFDrivers_DocumentRetrievalDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_XCAFDrivers_DocumentStorageDriver : public Handle_MDocStd_DocumentStorageDriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XCAFDrivers_DocumentStorageDriver DownCast(const Handle_Standard_Transient &AnObject);
