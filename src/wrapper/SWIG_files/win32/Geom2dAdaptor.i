...
%include Geom2dAdaptor_required_python_modules.i
...
class Handle_Geom2dAdaptor_GHCurve : public Handle_Adaptor2d_HCurve2d {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Geom2dAdaptor_GHCurve DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Geom2dAdaptor_HCurve : public Handle_Geom2dAdaptor_GHCurve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Geom2dAdaptor_HCurve DownCast(const Handle_Standard_Transient &AnObject);
