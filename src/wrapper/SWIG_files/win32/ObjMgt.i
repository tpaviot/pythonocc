...
class Handle_ObjMgt_ExternRef : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ObjMgt_ExternRef DownCast(const Handle_Standard_Persistent &AnObject);
...
class Handle_ObjMgt_ExternShareable : public Handle_Standard_Persistent {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ObjMgt_ExternShareable DownCast(const Handle_Standard_Persistent &AnObject);
