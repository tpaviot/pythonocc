...
class Handle_LProp_SequenceNodeOfSequenceOfCIType : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_LProp_SequenceNodeOfSequenceOfCIType DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_LProp_BadContinuity : public Handle_Standard_Failure {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_LProp_BadContinuity DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_LProp_NotDefined : public Handle_Standard_Failure {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_LProp_NotDefined DownCast(const Handle_Standard_Transient &AnObject);
