...
class LocOpe_SplitDrafts {
	public:
		...
		void Init(const TopoDS_Shape S);
		%feature("autodoc", "1");
		void Perform(const TopoDS_Face F, const TopoDS_Wire W, const gp_Dir Extractg, const gp_Pln NPlg, const Standard_Real Angleg, const gp_Dir Extractd, const gp_Pln NPld, const Standard_Real Angled, const Standard_Boolean ModifyLeft=true, const Standard_Boolean ModifyRight=true);
		%feature("autodoc", "1");
