...
class Geom_RectangularTrimmedSurface : public Geom_BoundedSurface {
	public:
		%feature("autodoc", "1");
		Geom_RectangularTrimmedSurface(const Handle_Geom_Surface &S, const Standard_Real U1, const Standard_Real U2, const Standard_Real V1, const Standard_Real V2, const Standard_Boolean USense=true, const Standard_Boolean VSense=true);
		%feature("autodoc", "1");
		Geom_RectangularTrimmedSurface(const Handle_Geom_Surface &S, const Standard_Real Param1, const Standard_Real Param2, const Standard_Boolean UTrim, const Standard_Boolean Sense=true);
		%feature("autodoc", "1");
		void SetTrim(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1, const Standard_Real V2, const Standard_Boolean USense=true, const Standard_Boolean VSense=true);
		%feature("autodoc", "1");
		void SetTrim(const Standard_Real Param1, const Standard_Real Param2, const Standard_Boolean UTrim, const Standard_Boolean Sense=true);
		%feature("autodoc", "1");
...
class Geom_BSplineCurve : public Geom_BoundedCurve {
	public:
		%feature("autodoc", "1");
		Geom_BSplineCurve(const TColgp_Array1OfPnt &Poles, const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Multiplicities, const Standard_Integer Degree, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		Geom_BSplineCurve(const TColgp_Array1OfPnt &Poles, const TColStd_Array1OfReal &Weights, const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Multiplicities, const Standard_Integer Degree, const Standard_Boolean Periodic=false, const Standard_Boolean CheckRational=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void InsertKnot(const Standard_Real U, const Standard_Integer M=1, const Standard_Real ParametricTolerance=0.0, const Standard_Boolean Add=true);
		%feature("autodoc", "1");
...
class Geom_TrimmedCurve : public Geom_BoundedCurve {
	public:
		%feature("autodoc", "1");
		Geom_TrimmedCurve(const Handle_Geom_Curve &C, const Standard_Real U1, const Standard_Real U2, const Standard_Boolean Sense=true);
		%feature("autodoc", "1");
		virtual		void Reverse();
		%feature("autodoc", "1");
		virtual		Standard_Real ReversedParameter(const Standard_Real U) const;
...
class Geom_BSplineSurface : public Geom_BoundedSurface {
	public:
		...
		%feature("autodoc", "1");
		void InsertUKnots(const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Mults, const Standard_Real ParametricTolerance=0.0, const Standard_Boolean Add=true);
		%feature("autodoc", "1");
		void InsertVKnots(const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Mults, const Standard_Real ParametricTolerance=0.0, const Standard_Boolean Add=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void InsertUKnot(const Standard_Real U, const Standard_Integer M, const Standard_Real ParametricTolerance, const Standard_Boolean Add=true);
		%feature("autodoc", "1");
		void InsertVKnot(const Standard_Real V, const Standard_Integer M, const Standard_Real ParametricTolerance, const Standard_Boolean Add=true);
		%feature("autodoc", "1");
		void Segment(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1, const Standard_Real V2);
		%feature("autodoc", "1");
		...
		void LocateU(const Standard_Real U, const Standard_Real ParametricTolerance, Standard_Integer &OutValue, Standard_Integer &OutValue, const Standard_Boolean WithKnotRepetition=false) const;
		%feature("autodoc","LocateV(Standard_Real V, Standard_Real ParametricTolerance, Standard_Boolean WithKnotRepetition=false) -> [Standard_Integer, Standard_Integer]");

		void LocateV(const Standard_Real V, const Standard_Real ParametricTolerance, Standard_Integer &OutValue, Standard_Integer &OutValue, const Standard_Boolean WithKnotRepetition=false) const;
		%feature("autodoc", "1");
		void SetPole(const Standard_Integer UIndex, const Standard_Integer VIndex, const gp_Pnt P);
		%feature("autodoc", "1");
		void SetPole(const Standard_Integer UIndex, const Standard_Integer VIndex, const gp_Pnt P, const Standard_Real Weight);
