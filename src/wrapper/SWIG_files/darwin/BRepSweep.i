...
class Handle_BRepSweep_SequenceNodeOfSequenceOfShapesOfNumLinearRegularSweep : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepSweep_SequenceNodeOfSequenceOfShapesOfNumLinearRegularSweep DownCast(const Handle_Standard_Transient &AnObject);
...
class BRepSweep_Translation : public BRepSweep_Trsf {
	public:
		%feature("autodoc", "1");
		BRepSweep_Translation(const TopoDS_Shape S, const Sweep_NumShape &N, const TopLoc_Location &L, const gp_Vec V, const Standard_Boolean C, const Standard_Boolean Canonize=true);
		%feature("autodoc", "1");
		virtual		TopAbs_Orientation DirectSolid(const TopoDS_Shape aGenS, const Sweep_NumShape &aDirS);
		%feature("autodoc", "1");
		gp_Vec Vec() const;
...
class BRepSweep_Revol {
	public:
		%feature("autodoc", "1");
		BRepSweep_Revol(const TopoDS_Shape S, const gp_Ax1 A, const Quantity_PlaneAngle D, const Standard_Boolean C=false);
		%feature("autodoc", "1");
		BRepSweep_Revol(const TopoDS_Shape S, const gp_Ax1 A, const Standard_Boolean C=false);
		%feature("autodoc", "1");
		TopoDS_Shape Shape();
		%feature("autodoc", "1");
		TopoDS_Shape Shape(const TopoDS_Shape aGenS);
...
class BRepSweep_Prism {
	public:
		%feature("autodoc", "1");
		BRepSweep_Prism(const TopoDS_Shape S, const gp_Vec V, const Standard_Boolean Copy=false, const Standard_Boolean Canonize=true);
		%feature("autodoc", "1");
		BRepSweep_Prism(const TopoDS_Shape S, const gp_Dir D, const Standard_Boolean Inf=true, const Standard_Boolean Copy=false, const Standard_Boolean Canonize=true);
		%feature("autodoc", "1");
		TopoDS_Shape Shape();
		%feature("autodoc", "1");
		TopoDS_Shape Shape(const TopoDS_Shape aGenS);
