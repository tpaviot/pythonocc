...
class Poly {
	public:
		...
		%feature("autodoc", "1");
		static		void Write(const Handle_Poly_Triangulation &T, Standard_OStream & OS, const Standard_Boolean Compact=true);
		%feature("autodoc", "1");
		static		void Write(const Handle_Poly_Polygon3D &P, Standard_OStream & OS, const Standard_Boolean Compact=true);
		%feature("autodoc", "1");
		static		void Write(const Handle_Poly_Polygon2D &P, Standard_OStream & OS, const Standard_Boolean Compact=true);
		%feature("autodoc", "1");
