...
%include BRepFeat_required_python_modules.i
...
class BRepFeat_MakeCylindricalHole : public BRepFeat_Builder {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Standard_Real Radius, const Standard_Real PFrom, const Standard_Real PTo, const Standard_Boolean WithControl=true);
		%feature("autodoc", "1");
		void PerformThruNext(const Standard_Real Radius, const Standard_Boolean WithControl=true);
		%feature("autodoc", "1");
		void PerformUntilEnd(const Standard_Real Radius, const Standard_Boolean WithControl=true);
		%feature("autodoc", "1");
		void PerformBlind(const Standard_Real Radius, const Standard_Real Length, const Standard_Boolean WithControl=true);
		%feature("autodoc", "1");
...
class BRepFeat {
	public:
		...
		%feature("autodoc","ParametricMinMax(const S, const C, Standard_Boolean Ori=false) -> [Standard_Real, Standard_Real, Standard_Real, Standard_Real]");

		static		void ParametricMinMax(const TopoDS_Shape S, const Handle_Geom_Curve &C, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Boolean & flag, const Standard_Boolean Ori=false);
		%feature("autodoc", "1");
