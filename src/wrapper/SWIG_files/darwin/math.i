...
class math_FunctionSetRoot {
	public:
		...
		%feature("autodoc", "1");
		math_FunctionSetRoot(math_FunctionSetWithDerivatives & F, const math_Vector &StartingPoint, const math_Vector &Tolerance, const math_Vector &infBound, const math_Vector &supBound, const Standard_Integer NbIterations=100, const Standard_Boolean theStopOnDivergent=false);
		%feature("autodoc", "1");
		virtual		void Delete();
		%feature("autodoc", "1");
		void SetTolerance(const math_Vector &Tolerance);
		%feature("autodoc", "1");
		void Perform(math_FunctionSetWithDerivatives & F, const math_Vector &StartingPoint, const math_Vector &infBound, const math_Vector &supBound, const Standard_Boolean theStopOnDivergent=false);
		%feature("autodoc", "1");
