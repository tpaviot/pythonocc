...
class FairCurve_Newton : public math_NewtonMinimum {
	public:
		%feature("autodoc", "1");
		FairCurve_Newton(math_MultipleVarFunctionWithHessian & F, const math_Vector &StartingPoint, const Standard_Real SpatialTolerance=9.99999999999999954748111825886258685613938723690807819366e-8, const Standard_Real CriteriumTolerance=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Integer NbIterations=40, const Standard_Real Convexity=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Boolean WithSingularity=true);
		%feature("autodoc", "1");
		FairCurve_Newton(math_MultipleVarFunctionWithHessian & F, const Standard_Real SpatialTolerance=9.99999999999999954748111825886258685613938723690807819366e-8, const Standard_Real Tolerance=9.99999999999999954748111825886258685613938723690807819366e-8, const Standard_Integer NbIterations=40, const Standard_Real Convexity=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Boolean WithSingularity=true);
		%feature("autodoc", "1");
...
class FairCurve_DistributionOfTension : public FairCurve_DistributionOfEnergy {
	public:
		%feature("autodoc", "1");
		FairCurve_DistributionOfTension(const Standard_Integer BSplOrder, const Handle_TColStd_HArray1OfReal &FlatKnots, const Handle_TColgp_HArray1OfPnt2d &Poles, const Standard_Integer DerivativeOrder, const Standard_Real LengthSliding, const FairCurve_BattenLaw &Law, const Standard_Integer NbValAux=0, const Standard_Boolean Uniform=false);
		%feature("autodoc", "1");
