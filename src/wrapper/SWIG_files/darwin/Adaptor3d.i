...
class Adaptor3d_TopolTool : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		virtual		TopAbs_State Classify(const gp_Pnt2d P, const Standard_Real Tol, const Standard_Boolean ReacdreOnPeriodic=true);
		%feature("autodoc", "1");
		virtual		Standard_Boolean IsThePointOn(const gp_Pnt2d P, const Standard_Real Tol, const Standard_Boolean ReacdreOnPeriodic=true);
		%feature("autodoc", "1");
