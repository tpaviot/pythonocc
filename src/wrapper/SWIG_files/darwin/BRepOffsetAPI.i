...
class BRepOffsetAPI_MakeFilling : public BRepBuilderAPI_MakeShape {
	public:
		%feature("autodoc", "1");
		BRepOffsetAPI_MakeFilling(const Standard_Integer Degree=3, const Standard_Integer NbPtsOnCur=15, const Standard_Integer NbIter=2, const Standard_Boolean Anisotropie=false, const Standard_Real Tol2d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Real Tol3d=1.00000000000000004792173602385929598312941379845142364502e-4, const Standard_Real TolAng=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Real TolCurv=1.000000000000000055511151231257827021181583404541015625e-1, const Standard_Integer MaxDeg=8, const Standard_Integer MaxSegments=9);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Integer Add(const TopoDS_Edge Constr, const GeomAbs_Shape Order, const Standard_Boolean IsBound=true);
		%feature("autodoc", "1");
		Standard_Integer Add(const TopoDS_Edge Constr, const TopoDS_Face Support, const GeomAbs_Shape Order, const Standard_Boolean IsBound=true);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_DraftAngle : public BRepBuilderAPI_ModifyShape {
	public:
		...
		%feature("autodoc", "1");
		void Add(const TopoDS_Face F, const gp_Dir Direction, const Standard_Real Angle, const gp_Pln NeutralPlane, const Standard_Boolean Flag=true);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_MakePipeShell : public BRepPrimAPI_MakeSweep {
	public:
		...
		%feature("autodoc", "1");
		void SetMode(const Standard_Boolean IsFrenet=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetMode(const TopoDS_Wire AuxiliarySpine, const Standard_Boolean CurvilinearEquivalence, const Standard_Boolean KeepContact=false);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_MakeOffsetShape : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepOffsetAPI_MakeOffsetShape(const TopoDS_Shape S, const Standard_Real Offset, const Standard_Real Tol, const BRepOffset_Mode Mode=BRepOffset_Skin, const Standard_Boolean Intersection=false, const Standard_Boolean SelfInter=false, const GeomAbs_JoinType Join=GeomAbs_Arc);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_MakeThickSolid : public BRepOffsetAPI_MakeOffsetShape {
	public:
		...
		%feature("autodoc", "1");
		BRepOffsetAPI_MakeThickSolid(const TopoDS_Shape S, const TopTools_ListOfShape &ClosingFaces, const Standard_Real Offset, const Standard_Real Tol, const BRepOffset_Mode Mode=BRepOffset_Skin, const Standard_Boolean Intersection=false, const Standard_Boolean SelfInter=false, const GeomAbs_JoinType Join=GeomAbs_Arc);
		%feature("autodoc", "1");
		virtual		const TopTools_ListOfShape & Modified(const TopoDS_Shape S);
...
class BRepOffsetAPI_MakeEvolved : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepOffsetAPI_MakeEvolved(const TopoDS_Wire Spine, const TopoDS_Wire Profil, const GeomAbs_JoinType Join=GeomAbs_Arc, const Standard_Boolean AxeProf=true, const Standard_Boolean Solid=false, const Standard_Boolean ProfOnSpine=false, const Standard_Real Tol=9.99999999999999954748111825886258685613938723690807819366e-8);
		%feature("autodoc", "1");
		BRepOffsetAPI_MakeEvolved(const TopoDS_Face Spine, const TopoDS_Wire Profil, const GeomAbs_JoinType Join=GeomAbs_Arc, const Standard_Boolean AxeProf=true, const Standard_Boolean Solid=false, const Standard_Boolean ProfOnSpine=false, const Standard_Real Tol=9.99999999999999954748111825886258685613938723690807819366e-8);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_NormalProjection : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		void SetLimit(const Standard_Boolean FaceBoundaries=true);
		%feature("autodoc", "1");
		void Compute3d(const Standard_Boolean With3d=true);
		%feature("autodoc", "1");
		virtual		void Build();
		%feature("autodoc", "1");
		virtual		Standard_Boolean IsDone() const;
...
class BRepOffsetAPI_ThruSections : public BRepBuilderAPI_MakeShape {
	public:
		%feature("autodoc", "1");
		BRepOffsetAPI_ThruSections(const Standard_Boolean isSolid=false, const Standard_Boolean ruled=false, const Standard_Real pres3d=9.99999999999999954748111825886258685613938723690807819366e-7);
		%feature("autodoc", "1");
		void Init(const Standard_Boolean isSolid=false, const Standard_Boolean ruled=false, const Standard_Real pres3d=9.99999999999999954748111825886258685613938723690807819366e-7);
		%feature("autodoc", "1");
		void AddWire(const TopoDS_Wire wire);
		%feature("autodoc", "1");
		void AddVertex(const TopoDS_Vertex aVertex);
		%feature("autodoc", "1");
		void CheckCompatibility(const Standard_Boolean check=true);
		%feature("autodoc", "1");
...
class BRepOffsetAPI_MakePipe : public BRepPrimAPI_MakeSweep {
	public:
		...
		%feature("autodoc", "1");
		BRepOffsetAPI_MakePipe(const TopoDS_Wire Spine, const TopoDS_Shape Profile, const GeomFill_Trihedron aMode, const Standard_Boolean ForceApproxC1=false);
		%feature("autodoc", "1");
