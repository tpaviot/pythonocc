...
class Units_UnitsSystem : public MMgt_TShared {
	public:
		...
		Units_UnitsSystem();
		%feature("autodoc", "1");
		Units_UnitsSystem(const char * aName, const Standard_Boolean Verbose=false);
		%feature("autodoc", "1");
...
class Units_UnitsLexicon : public Units_Lexicon {
	public:
		...
		Units_UnitsLexicon();
		%feature("autodoc", "1");
		void Creates(const char * afilename1, const char * afilename2, const Standard_Boolean amode=true);
		%feature("autodoc", "1");
...
class Units {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Units_UnitsDictionary DictionaryOfUnits(const Standard_Boolean amode=false);
		%feature("autodoc", "1");
		static		Handle_Units_Quantity Quantity(const char * aquantity);
		%feature("autodoc", "1");
		static		char * FirstQuantity(const char * aunit);
		%feature("autodoc", "1");
		static		Handle_Units_Lexicon LexiconUnits(const Standard_Boolean amode=true);
		%feature("autodoc", "1");
