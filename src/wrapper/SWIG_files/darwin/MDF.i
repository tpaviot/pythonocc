...
class MDF_SRelocationTable : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		MDF_SRelocationTable(const Standard_Boolean theSelfRelocation=false);
		%feature("autodoc", "1");
		void SetSelfRelocation(const Standard_Boolean theStatus=true);
		%feature("autodoc", "1");
...
class MDF_RRelocationTable : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		MDF_RRelocationTable(const Standard_Boolean theSelfRelocation=false);
		%feature("autodoc", "1");
		void SetSelfRelocation(const Standard_Boolean theStatus=true);
		%feature("autodoc", "1");
		Standard_Boolean IsSelfRelocation() const;
