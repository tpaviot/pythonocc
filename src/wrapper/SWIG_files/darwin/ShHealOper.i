...
class Handle_ShHealOper_SplitCurve3d : public Handle_ShapeUpgrade_SplitCurve3d {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ShHealOper_SplitCurve3d DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_ShHealOper_SplitCurve2d : public Handle_ShapeUpgrade_SplitCurve2d {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ShHealOper_SplitCurve2d DownCast(const Handle_Standard_Transient &AnObject);
...
class ShHealOper_CloseContour : public ShHealOper_Tool {
	public:
		...
		virtual		void Init(const TopoDS_Shape theShape);
		%feature("autodoc", "1");
		Standard_Boolean Perform(const TopTools_SequenceOfShape &theSeqEdges, const Standard_Boolean theModeVertex=false, const Standard_Boolean theModeFixGapsCurves=true);
		%feature("autodoc", "1");
		Standard_Boolean Perform(const TopoDS_Wire theWire, const Standard_Boolean theModeVertex=false, const Standard_Boolean theModeFixGapsCurves=true);
		%feature("autodoc", "1");
...
class ShHealOper_EdgeDivide : public ShHealOper_Tool {
	public:
		...
		virtual		void Init(const TopoDS_Shape theShape);
		%feature("autodoc", "1");
		Standard_Boolean Perform(const TopoDS_Shape theEdge, const Standard_Real theValue, const Standard_Boolean theDivideParamMode=true);
		%feature("autodoc", "1");
		Standard_Boolean Perform(const TopoDS_Shape theEdge, const TColStd_SequenceOfReal &theValues, const Standard_Boolean theDivideParamMode=true);
