...
%include IGESControl_required_python_modules.i
...
class IGESControl_Reader : public XSControl_Reader {
	public:
		...
		IGESControl_Reader();
		%feature("autodoc", "1");
		IGESControl_Reader(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
...
class IGESControl_Writer {
	public:
		...
		void ComputeModel();
		%feature("autodoc", "1");
		Standard_Boolean Write(Standard_OStream & S, const Standard_Boolean fnes=false);
		%feature("autodoc", "1");
		Standard_Boolean Write(const char * file, const Standard_Boolean fnes=false);
		%feature("autodoc", "1");
...
class IGESControl_Controller : public XSControl_Controller {
	public:
		%feature("autodoc", "1");
		IGESControl_Controller(const Standard_Boolean modefnes=false);
		%feature("autodoc", "1");
