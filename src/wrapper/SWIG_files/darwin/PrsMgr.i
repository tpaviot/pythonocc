...
class PrsMgr_PresentationManager : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		virtual		void EndDraw(const Handle_V3d_View &aView, const Standard_Boolean DoubleBuffer=false);
		%feature("autodoc", "1");
...
class PrsMgr_PresentationManager3d : public PrsMgr_PresentationManager {
	public:
		...
		%feature("autodoc", "1");
		virtual		void EndDraw(const Handle_V3d_View &theView, const Standard_Boolean DoubleBuffer=false);
		%feature("autodoc", "1");
