...
%include Geom2dConvert_required_python_modules.i
...
class Geom2dConvert {
	public:
		...
		Geom2dConvert();
		%feature("autodoc", "1");
		static		Handle_Geom2d_BSplineCurve SplitBSplineCurve(const Handle_Geom2d_BSplineCurve &C, const Standard_Integer FromK1, const Standard_Integer ToK2, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom2d_BSplineCurve SplitBSplineCurve(const Handle_Geom2d_BSplineCurve &C, const Standard_Real FromU1, const Standard_Real ToU2, const Standard_Real ParametricTolerance, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
...
class Geom2dConvert_CompCurveToBSplineCurve {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean Add(const Handle_Geom2d_BoundedCurve &NewCurve, const Standard_Real Tolerance, const Standard_Boolean After=false);
		%feature("autodoc", "1");
