...
class StdSelect_BRepOwner : public SelectMgr_EntityOwner {
	public:
		...
		%feature("autodoc", "1");
		StdSelect_BRepOwner(const TopoDS_Shape aShape, const Standard_Integer aPriority=0, const Standard_Boolean ComesFromDecomposition=false);
		%feature("autodoc", "1");
		StdSelect_BRepOwner(const TopoDS_Shape aShape, const Handle_SelectMgr_SelectableObject &theOrigin, const Standard_Integer aPriority=0, const Standard_Boolean FromDecomposition=false);
		%feature("autodoc", "1");
...
class StdSelect_BRepHilighter {
	public:
		...
		void Process();
		%feature("autodoc", "1");
		void Process(const Handle_V3d_View &aView, const Standard_Boolean DoubleBuffer=false);
		%feature("autodoc", "1");
		void Clear();
		%feature("autodoc", "1");
...
class StdSelect_BRepSelectionTool {
	public:
		...
		%feature("autodoc", "1");
		static		void Load(const Handle_SelectMgr_Selection &aSelection, const TopoDS_Shape aShape, const TopAbs_ShapeEnum aType, const Standard_Real theDeflection, const Standard_Real theDeviationAngle, const Standard_Boolean AutoTriangulation=true, const Standard_Integer aPriority=-0x00000000000000001, const Standard_Integer NbPOnEdge=9, const Standard_Real MaximalParameter=500);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		void ComputeSensitive(const TopoDS_Shape aShape, const Handle_StdSelect_BRepOwner &anOwner, const Handle_SelectMgr_Selection &aSelection, const Standard_Real theDeflection, const Standard_Real theDeviationAngle, const Standard_Integer NbPOnEdge, const Standard_Real MaximalParameter, const Standard_Boolean AutoTriangulation=true);
		%feature("autodoc", "1");
		static		Standard_Boolean GetSensitiveForFace(const TopoDS_Face aFace, const Handle_StdSelect_BRepOwner &anOwner, Select3D_ListOfSensitive & OutList, const Standard_Boolean AutoTriangulation=true, const Standard_Integer NbPOnEdge=9, const Standard_Real MaxiParam=500, const Standard_Boolean InteriorFlag=true);
