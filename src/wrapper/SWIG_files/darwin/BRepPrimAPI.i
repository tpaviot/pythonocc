...
%include BRepPrimAPI_required_python_modules.i
...
class BRepPrimAPI_MakeRevol : public BRepPrimAPI_MakeSweep {
	public:
		%feature("autodoc", "1");
		BRepPrimAPI_MakeRevol(const TopoDS_Shape S, const gp_Ax1 A, const Standard_Real D, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		BRepPrimAPI_MakeRevol(const TopoDS_Shape S, const gp_Ax1 A, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
...
class BRepPrimAPI_MakePrism : public BRepPrimAPI_MakeSweep {
	public:
		%feature("autodoc", "1");
		BRepPrimAPI_MakePrism(const TopoDS_Shape S, const gp_Vec V, const Standard_Boolean Copy=false, const Standard_Boolean Canonize=true);
		%feature("autodoc", "1");
		BRepPrimAPI_MakePrism(const TopoDS_Shape S, const gp_Dir D, const Standard_Boolean Inf=true, const Standard_Boolean Copy=false, const Standard_Boolean Canonize=true);
		%feature("autodoc", "1");
