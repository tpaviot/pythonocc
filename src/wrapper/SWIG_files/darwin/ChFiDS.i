...
class Handle_ChFiDS_Spine : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ChFiDS_Spine DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_ChFiDS_ChamfSpine : public Handle_ChFiDS_Spine {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ChFiDS_ChamfSpine DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_ChFiDS_HElSpine : public Handle_Adaptor3d_HCurve {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ChFiDS_HElSpine DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_ChFiDS_SurfData : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ChFiDS_SurfData DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_ChFiDS_ListNodeOfRegularities : public Handle_TCollection_MapNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_ChFiDS_ListNodeOfRegularities DownCast(const Handle_Standard_Transient &AnObject);
...
class ChFiDS_Spine : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		virtual		void Reset(const Standard_Boolean AllData=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc","Parameter(Standard_Real AbsC, Standard_Boolean Oriented=true) -> Standard_Real");

		void Parameter(const Standard_Real AbsC, Standard_Real &OutValue, const Standard_Boolean Oriented=true);
		%feature("autodoc","Parameter(Standard_Integer Index, Standard_Real AbsC, Standard_Boolean Oriented=true) -> Standard_Real");

		void Parameter(const Standard_Integer Index, const Standard_Real AbsC, Standard_Real &OutValue, const Standard_Boolean Oriented=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Integer Index(const Standard_Real W, const Standard_Boolean Forward=true) const;
		%feature("autodoc", "1");
...
class ChFiDS_Regul {
	public:
		...
		%feature("autodoc", "1");
		void SetS1(const Standard_Integer IS1, const Standard_Boolean IsFace=true);
		%feature("autodoc", "1");
		void SetS2(const Standard_Integer IS2, const Standard_Boolean IsFace=true);
		%feature("autodoc", "1");
