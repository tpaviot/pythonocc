...
%include AIS_renames.i


%include AIS_required_python_modules.i
...
class AIS_InteractiveObject : public SelectMgr_SelectableObject {
	public:
		...
		%feature("autodoc", "1");
		void Redisplay(const Standard_Boolean AllModes=false);
		%feature("autodoc", "1");
		void SetInfiniteState(const Standard_Boolean aFlag=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetTransformation(const Handle_Geom_Transformation &aTranformation, const Standard_Boolean postConcatenate=false, const Standard_Boolean updateSelection=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetAspect(const Handle_Prs3d_BasicAspect &anAspect, const Standard_Boolean globalChange=true);
		%feature("autodoc", "1");
...
class AIS_ExclusionFilter : public SelectMgr_Filter {
	public:
		%feature("autodoc", "1");
		AIS_ExclusionFilter(const Standard_Boolean ExclusionFlagOn=true);
		%feature("autodoc", "1");
		AIS_ExclusionFilter(const AIS_KindOfInteractive TypeToExclude, const Standard_Boolean ExclusionFlagOn=true);
		%feature("autodoc", "1");
		AIS_ExclusionFilter(const AIS_KindOfInteractive TypeToExclude, const Standard_Integer SignatureInType, const Standard_Boolean ExclusionFlagOn=true);
		%feature("autodoc", "1");
...
class AIS_TexturedShape : public AIS_Shape {
	public:
		...
		%feature("autodoc", "1");
		virtual		void ShowTriangles(const Standard_Boolean ShowTrianglesYN=false);
		%feature("autodoc", "1");
...
class AIS_LocalStatus : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		AIS_LocalStatus(const Standard_Boolean IsTemporary=true, const Standard_Boolean Decompose=false, const Standard_Integer DisplayMode=-0x00000000000000001, const Standard_Integer SelectionMode=-0x00000000000000001, const Standard_Integer HilightMode=0, const Standard_Boolean SubIntensity=0, const Quantity_NameOfColor TheHiCol=Quantity_NOC_WHITE);
		%feature("autodoc", "1");
...
class AIS_LocalContext : public MMgt_TShared {
	public:
		...
		AIS_LocalContext();
		%feature("autodoc", "1");
		AIS_LocalContext(const Handle_AIS_InteractiveContext &aCtx, const Standard_Integer anIndex, const Standard_Boolean LoadDisplayed=true, const Standard_Boolean AcceptStandardModes=true, const Standard_Boolean AcceptErase=false, const Standard_Boolean UseBothViewers=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Terminate(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		Standard_Boolean HasSameProjector(const Handle_Select3D_Projector &aPrj) const;
		%feature("autodoc", "1");
		Standard_Boolean Display(const Handle_AIS_InteractiveObject &anInteractive, const Standard_Integer DisplayMode=0, const Standard_Boolean AllowShapeDecomposition=true, const Standard_Integer ActivationMode=0);
		%feature("autodoc", "1");
		Standard_Boolean Load(const Handle_AIS_InteractiveObject &anInteractive, const Standard_Boolean AllowShapeDecomposition=true, const Standard_Integer ActivationMode=0);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		AIS_StatusOfPick Select(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfPick ShiftSelect(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfPick Select(const Standard_Integer XPMin, const Standard_Integer YPMin, const Standard_Integer XPMax, const Standard_Integer YPMax, const Handle_V3d_View &aView, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfPick ShiftSelect(const Standard_Integer XPMin, const Standard_Integer YPMin, const Standard_Integer XPMax, const Standard_Integer YPMax, const Handle_V3d_View &aView, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfPick Select(const TColgp_Array1OfPnt2d &Polyline, const Handle_V3d_View &aView, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfPick ShiftSelect(const TColgp_Array1OfPnt2d &Polyline, const Handle_V3d_View &aView, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void HilightPicked(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnhilightPicked(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UpdateSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UpdateSelected(const Handle_AIS_InteractiveObject &anobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetSelected(const Handle_AIS_InteractiveObject &anobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const Handle_AIS_InteractiveObject &anobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const TopoDS_Shape aShape, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const Handle_SelectMgr_EntityOwner &Ownr, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void ClearSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean EndImmediateDraw(const Handle_V3d_View &aView, const Standard_Boolean DoubleBuf=false);
		%feature("autodoc", "1");
...
class AIS_Plane : public AIS_InteractiveObject {
	public:
		%feature("autodoc", "1");
		AIS_Plane(const Handle_Geom_Plane &aComponent, const Standard_Boolean aCurrentMode=false);
		%feature("autodoc", "1");
		AIS_Plane(const Handle_Geom_Plane &aComponent, const gp_Pnt aCenter, const Standard_Boolean aCurrentMode=false);
		%feature("autodoc", "1");
		AIS_Plane(const Handle_Geom_Plane &aComponent, const gp_Pnt aCenter, const gp_Pnt aPmin, const gp_Pnt aPmax, const Standard_Boolean aCurrentMode=false);
		%feature("autodoc", "1");
		AIS_Plane(const Handle_Geom_Axis2Placement &aComponent, const AIS_TypeOfPlane aPlaneType, const Standard_Boolean aCurrentMode=false);
		%feature("autodoc", "1");
		void SetSize(const Standard_Real aValue);
		%feature("autodoc", "1");
...
class AIS_Circle : public AIS_InteractiveObject {
	public:
		...
		%feature("autodoc", "1");
		AIS_Circle(const Handle_Geom_Circle &aCircle, const Standard_Real aUStart, const Standard_Real aUEnd, const Standard_Boolean aSens=true);
		%feature("autodoc", "1");
		virtual		void Compute(const Handle_Prs3d_Projector &aProjector, const Handle_Geom_Transformation &aTrsf, const Handle_Prs3d_Presentation &aPresentation);
		%feature("autodoc", "1");
		virtual		Standard_Integer Signature() const;
...
class AIS_InteractiveContext : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void Display(const Handle_AIS_InteractiveObject &anIobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void Display(const Handle_AIS_InteractiveObject &anIobj, const Standard_Integer amode, const Standard_Integer aSelectionMode, const Standard_Boolean updateviewer=true, const Standard_Boolean allowdecomposition=true);
		%feature("autodoc", "1");
		void Load(const Handle_AIS_InteractiveObject &aniobj, const Standard_Integer SelectionMode=-0x00000000000000001, const Standard_Boolean AllowDecomp=false);
		%feature("autodoc", "1");
		void Erase(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true, const Standard_Boolean PutInCollector=false);
		%feature("autodoc", "1");
		void EraseMode(const Handle_AIS_InteractiveObject &aniobj, const Standard_Integer aMode, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void EraseAll(const Standard_Boolean PutInCollector=false, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void DisplayAll(const Standard_Boolean OnlyFromCollector=false, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void DisplayFromCollector(const Handle_AIS_InteractiveObject &anIObj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void EraseSelected(const Standard_Boolean PutInCollector=false, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void DisplaySelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Clear(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void ClearPrs(const Handle_AIS_InteractiveObject &aniobj, const Standard_Integer aMode=0, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void Remove(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void RemoveAll(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void Hilight(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void HilightWithColor(const Handle_AIS_InteractiveObject &aniobj, const Quantity_NameOfColor aCol, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void Unhilight(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		Standard_Integer GetZLayer(const Handle_AIS_InteractiveObject &theIObj) const;
		%feature("autodoc", "1");
		void Redisplay(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true, const Standard_Boolean allmodes=false);
		%feature("autodoc", "1");
		void Redisplay(const AIS_KindOfInteractive aTypeOfObject, const Standard_Integer Signature=-0x00000000000000001, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void RecomputePrsOnly(const Handle_AIS_InteractiveObject &anIobj, const Standard_Boolean updateviewer=true, const Standard_Boolean allmodes=false);
		%feature("autodoc", "1");
		void RecomputeSelectionOnly(const Handle_AIS_InteractiveObject &anIObj);
		%feature("autodoc", "1");
		void Update(const Handle_AIS_InteractiveObject &anIobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetDisplayMode(const Handle_AIS_InteractiveObject &aniobj, const Standard_Integer aMode, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnsetDisplayMode(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetColor(const Handle_AIS_InteractiveObject &aniobj, const Quantity_NameOfColor aColor, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetColor(const Handle_AIS_InteractiveObject &aniobj, const Quantity_Color &aColor, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnsetColor(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		virtual		void SetWidth(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real aValue, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		virtual		void UnsetWidth(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetMaterial(const Handle_AIS_InteractiveObject &aniobj, const Graphic3d_NameOfMaterial aName, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnsetMaterial(const Handle_AIS_InteractiveObject &anObj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetTransparency(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real aValue=5.9999999999999997779553950749686919152736663818359375e-1, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnsetTransparency(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetLocalAttributes(const Handle_AIS_InteractiveObject &aniobj, const Handle_AIS_Drawer &aDrawer, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnsetLocalAttributes(const Handle_AIS_InteractiveObject &anObj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetPolygonOffsets(const Handle_AIS_InteractiveObject &anObj, const Standard_Integer aMode, const Standard_ShortReal aFactor=1.0e+0, const Standard_ShortReal aUnits=0.0, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetTrihedronSize(const Standard_Real aSize, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		Standard_Real TrihedronSize() const;
		%feature("autodoc", "1");
		void SetPlaneSize(const Standard_Real aSizeX, const Standard_Real aSizeY, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetPlaneSize(const Standard_Real aSize, const Standard_Boolean updateviewer=true);
		%feature("autodoc","PlaneSize() -> [Standard_Real, Standard_Real]");
		...
		%feature("autodoc", "1");
		void SetDisplayMode(const AIS_DisplayMode AMode, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetDeviationCoefficient(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real aCoefficient, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetDeviationAngle(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real anAngle, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetAngleAndDeviation(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real anAngle, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetHLRDeviationCoefficient(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real aCoefficient, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetHLRDeviationAngle(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real anAngle, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetHLRAngleAndDeviation(const Handle_AIS_InteractiveObject &aniobj, const Standard_Real anAngle, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetSelectedAspect(const Handle_Prs3d_BasicAspect &anAspect, const Standard_Boolean globalChange=true, const Standard_Boolean updateViewer=true);
		%feature("autodoc", "1");
		AIS_StatusOfDetection MoveTo(const Standard_Integer XPix, const Standard_Integer YPix, const Handle_V3d_View &aView);
		%feature("autodoc", "1");
		Standard_Boolean HasNextDetected() const;
		...
		%feature("autodoc", "1");
		void SetCurrentObject(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveCurrentObject(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UpdateCurrent();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void HilightCurrents(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnhilightCurrents(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void ClearCurrents(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetSelected(const Handle_AIS_InteractiveObject &aniObj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SetSelectedCurrent();
		%feature("autodoc", "1");
		void UpdateSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void HilightSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void UnhilightSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void ClearSelected(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const TopoDS_Shape aShape, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddOrRemoveSelected(const Handle_SelectMgr_EntityOwner &anOwner, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		Standard_Boolean IsSelected(const Handle_AIS_InteractiveObject &aniobj) const;
		%feature("autodoc", "1");
		void InitSelected();
		...
		Handle_AIS_InteractiveObject DetectedCurrentObject() const;
		%feature("autodoc", "1");
		Standard_Integer OpenLocalContext(const Standard_Boolean UseDisplayedObjects=true, const Standard_Boolean AllowShapeDecomposition=true, const Standard_Boolean AcceptEraseOfObjects=false, const Standard_Boolean BothViewers=false);
		%feature("autodoc", "1");
		void CloseLocalContext(const Standard_Integer Index=-0x00000000000000001, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		Standard_Integer IndexOfCurrentLocal() const;
		%feature("autodoc", "1");
		void CloseAllContexts(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void ResetOriginalState(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		...
		Standard_Boolean EndImmediateDraw(const Handle_V3d_View &aView, const Standard_Boolean DoubleBuf=false);
		%feature("autodoc", "1");
		Standard_Boolean EndImmediateDraw(const Standard_Boolean DoubleBuf=false);
		%feature("autodoc", "1");
		Standard_Boolean IsImmediateModeOn() const;
		%feature("autodoc", "1");
		void Drag(const Handle_V3d_View &aView, const Handle_AIS_InteractiveObject &anObject, const Handle_Geom_Transformation &aTranformation, const Standard_Boolean postConcatenate=false, const Standard_Boolean update=false, const Standard_Boolean zBuffer=false);
		%feature("autodoc", "1");
		void SetAutomaticHilight(const Standard_Boolean aStatus);
		%feature("autodoc", "1");
		Standard_Boolean AutomaticHilight() const;
		%feature("autodoc", "1");
		void SetZDetection(const Standard_Boolean aStatus=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetTemporaryAttributes(const Handle_AIS_InteractiveObject &anObj, const Handle_Prs3d_Drawer &aDrawer, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SubIntensityOn(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SubIntensityOff(const Handle_AIS_InteractiveObject &aniobj, const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SubIntensityOn(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void SubIntensityOff(const Standard_Boolean updateviewer=true);
		%feature("autodoc", "1");
		void AddFilter(const Handle_SelectMgr_Filter &aFilter);
		%feature("autodoc", "1");
		void RemoveFilter(const Handle_SelectMgr_Filter &aFilter);
		...
		%feature("autodoc", "1");
		void DisplayedObjects(AIS_ListOfInteractive & aListOfIO, const Standard_Boolean OnlyFromNeutral=false) const;
		%feature("autodoc", "1");
		void DisplayedObjects(const AIS_KindOfInteractive WhichKind, const Standard_Integer WhichSignature, AIS_ListOfInteractive & aListOfIO, const Standard_Boolean OnlyFromNeutral=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Integer PurgeDisplay(const Standard_Boolean CollectorToo=false);
		%feature("autodoc", "1");
...
class AIS_GlobalStatus : public MMgt_TShared {
	public:
		...
		AIS_GlobalStatus();
		%feature("autodoc", "1");
		AIS_GlobalStatus(const AIS_DisplayStatus aStat, const Standard_Integer aDispMode, const Standard_Integer aSelMode, const Standard_Boolean ishilighted=false, const Quantity_NameOfColor TheHiCol=Quantity_NOC_WHITE, const Standard_Integer aLayerIndex=0);
		%feature("autodoc", "1");
