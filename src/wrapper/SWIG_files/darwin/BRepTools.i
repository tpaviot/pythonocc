...
class BRepTools_ReShape : public MMgt_TShared {
	public:
		...
		void Clear();
		%feature("autodoc", "1");
		void Remove(const TopoDS_Shape shape, const Standard_Boolean oriented=false);
		%feature("autodoc", "1");
		void Replace(const TopoDS_Shape shape, const TopoDS_Shape newshape, const Standard_Boolean oriented=false);
		%feature("autodoc", "1");
		Standard_Boolean IsRecorded(const TopoDS_Shape shape) const;
		%feature("autodoc", "1");
		TopoDS_Shape Value(const TopoDS_Shape shape) const;
		%feature("autodoc", "1");
		virtual		Standard_Integer Status(const TopoDS_Shape shape, TopoDS_Shape & newsh, const Standard_Boolean last=false);
		%feature("autodoc", "1");
...
class BRepTools_ShapeSet : public TopTools_ShapeSet {
	public:
		%feature("autodoc", "1");
		BRepTools_ShapeSet(const Standard_Boolean isWithTriangles=true);
		%feature("autodoc", "1");
		BRepTools_ShapeSet(const BRep_Builder &B, const Standard_Boolean isWithTriangles=true);
		%feature("autodoc", "1");
		virtual		void Clear();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void WritePolygon3D(Standard_OStream & OS, const Standard_Boolean Compact=true) const;
		%feature("autodoc", "1");
		%feature("autodoc", "1");
		%extend{
		...
		%feature("autodoc", "1");
		void WriteTriangulation(Standard_OStream & OS, const Standard_Boolean Compact=true) const;
		%feature("autodoc", "1");
		%feature("autodoc", "1");
		%extend{
		...
		%feature("autodoc", "1");
		void WritePolygonOnTriangulation(Standard_OStream & OS, const Standard_Boolean Compact=true) const;
		%feature("autodoc", "1");
		%feature("autodoc", "1");
		%extend{
