...
class BRepAlgo {
	public:
		...
		%feature("autodoc", "1");
		static		Standard_Boolean IsValid(const TopTools_ListOfShape &theArgs, const TopoDS_Shape theResult, const Standard_Boolean closedSolid=false, const Standard_Boolean GeomCtrl=true);
		%feature("autodoc", "1");
...
class BRepAlgo_FaceRestrictor {
	public:
		...
		%feature("autodoc", "1");
		void Init(const TopoDS_Face F, const Standard_Boolean Proj=false, const Standard_Boolean ControlOrientation=false);
		%feature("autodoc", "1");
...
class BRepAlgo_Section : public BRepAlgo_BooleanOperation {
	public:
		%feature("autodoc", "1");
		BRepAlgo_Section(const TopoDS_Shape Sh1, const TopoDS_Shape Sh2, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgo_Section(const TopoDS_Shape Sh, const gp_Pln Pl, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgo_Section(const TopoDS_Shape Sh, const Handle_Geom_Surface &Sf, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgo_Section(const Handle_Geom_Surface &Sf, const TopoDS_Shape Sh, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgo_Section(const Handle_Geom_Surface &Sf1, const Handle_Geom_Surface &Sf2, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
