...
class GeomFill_SectionPlacement {
	public:
		...
		%feature("autodoc", "1");
		gp_Trsf Transformation(const Standard_Boolean WithTranslation, const Standard_Boolean WithCorrection=false) const;
		%feature("autodoc", "1");
...
class GeomFill_ConstrainedFilling {
	public:
		...
		%feature("autodoc", "1");
		void Init(const Handle_GeomFill_Boundary &B1, const Handle_GeomFill_Boundary &B2, const Handle_GeomFill_Boundary &B3, const Standard_Boolean NoCheck=false);
		%feature("autodoc", "1");
		void Init(const Handle_GeomFill_Boundary &B1, const Handle_GeomFill_Boundary &B2, const Handle_GeomFill_Boundary &B3, const Handle_GeomFill_Boundary &B4, const Standard_Boolean NoCheck=false);
		%feature("autodoc", "1");
...
class GeomFill_Sweep {
	public:
		%feature("autodoc", "1");
		GeomFill_Sweep(const Handle_GeomFill_LocationLaw &Location, const Standard_Boolean WithKpart=true);
		%feature("autodoc", "1");
...
class GeomFill_CircularBlendFunc : public Approx_SweepFunction {
	public:
		%feature("autodoc", "1");
		GeomFill_CircularBlendFunc(const Handle_Adaptor3d_HCurve &Path, const Handle_Adaptor3d_HCurve &Curve1, const Handle_Adaptor3d_HCurve &Curve2, const Standard_Real Radius, const Standard_Boolean Polynomial=false);
		%feature("autodoc", "1");
		virtual		Standard_Boolean D0(const Standard_Real Param, const Standard_Real First, const Standard_Real Last, TColgp_Array1OfPnt & Poles, TColgp_Array1OfPnt2d & Poles2d, TColStd_Array1OfReal & Weigths);
		%feature("autodoc", "1");
		virtual		Standard_Boolean D1(const Standard_Real Param, const Standard_Real First, const Standard_Real Last, TColgp_Array1OfPnt & Poles, TColgp_Array1OfVec & DPoles, TColgp_Array1OfPnt2d & Poles2d, TColgp_Array1OfVec2d & DPoles2d, TColStd_Array1OfReal & Weigths, TColStd_Array1OfReal & DWeigths);
...
class GeomFill_Pipe {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Standard_Boolean WithParameters=false, const Standard_Boolean myPolynomial=false);
		%feature("autodoc", "1");
...
class GeomFill_AppSurf : public AppBlend_Approx {
	public:
		...
		GeomFill_AppSurf();
		%feature("autodoc", "1");
		GeomFill_AppSurf(const Standard_Integer Degmin, const Standard_Integer Degmax, const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Integer NbIt, const Standard_Boolean KnownParameters=false);
		%feature("autodoc", "1");
		void Init(const Standard_Integer Degmin, const Standard_Integer Degmax, const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Integer NbIt, const Standard_Boolean KnownParameters=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Perform(const Handle_GeomFill_Line &Lin, GeomFill_SectionGenerator & SecGen, const Standard_Boolean SpApprox=false);
		%feature("autodoc", "1");
...
class GeomFill_AppSweep : public AppBlend_Approx {
	public:
		...
		GeomFill_AppSweep();
		%feature("autodoc", "1");
		GeomFill_AppSweep(const Standard_Integer Degmin, const Standard_Integer Degmax, const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Integer NbIt, const Standard_Boolean KnownParameters=false);
		%feature("autodoc", "1");
		void Init(const Standard_Integer Degmin, const Standard_Integer Degmax, const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Integer NbIt, const Standard_Boolean KnownParameters=false);
		%feature("autodoc", "1");
		void SetParType(const Approx_ParametrizationType ParType);
		...
		void CriteriumWeight(Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue) const;
		%feature("autodoc", "1");
		void Perform(const Handle_GeomFill_Line &Lin, GeomFill_SweepSectionGenerator & SecGen, const Standard_Boolean SpApprox=false);
		%feature("autodoc", "1");
