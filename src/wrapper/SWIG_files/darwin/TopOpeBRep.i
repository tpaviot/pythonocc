...
class TopOpeBRep_DSFiller {
	public:
		...
		TopOpeBRepTool_PShapeClassifier PShapeClassifier() const;
		%feature("autodoc", "1");
		void Insert(const TopoDS_Shape S1, const TopoDS_Shape S2, const Handle_TopOpeBRepDS_HDataStructure &HDS, const Standard_Boolean orientFORWARD=true);
		%feature("autodoc", "1");
		void InsertIntersection(const TopoDS_Shape S1, const TopoDS_Shape S2, const Handle_TopOpeBRepDS_HDataStructure &HDS, const Standard_Boolean orientFORWARD=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Insert1d(const TopoDS_Shape S1, const TopoDS_Shape S2, const TopoDS_Face F1, const TopoDS_Face F2, const Handle_TopOpeBRepDS_HDataStructure &HDS, const Standard_Boolean orientFORWARD=false);
		%feature("autodoc", "1");
...
class TopOpeBRep_EdgesIntersector {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const TopoDS_Shape E1, const TopoDS_Shape E2, const Standard_Boolean ReduceSegments=true);
		%feature("autodoc", "1");
		Standard_Boolean IsEmpty();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void InitPoint(const Standard_Boolean selectkeep=true);
		%feature("autodoc", "1");
		Standard_Boolean MorePoint() const;
		%feature("autodoc", "1");
		void NextPoint();
...
class TopOpeBRep_VPointInterIterator {
	public:
		...
		%feature("autodoc", "1");
		void Init(const TopOpeBRep_LineInter &LI, const Standard_Boolean checkkeep=false);
		%feature("autodoc", "1");
		void Init();
		%feature("autodoc", "1");
		Standard_Boolean More() const;
