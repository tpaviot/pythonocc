...
%rename(DownCast) Handle_Graphic3d_TextureParams::DownCast;
...
%rename(TexturesFolder) Graphic3d_TextureRoot::TexturesFolder;
...
%rename(InitGraphicDriver) Graphic3d::InitGraphicDriver;
