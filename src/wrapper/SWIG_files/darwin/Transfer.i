...
class Transfer_TransferInput {
	public:
		...
		%feature("autodoc", "1");
		void FillModel(const Handle_Transfer_TransientProcess &proc, const Handle_Interface_InterfaceModel &amodel, const Handle_Interface_Protocol &proto, const Standard_Boolean roots=true) const;
		%feature("autodoc", "1");
		void FillModel(const Handle_Transfer_FinderProcess &proc, const Handle_Interface_InterfaceModel &amodel) const;
		%feature("autodoc", "1");
		void FillModel(const Handle_Transfer_FinderProcess &proc, const Handle_Interface_InterfaceModel &amodel, const Handle_Interface_Protocol &proto, const Standard_Boolean roots=true) const;
...
class Transfer_ActorOfProcessForFinder : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void SetLast(const Standard_Boolean mode=true);
		%feature("autodoc", "1");
...
class Transfer_Finder : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void GetAttributes(const Handle_Transfer_Finder &other, const char * fromname="", const Standard_Boolean copied=true);
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
...
class Transfer_ProcessForTransient : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForTransient RootResult(const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForTransient CompleteResult(const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForTransient ResultOne(const Handle_Standard_Transient &start, const Standard_Integer level, const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void RemoveResult(const Handle_Standard_Transient &start, const Standard_Integer level, const Standard_Boolean compute=true);
		%feature("autodoc", "1");
...
class Transfer_IteratorOfProcessForFinder : public Transfer_TransferIterator {
	public:
		...
		%feature("autodoc", "1");
		void Filter(const Handle_Transfer_HSequenceOfFinder &list, const Standard_Boolean keep=true);
		%feature("autodoc", "1");
...
class Transfer_TransferOutput {
	public:
		...
		void TransferRoots();
		%feature("autodoc", "1");
		Interface_EntityIterator ListForStatus(const Standard_Boolean normal, const Standard_Boolean roots=true) const;
		%feature("autodoc", "1");
		Handle_Interface_InterfaceModel ModelForStatus(const Handle_Interface_Protocol &protocol, const Standard_Boolean normal, const Standard_Boolean roots=true) const;
...
class Transfer_ProcessForFinder : public MMgt_TShared {
	public:
		...
		Standard_Boolean IsLooping(const Standard_Integer alevel) const;
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForFinder RootResult(const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForFinder CompleteResult(const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForFinder AbnormalResult() const;
		%feature("autodoc", "1");
		Interface_CheckIterator CheckList(const Standard_Boolean erronly) const;
		%feature("autodoc", "1");
		Transfer_IteratorOfProcessForFinder ResultOne(const Handle_Transfer_Finder &start, const Standard_Integer level, const Standard_Boolean withstart=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void RemoveResult(const Handle_Transfer_Finder &start, const Standard_Integer level, const Standard_Boolean compute=true);
		%feature("autodoc", "1");
...
class Transfer_IteratorOfProcessForTransient : public Transfer_TransferIterator {
	public:
		...
		%feature("autodoc", "1");
		void Filter(const Handle_TColStd_HSequenceOfTransient &list, const Standard_Boolean keep=true);
		%feature("autodoc", "1");
		Standard_Boolean HasStarting() const;
		%feature("autodoc", "1");
