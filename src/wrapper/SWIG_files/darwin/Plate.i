...
class Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Plate_HArray1OfPinpointConstraint : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Plate_HArray1OfPinpointConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint DownCast(const Handle_Standard_Transient &AnObject);
...
class Plate_Plate {
	public:
		...
		%feature("autodoc", "1");
		void SetPolynomialPartOnly(const Standard_Boolean PPOnly=true);
		%feature("autodoc", "1");
