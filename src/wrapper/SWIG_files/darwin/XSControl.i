...
%include XSControl_required_python_modules.i
...
class XSControl_Writer {
	public:
		...
		%feature("autodoc", "1");
		XSControl_Writer(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
		Standard_Boolean SetNorm(const char * norm);
		%feature("autodoc", "1");
		void SetWS(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
		Handle_XSControl_WorkSession WS() const;
		%feature("autodoc", "1");
		Handle_Interface_InterfaceModel Model(const Standard_Boolean newone=false);
		%feature("autodoc", "1");
...
class XSControl_Utils {
	public:
		...
		%feature("autodoc", "1");
		char * TypeName(const Handle_Standard_Transient &item, const Standard_Boolean nopk=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Handle_Standard_Transient ShapeBinder(const TopoDS_Shape shape, const Standard_Boolean hs=true) const;
		%feature("autodoc", "1");
...
class XSControl_Controller : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		char * Name(const Standard_Boolean rsc=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetModeWrite(const Standard_Integer modemin, const Standard_Integer modemax, const Standard_Boolean shape=true);
		%feature("autodoc", "1");
		void SetModeWriteHelp(const Standard_Integer modetrans, const char * help, const Standard_Boolean shape=true);
		%feature("autodoc","ModeWriteBounds(Standard_Boolean shape=true) -> [Standard_Integer, Standard_Integer]");

		Standard_Boolean ModeWriteBounds(Standard_Integer &OutValue, Standard_Integer &OutValue, const Standard_Boolean shape=true) const;
		%feature("autodoc", "1");
		Standard_Boolean IsModeWrite(const Standard_Integer modetrans, const Standard_Boolean shape=true) const;
		%feature("autodoc", "1");
		char * ModeWriteHelp(const Standard_Integer modetrans, const Standard_Boolean shape=true) const;
		%feature("autodoc", "1");
...
class XSControl_Reader {
	public:
		...
		%feature("autodoc", "1");
		XSControl_Reader(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
		Standard_Boolean SetNorm(const char * norm);
		%feature("autodoc", "1");
		void SetWS(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
...
class XSControl_WorkSession : public IFSelect_WorkSession {
	public:
		...
		%feature("autodoc", "1");
		char * SelectedNorm(const Standard_Boolean rsc=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		IFSelect_ReturnStatus TransferWriteShape(const TopoDS_Shape shape, const Standard_Boolean compgraph=true);
		%feature("autodoc", "1");
...
class XSControl_TransferReader : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_TColStd_HSequenceOfTransient CheckedList(const Handle_Standard_Transient &ent, const Interface_CheckStatus withcheck=Interface_CheckAny, const Standard_Boolean result=true) const;
		%feature("autodoc", "1");
		Standard_Boolean BeginTransfer();
		%feature("autodoc", "1");
		Standard_Boolean Recognize(const Handle_Standard_Transient &ent);
		%feature("autodoc", "1");
		Standard_Integer TransferOne(const Handle_Standard_Transient &ent, const Standard_Boolean rec=true);
		%feature("autodoc", "1");
		Standard_Integer TransferList(const Handle_TColStd_HSequenceOfTransient &list, const Standard_Boolean rec=true);
		%feature("autodoc", "1");
