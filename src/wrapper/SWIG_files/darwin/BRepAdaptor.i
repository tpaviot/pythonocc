...
class BRepAdaptor_CompCurve : public Adaptor3d_Curve {
	public:
		...
		%feature("autodoc", "1");
		BRepAdaptor_CompCurve(const TopoDS_Wire W, const Standard_Boolean KnotByCurvilinearAbcissa=false);
		%feature("autodoc", "1");
...
class BRepAdaptor_Surface : public Adaptor3d_Surface {
	public:
		...
		BRepAdaptor_Surface();
		%feature("autodoc", "1");
		BRepAdaptor_Surface(const TopoDS_Face F, const Standard_Boolean R=true);
		%feature("autodoc", "1");
		void Initialize(const TopoDS_Face F, const Standard_Boolean Restriction=true);
		%feature("autodoc", "1");
