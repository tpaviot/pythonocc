...
%include TopExp_required_python_modules.i
...
class TopExp {
	public:
		...
		%feature("autodoc", "1");
		static		TopoDS_Vertex FirstVertex(const TopoDS_Edge E, const Standard_Boolean CumOri=false);
		%feature("autodoc", "1");
		static		TopoDS_Vertex LastVertex(const TopoDS_Edge E, const Standard_Boolean CumOri=false);
		%feature("autodoc", "1");
		static		void Vertices(const TopoDS_Edge E, TopoDS_Vertex & Vfirst, TopoDS_Vertex & Vlast, const Standard_Boolean CumOri=false);
		%feature("autodoc", "1");
