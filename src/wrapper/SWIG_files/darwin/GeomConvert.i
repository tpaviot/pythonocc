...
class GeomConvert_CompBezierSurfacesToBSplineSurface {
	public:
		...
		%feature("autodoc", "1");
		GeomConvert_CompBezierSurfacesToBSplineSurface(const TColGeom_Array2OfBezierSurface &Beziers, const Standard_Real Tolerance, const Standard_Boolean RemoveKnots=true);
		%feature("autodoc", "1");
...
class GeomConvert {
	public:
		...
		GeomConvert();
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineCurve SplitBSplineCurve(const Handle_Geom_BSplineCurve &C, const Standard_Integer FromK1, const Standard_Integer ToK2, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineCurve SplitBSplineCurve(const Handle_Geom_BSplineCurve &C, const Standard_Real FromU1, const Standard_Real ToU2, const Standard_Real ParametricTolerance, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineSurface SplitBSplineSurface(const Handle_Geom_BSplineSurface &S, const Standard_Integer FromUK1, const Standard_Integer ToUK2, const Standard_Integer FromVK1, const Standard_Integer ToVK2, const Standard_Boolean SameUOrientation=true, const Standard_Boolean SameVOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineSurface SplitBSplineSurface(const Handle_Geom_BSplineSurface &S, const Standard_Integer FromK1, const Standard_Integer ToK2, const Standard_Boolean USplit, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineSurface SplitBSplineSurface(const Handle_Geom_BSplineSurface &S, const Standard_Real FromU1, const Standard_Real ToU2, const Standard_Real FromV1, const Standard_Real ToV2, const Standard_Real ParametricTolerance, const Standard_Boolean SameUOrientation=true, const Standard_Boolean SameVOrientation=true);
		%feature("autodoc", "1");
		static		Handle_Geom_BSplineSurface SplitBSplineSurface(const Handle_Geom_BSplineSurface &S, const Standard_Real FromParam1, const Standard_Real ToParam2, const Standard_Boolean USplit, const Standard_Real ParametricTolerance, const Standard_Boolean SameOrientation=true);
		%feature("autodoc", "1");
...
class GeomConvert_CompCurveToBSplineCurve {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean Add(const Handle_Geom_BoundedCurve &NewCurve, const Standard_Real Tolerance, const Standard_Boolean After=false, const Standard_Boolean WithRatio=true, const Standard_Integer MinM=0);
		%feature("autodoc", "1");
