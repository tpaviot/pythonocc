...
class TNaming_Tool {
	public:
		...
		%feature("autodoc", "1");
		static		void Collect(const Handle_TNaming_NamedShape &NS, TNaming_MapOfNamedShape & Labels, const Standard_Boolean OnlyModif=true);
		%feature("autodoc", "1");
...
class TNaming_Translator {
	public:
		...
		%feature("autodoc", "1");
		void DumpMap(const Standard_Boolean isWrite=false) const;
...
class TNaming_Selector {
	public:
		%feature("autodoc", "1");
		static		Standard_Boolean IsIdentified(const TDF_Label &access, const TopoDS_Shape selection, Handle_TNaming_NamedShape & NS, const Standard_Boolean Geometry=false);
		%feature("autodoc", "1");
		TNaming_Selector(const TDF_Label &aLabel);
		%feature("autodoc", "1");
		Standard_Boolean Select(const TopoDS_Shape Selection, const TopoDS_Shape Context, const Standard_Boolean Geometry=false, const Standard_Boolean KeepOrientatation=false) const;
		%feature("autodoc", "1");
		Standard_Boolean Select(const TopoDS_Shape Selection, const Standard_Boolean Geometry=false, const Standard_Boolean KeepOrientatation=false) const;
		%feature("autodoc", "1");
...
class TNaming_Scope {
	public:
		...
		%feature("autodoc", "1");
		void ValidChildren(const TDF_Label &L, const Standard_Boolean withroot=true);
		%feature("autodoc", "1");
		void Unvalid(const TDF_Label &L);
		%feature("autodoc", "1");
		void UnvalidChildren(const TDF_Label &L, const Standard_Boolean withroot=true);
		%feature("autodoc", "1");
...
class TNaming_Naming : public TDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_TNaming_NamedShape Name(const TDF_Label &where, const TopoDS_Shape Selection, const TopoDS_Shape Context, const Standard_Boolean Geometry=false, const Standard_Boolean KeepOrientation=false, const Standard_Boolean BNproblem=false);
		%feature("autodoc", "1");
		TNaming_Naming();
		%feature("autodoc", "1");
...
class TNaming {
	public:
		...
		%feature("autodoc", "1");
		static		void Displace(const TDF_Label &label, const TopLoc_Location &aLocation, const Standard_Boolean WithOld=true);
		%feature("autodoc", "1");
