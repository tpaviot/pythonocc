...
%include Message_required_python_modules.i
...
class Handle_Message_Printer : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_Printer DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_PrinterOStream : public Handle_Message_Printer {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_PrinterOStream DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_Messenger : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_Messenger DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_ProgressIndicator : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_ProgressIndicator DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_SequenceNodeOfSequenceOfProgressScale : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_SequenceNodeOfSequenceOfProgressScale DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_Algorithm : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_Algorithm DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_Message_SequenceNodeOfSequenceOfPrinters : public Handle_TCollection_SeqNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_Message_SequenceNodeOfSequenceOfPrinters DownCast(const Handle_Standard_Transient &AnObject);
...
class Message_ProgressIndicator : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void SetScale(const char * name, const Standard_Real min, const Standard_Real max, const Standard_Real step, const Standard_Boolean isInf=false);
		%feature("autodoc", "1");
		void SetScale(const Standard_Real min, const Standard_Real max, const Standard_Real step, const Standard_Boolean isInf=false);
		...
		%feature("autodoc", "1");
		virtual		Standard_Boolean Show(const Standard_Boolean force=true);
		%feature("autodoc", "1");
...
class Message_ProgressScale {
	public:
		...
		%feature("autodoc", "1");
		void SetScale(const Standard_Real theMin, const Standard_Real theMax, const Standard_Real theStep, const Standard_Boolean theInfinite=true);
		%feature("autodoc", "1");
...
class Message_Messenger : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void Send(const char * theString, const Message_Gravity theGravity=Message_Warning, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		void Send(const TCollection_AsciiString &theString, const Message_Gravity theGravity=Message_Warning, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		void Send(const TCollection_ExtendedString &theString, const Message_Gravity theGravity=Message_Warning, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
...
class Message_ProgressSentry {
	public:
		%feature("autodoc", "1");
		Message_ProgressSentry(const Handle_Message_ProgressIndicator &PI, const char * name, const Standard_Real min, const Standard_Real max, const Standard_Real step, const Standard_Boolean isInf=false, const Standard_Real newScopeSpan=0.0);
		%feature("autodoc", "1");
		Message_ProgressSentry(const Handle_Message_ProgressIndicator &PI, const Handle_TCollection_HAsciiString &name, const Standard_Real min, const Standard_Real max, const Standard_Real step, const Standard_Boolean isInf=false, const Standard_Real newScopeSpan=0.0);
		%feature("autodoc", "1");
		void Relieve();
		%feature("autodoc", "1");
		void Next(const char * name=0) const;
		%feature("autodoc", "1");
		void Next(const Standard_Real span, const char * name=0) const;
		%feature("autodoc", "1");
		void Next(const Standard_Real span, const Handle_TCollection_HAsciiString &name) const;
		%feature("autodoc", "1");
...
class Message_PrinterOStream : public Message_Printer {
	public:
		...
		%feature("autodoc", "1");
		virtual		void Send(const char * theString, const Message_Gravity theGravity, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		virtual		void Send(const TCollection_AsciiString &theString, const Message_Gravity theGravity, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		virtual		void Send(const TCollection_ExtendedString &theString, const Message_Gravity theGravity, const Standard_Boolean putEndl=true) const;
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
