...
class STEPControl_Reader : public XSControl_Reader {
	public:
		...
		STEPControl_Reader();
		%feature("autodoc", "1");
		STEPControl_Reader(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
...
class STEPControl_ActorRead : public Transfer_ActorOfTransientProcess {
	public:
		...
		%feature("autodoc", "1");
		Handle_Transfer_Binder TransferShape(const Handle_Standard_Transient &start, const Handle_Transfer_TransientProcess &TP, const Standard_Boolean isManifold=true);
		%feature("autodoc", "1");
...
class STEPControl_ActorWrite : public Transfer_ActorOfFinderProcess {
	public:
		...
		%feature("autodoc", "1");
		Handle_Transfer_Binder TransferSubShape(const Handle_Transfer_Finder &start, const Handle_StepShape_ShapeDefinitionRepresentation &SDR, Handle_StepGeom_Axis2Placement3d & AX1, const Handle_Transfer_FinderProcess &FP, const Handle_TopTools_HSequenceOfShape &shapeGroup=0, const Standard_Boolean isManifold=true);
		%feature("autodoc", "1");
		Handle_Transfer_Binder TransferShape(const Handle_Transfer_Finder &start, const Handle_StepShape_ShapeDefinitionRepresentation &SDR, const Handle_Transfer_FinderProcess &FP, const Handle_TopTools_HSequenceOfShape &shapeGroup=0, const Standard_Boolean isManifold=true);
		%feature("autodoc", "1");
...
class STEPControl_Writer {
	public:
		...
		STEPControl_Writer();
		%feature("autodoc", "1");
		STEPControl_Writer(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
		void SetTolerance(const Standard_Real Tol);
		%feature("autodoc", "1");
		void UnsetTolerance();
		...
		%feature("autodoc", "1");
		Handle_StepData_StepModel Model(const Standard_Boolean newone=false);
		%feature("autodoc", "1");
		IFSelect_ReturnStatus Transfer(const TopoDS_Shape sh, const STEPControl_StepModelType mode, const Standard_Boolean compgraph=true);
		%feature("autodoc", "1");
