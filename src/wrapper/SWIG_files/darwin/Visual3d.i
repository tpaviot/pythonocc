...
class Visual3d_LayerItem : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void SetNeedToRecompute(const Standard_Boolean NeedToRecompute=true);
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
...
class Visual3d_Layer : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		Visual3d_Layer(const Handle_Visual3d_ViewManager &AViewer, const Aspect_TypeOfLayer AType=Aspect_TOL_OVERLAY, const Standard_Boolean AFlag=false);
		%feature("autodoc", "1");
		void Destroy();
		%feature("autodoc", "1");
		void Begin();
		...
		void BeginPolygon();
		%feature("autodoc", "1");
		void AddVertex(const Standard_Real X, const Standard_Real Y, const Standard_Boolean AFlag=true);
		%feature("autodoc", "1");
		void ClosePrimitive();
		%feature("autodoc", "1");
...
class Visual3d_Light : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Visual3d_Light(const Quantity_Color &Color, const Graphic3d_Vector &Direction, const Standard_Boolean Headlight=false);
		%feature("autodoc", "1");
...
class Visual3d_View : public Graphic3d_DataStructureManager {
	public:
		...
		%feature("autodoc", "1");
		void TriedronDisplay(const Aspect_TypeOfTriedronPosition APosition=Aspect_TOTP_CENTER, const Quantity_NameOfColor AColor=Quantity_NOC_WHITE, const Standard_Real AScale=2.00000000000000004163336342344337026588618755340576171875e-2, const Standard_Boolean AsWireframe=true);
		%feature("autodoc", "1");
		void TriedronErase();
		%feature("autodoc", "1");
...
class Visual3d_TransientManager : public MMgt_TShared {
	public:
		...
		void Destroy();
		%feature("autodoc", "1");
		static		Standard_Integer BeginDraw(const Handle_Visual3d_View &aView, const Standard_Boolean DoubleBuffer=false, const Standard_Boolean RetainMode=false);
		%feature("autodoc", "1");
		static		void EndDraw(const Standard_Boolean Synchronize=false);
		%feature("autodoc", "1");
		static		void ClearDraw(const Handle_Visual3d_View &aView, const Standard_Boolean aFlush=true);
		%feature("autodoc", "1");
