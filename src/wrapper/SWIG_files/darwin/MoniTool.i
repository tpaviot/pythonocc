...
class MoniTool_Profile : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		TCollection_AsciiString CaseName(const char * optname, const Standard_Boolean proper=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetTypedValues(const Standard_Boolean proper=false, const char * name="") const;
		%feature("autodoc", "1");
...
class MoniTool_TypedValue : public MMgt_TShared {
	public:
		...
		char * UnitDef() const;
		%feature("autodoc", "1");
		void StartEnum(const Standard_Integer start=0, const Standard_Boolean match=true);
		%feature("autodoc", "1");
...
class MoniTool_AttrList {
	public:
		...
		%feature("autodoc", "1");
		void GetAttributes(const MoniTool_AttrList &other, const char * fromname="", const Standard_Boolean copied=true);
...
class MoniTool_OptValue {
	public:
		...
		void Clear();
		%feature("autodoc", "1");
		void SetValue(const Handle_MoniTool_Profile &prof, const char * opt, const Standard_Boolean fast=true);
		%feature("autodoc", "1");
		virtual		Handle_MoniTool_Profile Prof() const;
		%feature("autodoc", "1");
		void Load(const Standard_Boolean fast=true);
		%feature("autodoc", "1");
...
class MoniTool_Option : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_TColStd_HSequenceOfAsciiString Aliases(const char * name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
