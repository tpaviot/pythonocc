...
class Handle_GEOMImpl_SketcherDriver : public Handle_GEOM_BaseDriver {
	public:
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Handle_GEOMImpl_SketcherDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class GEOMImpl_IShapesOperations : public GEOM_IOperations {
	public:
		...
		%feature("autodoc", "1");
		static		void SortShapes(TopTools_ListOfShape & SL, const Standard_Boolean isOldSorting=true);
		%feature("autodoc", "1");
...
class GEOMImpl_GlueDriver : public TFunction_Driver {
	public:
		...
		static		const Standard_GUID & GetID();
		%feature("autodoc", "1");
		static		TopoDS_Shape GlueFaces(const TopoDS_Shape theShape, const Standard_Real theTolerance, const Standard_Boolean doKeepNonSolids=true);
		%feature("autodoc", "1");
...
class GEOMImpl_ITransformOperations : public GEOM_IOperations {
	public:
		...
		%feature("autodoc", "1");
		Handle_GEOM_Object PositionAlongPath(Handle_GEOM_Object , Handle_GEOM_Object , const GEOM_Parameter &theDistance, bool , bool );
		%feature("autodoc", "1");
