...
class Handle_BRepCheck_Result : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_Result DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BRepCheck_Face : public Handle_BRepCheck_Result {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_Face DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BRepCheck_Shell : public Handle_BRepCheck_Result {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_Shell DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BRepCheck_DataMapNodeOfDataMapOfShapeListOfStatus : public Handle_TCollection_MapNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_DataMapNodeOfDataMapOfShapeListOfStatus DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BRepCheck_ListNodeOfListOfStatus : public Handle_TCollection_MapNode {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_ListNodeOfListOfStatus DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BRepCheck_Edge : public Handle_BRepCheck_Result {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BRepCheck_Edge DownCast(const Handle_Standard_Transient &AnObject);
...
class BRepCheck_Shell : public BRepCheck_Result {
	public:
		...
		virtual		void Blind();
		%feature("autodoc", "1");
		BRepCheck_Status Closed(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status Orientation(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
...
class BRepCheck_Face : public BRepCheck_Result {
	public:
		...
		virtual		void Blind();
		%feature("autodoc", "1");
		BRepCheck_Status IntersectWires(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status ClassifyWires(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status OrientationOfWires(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		void SetUnorientable();
		%feature("autodoc", "1");
		Standard_Boolean IsUnorientable() const;
...
class BRepCheck_Wire : public BRepCheck_Result {
	public:
		...
		BRepCheck_Status Closed(const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status Closed2d(const TopoDS_Face F, const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status Orientation(const TopoDS_Face F, const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		BRepCheck_Status SelfIntersect(const TopoDS_Face F, TopoDS_Edge & E1, TopoDS_Edge & E2, const Standard_Boolean Update=false);
		%feature("autodoc", "1");
		Standard_Boolean GeometricControls() const;
		%feature("autodoc", "1");
		void GeometricControls(const Standard_Boolean B);
...
class BRepCheck_Analyzer {
	public:
		%feature("autodoc", "1");
		BRepCheck_Analyzer(const TopoDS_Shape S, const Standard_Boolean B=true);
		%feature("autodoc", "1");
		void Init(const TopoDS_Shape S, const Standard_Boolean GeomControls=true);
		%feature("autodoc", "1");
