...
class BRepLib_FuseEdges {
	public:
		%feature("autodoc", "1");
		BRepLib_FuseEdges(const TopoDS_Shape theShape, const Standard_Boolean PerformNow=false);
		%feature("autodoc", "1");
		void AvoidEdges(const TopTools_IndexedMapOfShape &theMapEdg);
		%feature("autodoc", "1");
		void SetConcatBSpl(const Standard_Boolean theConcatBSpl=true);
		%feature("autodoc", "1");
...
class BRepLib_MakeShell : public BRepLib_MakeShape {
	public:
		...
		BRepLib_MakeShell();
		%feature("autodoc", "1");
		BRepLib_MakeShell(const Handle_Geom_Surface &S, const Standard_Boolean Segment=false);
		%feature("autodoc", "1");
		BRepLib_MakeShell(const Handle_Geom_Surface &S, const Standard_Real UMin, const Standard_Real UMax, const Standard_Real VMin, const Standard_Real VMax, const Standard_Boolean Segment=false);
		%feature("autodoc", "1");
...
class BRepLib {
	public:
		...
		%feature("autodoc", "1");
		static		void SameParameter(const TopoDS_Shape S, const Standard_Real Tolerance=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Boolean forced=false);
		%feature("autodoc", "1");
		static		void UpdateTolerances(const TopoDS_Shape S, const Standard_Boolean verifyFaceTolerance=false);
		%feature("autodoc", "1");
...
class BRepLib_MakePolygon : public BRepLib_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepLib_MakePolygon(const gp_Pnt P1, const gp_Pnt P2, const gp_Pnt P3, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepLib_MakePolygon(const gp_Pnt P1, const gp_Pnt P2, const gp_Pnt P3, const gp_Pnt P4, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepLib_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2);
		%feature("autodoc", "1");
		BRepLib_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2, const TopoDS_Vertex V3, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepLib_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2, const TopoDS_Vertex V3, const TopoDS_Vertex V4, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
...
class BRepLib_MakeFace : public BRepLib_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepLib_MakeFace(const TopoDS_Wire W, const Standard_Boolean OnlyPlane=false);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const gp_Pln P, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const gp_Cylinder C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const gp_Cone C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const gp_Sphere S, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const gp_Torus C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepLib_MakeFace(const Handle_Geom_Surface &S, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
...
class BRepLib_FindSurface {
	public:
		...
		BRepLib_FindSurface();
		%feature("autodoc", "1");
		BRepLib_FindSurface(const TopoDS_Shape S, const Standard_Real Tol=-0x00000000000000001, const Standard_Boolean OnlyPlane=false, const Standard_Boolean OnlyClosed=false);
		%feature("autodoc", "1");
		void Init(const TopoDS_Shape S, const Standard_Real Tol=-0x00000000000000001, const Standard_Boolean OnlyPlane=false, const Standard_Boolean OnlyClosed=false);
		%feature("autodoc", "1");
