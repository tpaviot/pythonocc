...
class XCAFDoc_DocumentTool : public TDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_XCAFDoc_DocumentTool Set(const TDF_Label &L, const Standard_Boolean IsAcces=true);
		%feature("autodoc", "1");
...
class XCAFDoc_ShapeTool : public TDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean Search(const TopoDS_Shape S, TDF_Label & L, const Standard_Boolean findInstance=true, const Standard_Boolean findComponent=true, const Standard_Boolean findSubshape=true) const;
		%feature("autodoc", "1");
		Standard_Boolean FindShape(const TopoDS_Shape S, TDF_Label & L, const Standard_Boolean findInstance=false) const;
		%feature("autodoc", "1");
		TDF_Label FindShape(const TopoDS_Shape S, const Standard_Boolean findInstance=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		TDF_Label AddShape(const TopoDS_Shape S, const Standard_Boolean makeAssembly=true, const Standard_Boolean makePrepare=true);
		%feature("autodoc", "1");
		Standard_Boolean RemoveShape(const TDF_Label &L, const Standard_Boolean removeCompletely=true) const;
		%feature("autodoc", "1");
		void Init();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Standard_Integer GetUsers(const TDF_Label &L, TDF_LabelSequence & Labels, const Standard_Boolean getsubchilds=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Standard_Integer NbComponents(const TDF_Label &L, const Standard_Boolean getsubchilds=false);
		%feature("autodoc", "1");
		static		Standard_Boolean GetComponents(const TDF_Label &L, TDF_LabelSequence & Labels, const Standard_Boolean getsubchilds=false);
		%feature("autodoc", "1");
		TDF_Label AddComponent(const TDF_Label &assembly, const TDF_Label &comp, const TopLoc_Location &Loc) const;
		%feature("autodoc", "1");
		TDF_Label AddComponent(const TDF_Label &assembly, const TopoDS_Shape comp, const Standard_Boolean expand=false);
		%feature("autodoc", "1");
		...
		TDF_Label BaseLabel() const;
		%feature("autodoc", "1");
		void Dump(const Standard_Boolean deep=false) const;
		%feature("autodoc", "1");
		static		void DumpShape(const TDF_Label &L, const Standard_Integer level=0, const Standard_Boolean deep=false);
		%feature("autodoc", "1");
		virtual		const Standard_GUID & ID() const;
		%feature("autodoc", "1");
		virtual		void Restore(const Handle_TDF_Attribute &with);
...
class XCAFDoc_LayerTool : public TDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		void SetLayer(const TDF_Label &L, const TDF_Label &LayerL, const Standard_Boolean shapeInOneLayer=false) const;
		%feature("autodoc", "1");
		void SetLayer(const TDF_Label &L, const TCollection_ExtendedString &aLayer, const Standard_Boolean shapeInOneLayer=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void SetVisibility(const TDF_Label &layerL, const Standard_Boolean isvisible=true) const;
		%feature("autodoc", "1");
		Standard_Boolean SetLayer(const TopoDS_Shape Sh, const TDF_Label &LayerL, const Standard_Boolean shapeInOneLayer=false);
		%feature("autodoc", "1");
		Standard_Boolean SetLayer(const TopoDS_Shape Sh, const TCollection_ExtendedString &aLayer, const Standard_Boolean shapeInOneLayer=false);
		%feature("autodoc", "1");
...
class XCAFDoc_ColorTool : public TDF_Attribute {
	public:
		...
		%feature("autodoc", "1");
		void SetVisibility(const TDF_Label &shapeLabel, const Standard_Boolean isvisible=true);
		%feature("autodoc", "1");
		Standard_Boolean SetInstanceColor(const TopoDS_Shape theShape, const XCAFDoc_ColorType type, const Quantity_Color &color, const Standard_Boolean isCreateSHUO=true);
		%feature("autodoc", "1");
