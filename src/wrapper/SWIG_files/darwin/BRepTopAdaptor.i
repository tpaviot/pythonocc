...
class BRepTopAdaptor_FClass2d {
	public:
		...
		%feature("autodoc", "1");
		TopAbs_State Perform(const gp_Pnt2d Puv, const Standard_Boolean RecadreOnPeriodic=true) const;
		%feature("autodoc", "1");
		void Destroy();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		TopAbs_State TestOnRestriction(const gp_Pnt2d Puv, const Standard_Real Tol, const Standard_Boolean RecadreOnPeriodic=true) const;
...
class BRepTopAdaptor_TopolTool : public Adaptor3d_TopolTool {
	public:
		...
		%feature("autodoc", "1");
		virtual		TopAbs_State Classify(const gp_Pnt2d P2d, const Standard_Real Tol, const Standard_Boolean RecadreOnPeriodic=true);
		%feature("autodoc", "1");
		virtual		Standard_Boolean IsThePointOn(const gp_Pnt2d P2d, const Standard_Real Tol, const Standard_Boolean RecadreOnPeriodic=true);
		%feature("autodoc", "1");
