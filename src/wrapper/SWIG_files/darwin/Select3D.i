...
class Select3D_Projector : public Standard_Transient {
	public:
		...
		%feature("autodoc", "1");
		virtual		void Scaled(const Standard_Boolean On=false);
		%feature("autodoc", "1");
...
class Select3D_SensitiveEntity : public SelectBasics_SensitiveEntity {
	public:
		...
		%feature("autodoc", "1");
		virtual		void Dump(Standard_OStream & S, const Standard_Boolean FullDump=true) const;
		%feature("autodoc", "1");
...
class Select3D_SensitiveTriangulation : public Select3D_SensitiveEntity {
	public:
		%feature("autodoc", "1");
		Select3D_SensitiveTriangulation(const Handle_SelectBasics_EntityOwner &OwnerId, const Handle_Poly_Triangulation &aTriangulation, const TopLoc_Location &aLoc, const Standard_Boolean InteriorFlag=true);
		%feature("autodoc", "1");
...
class Select3D_SensitiveGroup : public Select3D_SensitiveEntity {
	public:
		%feature("autodoc", "1");
		Select3D_SensitiveGroup(const Handle_SelectBasics_EntityOwner &OwnerId, const Standard_Boolean MatchAll=true);
		%feature("autodoc", "1");
		Select3D_SensitiveGroup(const Handle_SelectBasics_EntityOwner &OwnerId, Select3D_ListOfSensitive & TheList, const Standard_Boolean MatchAll=true);
		%feature("autodoc", "1");
...
class Select3D_SensitiveCircle : public Select3D_SensitivePoly {
	public:
		%feature("autodoc", "1");
		Select3D_SensitiveCircle(const Handle_SelectBasics_EntityOwner &OwnerId, const Handle_Geom_Circle &TheCircle, const Standard_Boolean FilledCircle=false, const Standard_Integer NbOfPoints=6);
		%feature("autodoc", "1");
		Select3D_SensitiveCircle(const Handle_SelectBasics_EntityOwner &OwnerId, const Handle_Geom_Circle &TheCircle, const Standard_Real u1, const Standard_Real u2, const Standard_Boolean FilledCircle=false, const Standard_Integer NbOfPoints=6);
		%feature("autodoc", "1");
		Select3D_SensitiveCircle(const Handle_SelectBasics_EntityOwner &OwnerId, const Handle_TColgp_HArray1OfPnt &apolyg3d, const Standard_Boolean FilledCircle=false);
		%feature("autodoc", "1");
		Select3D_SensitiveCircle(const Handle_SelectBasics_EntityOwner &OwnerId, const TColgp_Array1OfPnt &apolyg3d, const Standard_Boolean FilledCircle=false);
		%feature("autodoc","Matches(Standard_Real X, Standard_Real Y, Standard_Real aTol) -> Standard_Real");
