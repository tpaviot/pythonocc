...
class ProjLib_ProjectOnPlane : public Adaptor3d_Curve {
	public:
		...
		%feature("autodoc", "1");
		void Load(const Handle_Adaptor3d_HCurve &C, const Standard_Real Tolerance, const Standard_Boolean KeepParametrization=true);
		%feature("autodoc", "1");
...
class ProjLib_PrjResolve {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Standard_Real t, const Standard_Real U, const Standard_Real V, const gp_Pnt2d Tol, const gp_Pnt2d Inf, const gp_Pnt2d Sup, const Standard_Real FTol=-0x00000000000000001, const Standard_Boolean StrictInside=false);
		%feature("autodoc", "1");
		Standard_Boolean IsDone() const;
		%feature("autodoc", "1");
