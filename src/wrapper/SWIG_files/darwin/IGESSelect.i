...
class IGESSelect_IGESTypeForm : public IFSelect_Signature {
	public:
		%feature("autodoc", "1");
		IGESSelect_IGESTypeForm(const Standard_Boolean withform=true);
		%feature("autodoc", "1");
...
class IGESSelect_WorkLibrary : public IFSelect_WorkLibrary {
	public:
		%feature("autodoc", "1");
		IGESSelect_WorkLibrary(const Standard_Boolean modefnes=false);
		%feature("autodoc", "1");
...
class IGESSelect_CounterOfLevelNumber : public IFSelect_SignCounter {
	public:
		%feature("autodoc", "1");
		IGESSelect_CounterOfLevelNumber(const Standard_Boolean withmap=true, const Standard_Boolean withlist=false);
		%feature("autodoc", "1");
		virtual		void Clear();
		%feature("autodoc", "1");
