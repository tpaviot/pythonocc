...
class IGESData_ParamReader {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean ReadBoolean(const IGESData_ParamCursor &PC, const Message_Msg &amsg, Standard_Boolean & val, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Standard_Boolean ReadBoolean(const IGESData_ParamCursor &PC, const char * mess, Standard_Boolean & val, const Standard_Boolean exact=true);
		...
		%feature("autodoc", "1");
		Standard_Boolean ReadEntity(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, IGESData_Status & aStatus, Handle_IGESData_IGESEntity & val, const Standard_Boolean canbenul=false);
		%feature("autodoc", "1");
		Standard_Boolean ReadEntity(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, const char * mess, Handle_IGESData_IGESEntity & val, const Standard_Boolean canbenul=false);
		%feature("autodoc", "1");
		Standard_Boolean ReadEntity(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, IGESData_Status & aStatus, const Handle_Standard_Type &type, Handle_IGESData_IGESEntity & val, const Standard_Boolean canbenul=false);
		%feature("autodoc", "1");
		Standard_Boolean ReadEntity(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, const char * mess, const Handle_Standard_Type &type, Handle_IGESData_IGESEntity & val, const Standard_Boolean canbenul=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean ReadEntList(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, Message_Msg & amsg, Interface_EntityList & val, const Standard_Boolean ord=true);
		%feature("autodoc", "1");
		Standard_Boolean ReadEntList(const Handle_IGESData_IGESReaderData &IR, const IGESData_ParamCursor &PC, const char * mess, Interface_EntityList & val, const Standard_Boolean ord=true);
...
class IGESData_ParamCursor {
	public:
		...
		%feature("autodoc", "1");
		void SetTerm(const Standard_Integer size, const Standard_Boolean autoadv=true);
		%feature("autodoc", "1");
		void SetOne(const Standard_Boolean autoadv=true);
		%feature("autodoc", "1");
		void SetXY(const Standard_Boolean autoadv=true);
		%feature("autodoc", "1");
		void SetXYZ(const Standard_Boolean autoadv=true);
		%feature("autodoc", "1");
...
class IGESData_FreeFormatEntity : public IGESData_UndefinedEntity {
	public:
		...
		%feature("autodoc", "1");
		void AddEntity(const Interface_ParamType ptype, const Handle_IGESData_IGESEntity &ent, const Standard_Boolean negative=false);
		%feature("autodoc", "1");
...
class IGESData_IGESModel : public Interface_InterfaceModel {
	public:
		...
		%feature("autodoc", "1");
		void SetStartSection(const Handle_TColStd_HSequenceOfHAsciiString &list, const Standard_Boolean copy=true);
		%feature("autodoc", "1");
...
class IGESData_BasicEditor {
	public:
		...
		%feature("autodoc", "1");
		void ApplyUnit(const Standard_Boolean enforce=false);
		%feature("autodoc", "1");
		void ComputeStatus();
		%feature("autodoc", "1");
...
class IGESData_IGESWriter {
	public:
		...
		%feature("autodoc", "1");
		void Send(const Handle_IGESData_IGESEntity &val, const Standard_Boolean negative=false);
		%feature("autodoc", "1");
