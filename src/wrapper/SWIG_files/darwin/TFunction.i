...
class TFunction_Logbook {
	public:
		...
		%feature("autodoc", "1");
		void SetImpacted(const TDF_Label &L, const Standard_Boolean WithChildren=false);
		%feature("autodoc", "1");
		void SetValid(const TDF_Label &L, const Standard_Boolean WithChildren=false);
		%feature("autodoc", "1");
		TDF_LabelMap & ChangeValid();
		%feature("autodoc", "1");
		Standard_Boolean IsModified(const TDF_Label &L, const Standard_Boolean WithChildren=false) const;
		%feature("autodoc", "1");
