...
class Convert_TorusToBSplineSurface : public Convert_ElementarySurfaceToBSplineSurface {
	public:
		...
		%feature("autodoc", "1");
		Convert_TorusToBSplineSurface(const gp_Torus T, const Standard_Real Param1, const Standard_Real Param2, const Standard_Boolean UTrim=true);
		%feature("autodoc", "1");
...
class Convert_SphereToBSplineSurface : public Convert_ElementarySurfaceToBSplineSurface {
	public:
		...
		%feature("autodoc", "1");
		Convert_SphereToBSplineSurface(const gp_Sphere Sph, const Standard_Real Param1, const Standard_Real Param2, const Standard_Boolean UTrim=true);
		%feature("autodoc", "1");
