...
class ShapeProcess_DictionaryOfOperator : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		const Handle_ShapeProcess_Operator & Item(const char * name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		const Handle_ShapeProcess_Operator & Item(const TCollection_AsciiString &name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		Standard_Boolean GetItem(const char * name, Handle_ShapeProcess_Operator & anitem, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		Standard_Boolean GetItem(const TCollection_AsciiString &name, Handle_ShapeProcess_Operator & anitem, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		void SetItem(const char * name, const Handle_ShapeProcess_Operator &anitem, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		void SetItem(const TCollection_AsciiString &name, const Handle_ShapeProcess_Operator &anitem, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Handle_ShapeProcess_Operator & NewItem(const char * name, Standard_Boolean & isvalued, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Handle_ShapeProcess_Operator & NewItem(const TCollection_AsciiString &name, Standard_Boolean & isvalued, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
