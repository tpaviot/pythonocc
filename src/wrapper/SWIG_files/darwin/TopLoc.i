...
%include TopLoc_required_python_modules.i
...
class TopLoc_ItemLocation {
	public:
		%feature("autodoc", "1");
		TopLoc_ItemLocation(const Handle_TopLoc_Datum3D &D, const Standard_Integer P, const Standard_Boolean fromTrsf=false);
		%feature("autodoc", "1");
