...
class GeomAPI_Interpolate {
	public:
		...
		%feature("autodoc", "1");
		void Load(const gp_Vec InitialTangent, const gp_Vec FinalTangent, const Standard_Boolean Scale=true);
		%feature("autodoc", "1");
		void Load(const TColgp_Array1OfVec &Tangents, const Handle_TColStd_HArray1OfBoolean &TangentFlags, const Standard_Boolean Scale=true);
		%feature("autodoc", "1");
		void Perform();
		%feature("autodoc", "1");
