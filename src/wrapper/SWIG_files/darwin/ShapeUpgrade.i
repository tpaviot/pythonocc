...
class ShapeUpgrade_SplitCurve : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Standard_Boolean Segment=true);
		%feature("autodoc", "1");
...
class ShapeUpgrade_ShapeDivide {
	public:
		...
		%feature("autodoc", "1");
		virtual		Standard_Boolean Perform(const Standard_Boolean newContext=true);
		%feature("autodoc", "1");
...
class ShapeUpgrade_SplitSurface : public MMgt_TShared {
	public:
		...
		virtual		void Build(const Standard_Boolean Segment);
		%feature("autodoc", "1");
		virtual		void Compute(const Standard_Boolean Segment=true);
		%feature("autodoc", "1");
		void Perform(const Standard_Boolean Segment=true);
		%feature("autodoc", "1");
...
class ShapeUpgrade_UnifySameDomain : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		ShapeUpgrade_UnifySameDomain(const TopoDS_Shape aShape, const Standard_Boolean UnifyEdges=true, const Standard_Boolean UnifyFaces=true, const Standard_Boolean ConcatBSplines=false);
		%feature("autodoc", "1");
		void Initialize(const TopoDS_Shape aShape, const Standard_Boolean UnifyEdges=true, const Standard_Boolean UnifyFaces=true, const Standard_Boolean ConcatBSplines=false);
		%feature("autodoc", "1");
		void Build();
		%feature("autodoc", "1");
