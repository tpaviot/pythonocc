...
class Handle_BinLDrivers_DocumentRetrievalDriver : public Handle_PCDM_RetrievalDriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BinLDrivers_DocumentRetrievalDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BinLDrivers_DocumentStorageDriver : public Handle_PCDM_StorageDriver {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BinLDrivers_DocumentStorageDriver DownCast(const Handle_Standard_Transient &AnObject);
...
class BinLDrivers_DocumentStorageDriver : public PCDM_StorageDriver {
	public:
		...
		%feature("autodoc", "1");
		void AddSection(const TCollection_AsciiString &theName, const Standard_Boolean isPostRead=true);
		%feature("autodoc", "1");
