...
class IGESCAFControl_Writer : public IGESControl_Writer {
	public:
		...
		%feature("autodoc", "1");
		IGESCAFControl_Writer(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
...
class IGESCAFControl_Reader : public IGESControl_Reader {
	public:
		...
		%feature("autodoc", "1");
		IGESCAFControl_Reader(const Handle_XSControl_WorkSession &WS, const Standard_Boolean scratch=true);
		%feature("autodoc", "1");
