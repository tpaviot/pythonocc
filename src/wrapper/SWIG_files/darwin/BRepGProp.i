...
class BRepGProp {
	public:
		...
		%feature("autodoc", "1");
		static		void VolumeProperties(const TopoDS_Shape S, GProp_GProps & VProps, const Standard_Boolean OnlyClosed=false);
		%feature("autodoc", "1");
		static		Standard_Real VolumeProperties(const TopoDS_Shape S, GProp_GProps & VProps, const Standard_Real Eps, const Standard_Boolean OnlyClosed=false);
		%feature("autodoc", "1");
		static		Standard_Real VolumePropertiesGK(const TopoDS_Shape S, GProp_GProps & VProps, const Standard_Real Eps=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Boolean OnlyClosed=false, const Standard_Boolean IsUseSpan=false, const Standard_Boolean CGFlag=false, const Standard_Boolean IFlag=false);
		%feature("autodoc", "1");
...
class BRepGProp_Face {
	public:
		%feature("autodoc", "1");
		BRepGProp_Face(const Standard_Boolean IsUseSpan=false);
		%feature("autodoc", "1");
		BRepGProp_Face(const TopoDS_Face F, const Standard_Boolean IsUseSpan=false);
		%feature("autodoc", "1");
