...
class ShapeConstruct_Curve {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean AdjustCurve(const Handle_Geom_Curve &C3D, const gp_Pnt P1, const gp_Pnt P2, const Standard_Boolean take1=true, const Standard_Boolean take2=true) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean AdjustCurve2d(const Handle_Geom2d_Curve &C2D, const gp_Pnt2d P1, const gp_Pnt2d P2, const Standard_Boolean take1=true, const Standard_Boolean take2=true) const;
		%feature("autodoc", "1");
...
class ShapeConstruct {
	public:
		...
		%feature("autodoc","JoinCurves(const c2d1, const ac2d2, TopAbs_Orientation Orient1, TopAbs_Orientation Orient2, Standard_Boolean isError=false) -> [Standard_Real, Standard_Real, Standard_Real, Standard_Real]");

		static		Standard_Boolean JoinCurves(const Handle_Geom2d_Curve &c2d1, const Handle_Geom2d_Curve &ac2d2, const TopAbs_Orientation Orient1, const TopAbs_Orientation Orient2, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue, Handle_Geom2d_Curve & c2dOut, Standard_Boolean & isRev1, Standard_Boolean & isRev2, const Standard_Boolean isError=false);
