...
class BRepAlgoAPI_Check {
	public:
		...
		BRepAlgoAPI_Check();
		%feature("autodoc", "1");
		BRepAlgoAPI_Check(const TopoDS_Shape theS, const Standard_Boolean bTestSE=true, const Standard_Boolean bTestSI=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Check(const TopoDS_Shape theS1, const TopoDS_Shape theS2, const BOPAlgo_Operation theOp=BOPAlgo_UNKNOWN, const Standard_Boolean bTestSE=true, const Standard_Boolean bTestSI=true);
		%feature("autodoc", "1");
		void SetData(const TopoDS_Shape theS, const Standard_Boolean bTestSE=true, const Standard_Boolean bTestSI=true);
		%feature("autodoc", "1");
		void SetData(const TopoDS_Shape theS1, const TopoDS_Shape theS2, const BOPAlgo_Operation theOp=BOPAlgo_UNKNOWN, const Standard_Boolean bTestSE=true, const Standard_Boolean bTestSI=true);
		%feature("autodoc", "1");
		void Perform();
		%feature("autodoc", "1");
...
class BRepAlgoAPI_Section : public BRepAlgoAPI_BooleanOperation {
	public:
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const TopoDS_Shape S1, const TopoDS_Shape S2, const BOPAlgo_PaveFiller &aDSF, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const TopoDS_Shape Sh1, const TopoDS_Shape Sh2, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const TopoDS_Shape Sh, const gp_Pln Pl, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const TopoDS_Shape Sh, const Handle_Geom_Surface &Sf, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const Handle_Geom_Surface &Sf, const TopoDS_Shape Sh, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
		BRepAlgoAPI_Section(const Handle_Geom_Surface &Sf1, const Handle_Geom_Surface &Sf2, const Standard_Boolean PerformNow=true);
		%feature("autodoc", "1");
...
class BRepAlgoAPI_Cut : public BRepAlgoAPI_BooleanOperation {
	public:
		...
		%feature("autodoc", "1");
		BRepAlgoAPI_Cut(const TopoDS_Shape S1, const TopoDS_Shape S2, const BOPAlgo_PaveFiller &aDSF, const Standard_Boolean bFWD=true);
