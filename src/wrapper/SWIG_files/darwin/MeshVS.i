...
class MeshVS_Tool {
	public:
		...
		MeshVS_Tool();
		%feature("autodoc", "1");
		static		Handle_Graphic3d_AspectFillArea3d CreateAspectFillArea3d(const Handle_MeshVS_Drawer &theDr, const Standard_Boolean UseDefaults=true);
		%feature("autodoc", "1");
		static		Handle_Graphic3d_AspectFillArea3d CreateAspectFillArea3d(const Handle_MeshVS_Drawer &theDr, const Graphic3d_MaterialAspect &Mat, const Standard_Boolean UseDefaults=true);
		%feature("autodoc", "1");
		static		Handle_Graphic3d_AspectLine3d CreateAspectLine3d(const Handle_MeshVS_Drawer &theDr, const Standard_Boolean UseDefaults=true);
		%feature("autodoc", "1");
		static		Handle_Graphic3d_AspectMarker3d CreateAspectMarker3d(const Handle_MeshVS_Drawer &theDr, const Standard_Boolean UseDefaults=true);
		%feature("autodoc", "1");
		static		Handle_Graphic3d_AspectText3d CreateAspectText3d(const Handle_MeshVS_Drawer &theDr, const Standard_Boolean UseDefaults=true);
		%feature("autodoc", "1");
...
class MeshVS_Mesh : public AIS_InteractiveObject {
	public:
		%feature("autodoc", "1");
		MeshVS_Mesh(const Standard_Boolean theIsAllowOverlapped=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void AddBuilder(const Handle_MeshVS_PrsBuilder &Builder, const Standard_Boolean TreatAsHilighter=false);
		%feature("autodoc", "1");
...
class MeshVS_MeshEntityOwner : public SelectMgr_EntityOwner {
	public:
		%feature("autodoc", "1");
		MeshVS_MeshEntityOwner(const SelectMgr_SOPtr &SelObj, const Standard_Integer ID, const Standard_Address MeshEntity, const MeshVS_EntityType &Type, const Standard_Integer Priority=0, const Standard_Boolean IsGroup=false);
		%feature("autodoc", "1");
