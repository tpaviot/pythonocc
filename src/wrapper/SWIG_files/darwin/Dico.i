...
class Dico_DictionaryOfInteger : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		const Standard_Integer & Item(const char * name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		const Standard_Integer & Item(const TCollection_AsciiString &name, const Standard_Boolean exact=true) const;
		%feature("autodoc","GetItem(Standard_CString name, Standard_Boolean exact=true) -> Standard_Integer");

		Standard_Boolean GetItem(const char * name, Standard_Integer &OutValue, const Standard_Boolean exact=true) const;
		%feature("autodoc","GetItem(const name, Standard_Boolean exact=true) -> Standard_Integer");

		Standard_Boolean GetItem(const TCollection_AsciiString &name, Standard_Integer &OutValue, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		void SetItem(const char * name, const Standard_Integer &anitem, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		void SetItem(const TCollection_AsciiString &name, const Standard_Integer &anitem, const Standard_Boolean exact=true);
		%feature("autodoc","1");
		%extend {
				Standard_Integer GetNewItem(const Standard_CString name, Standard_Boolean & isvalued, const Standard_Boolean exact=true) {
				return (Standard_Integer) $self->NewItem(name,isvalued,exact);
				}
		};
		%feature("autodoc","1");
		%extend {
				void SetNewItem(Standard_Integer value ,const Standard_CString name, Standard_Boolean & isvalued, const Standard_Boolean exact=true) {
				$self->NewItem(name,isvalued,exact)=value;
				}
		};
		%feature("autodoc","1");
		%extend {
				Standard_Integer GetNewItem(const TCollection_AsciiString &name, Standard_Boolean & isvalued, const Standard_Boolean exact=true) {
				return (Standard_Integer) $self->NewItem(name,isvalued,exact);
				}
		};
		%feature("autodoc","1");
		%extend {
				void SetNewItem(Standard_Integer value ,const TCollection_AsciiString &name, Standard_Boolean & isvalued, const Standard_Boolean exact=true) {
				$self->NewItem(name,isvalued,exact)=value;
				}
		};
		%feature("autodoc", "1");
...
class Dico_DictionaryOfTransient : public MMgt_TShared {
	public:
		...
		Standard_Boolean HasItem(const TCollection_AsciiString &name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		const Handle_Standard_Transient & Item(const char * name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		const Handle_Standard_Transient & Item(const TCollection_AsciiString &name, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		Standard_Boolean GetItem(const char * name, Handle_Standard_Transient & anitem, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		Standard_Boolean GetItem(const TCollection_AsciiString &name, Handle_Standard_Transient & anitem, const Standard_Boolean exact=true) const;
		%feature("autodoc", "1");
		void SetItem(const char * name, const Handle_Standard_Transient &anitem, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		void SetItem(const TCollection_AsciiString &name, const Handle_Standard_Transient &anitem, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Handle_Standard_Transient & NewItem(const char * name, Standard_Boolean & isvalued, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Handle_Standard_Transient & NewItem(const TCollection_AsciiString &name, Standard_Boolean & isvalued, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Standard_Boolean RemoveItem(const char * name, const Standard_Boolean cln=true, const Standard_Boolean exact=true);
		%feature("autodoc", "1");
		Standard_Boolean RemoveItem(const TCollection_AsciiString &name, const Standard_Boolean cln=true, const Standard_Boolean exact=true);
