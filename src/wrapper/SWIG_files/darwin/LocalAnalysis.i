...
class LocalAnalysis_SurfaceContinuity {
	public:
		%feature("autodoc", "1");
		LocalAnalysis_SurfaceContinuity(const Handle_Geom_Surface &Surf1, const Standard_Real u1, const Standard_Real v1, const Handle_Geom_Surface &Surf2, const Standard_Real u2, const Standard_Real v2, const GeomAbs_Shape Order, const Standard_Real EpsNul=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC0=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC2=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsG1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Percent=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Real Maxlen=10000);
		%feature("autodoc", "1");
		LocalAnalysis_SurfaceContinuity(const Handle_Geom2d_Curve &curv1, const Handle_Geom2d_Curve &curv2, const Standard_Real U, const Handle_Geom_Surface &Surf1, const Handle_Geom_Surface &Surf2, const GeomAbs_Shape Order, const Standard_Real EpsNul=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC0=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC2=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsG1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Percent=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Real Maxlen=10000);
		%feature("autodoc", "1");
		LocalAnalysis_SurfaceContinuity(const Standard_Real EpsNul=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC0=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC2=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsG1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Percent=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Real Maxlen=10000);
		%feature("autodoc", "1");
...
class LocalAnalysis_CurveContinuity {
	public:
		%feature("autodoc", "1");
		LocalAnalysis_CurveContinuity(const Handle_Geom_Curve &Curv1, const Standard_Real u1, const Handle_Geom_Curve &Curv2, const Standard_Real u2, const GeomAbs_Shape Order, const Standard_Real EpsNul=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC0=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsC2=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsG1=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real EpsG2=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Percent=1.00000000000000002081668171172168513294309377670288085938e-2, const Standard_Real Maxlen=10000);
		%feature("autodoc", "1");
		Standard_Boolean IsDone() const;
		%feature("autodoc", "1");
		LocalAnalysis_StatusErrorType StatusError() const;
