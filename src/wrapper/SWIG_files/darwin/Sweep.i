...
class Sweep_NumShape {
	public:
		...
		Sweep_NumShape();
		%feature("autodoc", "1");
		Sweep_NumShape(const Standard_Integer Index, const TopAbs_ShapeEnum Type, const Standard_Boolean Closed=false, const Standard_Boolean BegInf=false, const Standard_Boolean EndInf=false);
		%feature("autodoc", "1");
		void Init(const Standard_Integer Index, const TopAbs_ShapeEnum Type, const Standard_Boolean Closed=false, const Standard_Boolean BegInf=false, const Standard_Boolean EndInf=false);
		%feature("autodoc", "1");
