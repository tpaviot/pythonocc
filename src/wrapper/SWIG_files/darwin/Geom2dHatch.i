...
class Geom2dHatch_Hatcher {
	public:
		%feature("autodoc", "1");
		Geom2dHatch_Hatcher(const Geom2dHatch_Intersector &Intersector, const Standard_Real Confusion2d, const Standard_Real Confusion3d, const Standard_Boolean KeepPnt=false, const Standard_Boolean KeepSeg=false);
		%feature("autodoc", "1");
