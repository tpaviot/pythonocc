...
class Bnd_B2d {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean IsOut(const gp_XY theCenter, const Standard_Real theRadius, const Standard_Boolean isCircleHollow=false) const;
		%feature("autodoc", "1");
...
class Bnd_B3d {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean IsOut(const gp_XYZ theCenter, const Standard_Real theRadius, const Standard_Boolean isSphereHollow=false) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean IsOut(const gp_Ax1 theLine, const Standard_Boolean isRay=false, const Standard_Real theOverthickness=0.0) const;
		%feature("autodoc", "1");
