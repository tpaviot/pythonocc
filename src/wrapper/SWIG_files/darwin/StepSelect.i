...
%include StepSelect_required_python_modules.i
...
class Handle_StepSelect_FileModifier : public Handle_IFSelect_GeneralModifier {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_StepSelect_FileModifier DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_StepSelect_FloatFormat : public Handle_StepSelect_FileModifier {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_StepSelect_FloatFormat DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_StepSelect_Activator : public Handle_IFSelect_Activator {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_StepSelect_Activator DownCast(const Handle_Standard_Transient &AnObject);
...
class StepSelect_WorkLibrary : public IFSelect_WorkLibrary {
	public:
		%feature("autodoc", "1");
		StepSelect_WorkLibrary(const Standard_Boolean copymode=true);
		%feature("autodoc", "1");
