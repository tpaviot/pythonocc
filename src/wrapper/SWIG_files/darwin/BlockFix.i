...
%include BlockFix_required_python_modules.i
...
class Handle_BlockFix_SphereSpaceModifier : public Handle_BRepTools_Modification {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BlockFix_SphereSpaceModifier DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BlockFix_PeriodicSurfaceModifier : public Handle_BRepTools_Modification {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BlockFix_PeriodicSurfaceModifier DownCast(const Handle_Standard_Transient &AnObject);
...
class Handle_BlockFix_BlockFixAPI : public Handle_MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_BlockFix_BlockFixAPI DownCast(const Handle_Standard_Transient &AnObject);
