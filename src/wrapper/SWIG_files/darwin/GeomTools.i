...
%include GeomTools_required_python_modules.i
...
class GeomTools_Curve2dSet {
	public:
		...
		%feature("autodoc", "1");
		static		void PrintCurve2d(const Handle_Geom2d_Curve &C, Standard_OStream & OS, const Standard_Boolean compact=false);
		%feature("autodoc", "1");
...
class GeomTools_CurveSet {
	public:
		...
		%feature("autodoc", "1");
		static		void PrintCurve(const Handle_Geom_Curve &C, Standard_OStream & OS, const Standard_Boolean compact=false);
		%feature("autodoc", "1");
...
class GeomTools_SurfaceSet {
	public:
		...
		%feature("autodoc", "1");
		static		void PrintSurface(const Handle_Geom_Surface &S, Standard_OStream & OS, const Standard_Boolean compact=false);
		%feature("autodoc", "1");
...
class GeomTools_UndefinedTypeHandler : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		virtual		void PrintCurve(const Handle_Geom_Curve &C, Standard_OStream & OS, const Standard_Boolean compact=false) const;
		%feature("autodoc", "1");
		virtual		std::istream & ReadCurve(const Standard_Integer ctype, std::istream & IS, Handle_Geom_Curve & C) const;
		%feature("autodoc", "1");
		virtual		void PrintCurve2d(const Handle_Geom2d_Curve &C, Standard_OStream & OS, const Standard_Boolean compact=false) const;
		%feature("autodoc", "1");
		virtual		std::istream & ReadCurve2d(const Standard_Integer ctype, std::istream & IS, Handle_Geom2d_Curve & C) const;
		%feature("autodoc", "1");
		virtual		void PrintSurface(const Handle_Geom_Surface &S, Standard_OStream & OS, const Standard_Boolean compact=false) const;
		%feature("autodoc", "1");
