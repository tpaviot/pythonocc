...
class Law_Interpol : public Law_BSpFunc {
	public:
		...
		Law_Interpol();
		%feature("autodoc", "1");
		void Set(const TColgp_Array1OfPnt2d &ParAndRad, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		void SetInRelative(const TColgp_Array1OfPnt2d &ParAndRad, const Standard_Real Ud, const Standard_Real Uf, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		void Set(const TColgp_Array1OfPnt2d &ParAndRad, const Standard_Real Dd, const Standard_Real Df, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		void SetInRelative(const TColgp_Array1OfPnt2d &ParAndRad, const Standard_Real Ud, const Standard_Real Uf, const Standard_Real Dd, const Standard_Real Df, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		virtual		const Handle_Standard_Type & DynamicType() const;
...
class Law_BSpline : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		Law_BSpline(const TColStd_Array1OfReal &Poles, const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Multiplicities, const Standard_Integer Degree, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
		Law_BSpline(const TColStd_Array1OfReal &Poles, const TColStd_Array1OfReal &Weights, const TColStd_Array1OfReal &Knots, const TColStd_Array1OfInteger &Multiplicities, const Standard_Integer Degree, const Standard_Boolean Periodic=false);
		%feature("autodoc", "1");
