...
class ShapeAnalysis_Surface : public MMgt_TShared {
	public:
		...
		%feature("autodoc","DegeneratedValues(const P3d, Standard_Real preci, Standard_Boolean forward=true) -> [Standard_Real, Standard_Real]");

		Standard_Boolean DegeneratedValues(const gp_Pnt P3d, const Standard_Real preci, gp_Pnt2d & firstP2d, gp_Pnt2d & lastP2d, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean forward=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc","UVFromIso(const P3D, Standard_Real preci) -> [Standard_Real, Standard_Real]");
...
class ShapeAnalysis_FreeBounds {
	public:
		...
		%feature("autodoc", "1");
		ShapeAnalysis_FreeBounds(const TopoDS_Shape shape, const Standard_Real toler, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=true);
		%feature("autodoc", "1");
		ShapeAnalysis_FreeBounds(const TopoDS_Shape shape, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=true, const Standard_Boolean checkinternaledges=false);
		%feature("autodoc", "1");
...
class ShapeAnalysis_Edge {
	public:
		...
		%feature("autodoc","Curve3d(const edge, Standard_Boolean orient=true) -> [Standard_Real, Standard_Real]");

		Standard_Boolean Curve3d(const TopoDS_Edge edge, Handle_Geom_Curve & C3d, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean orient=true) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc","PCurve(const edge, const face, Standard_Boolean orient=true) -> [Standard_Real, Standard_Real]");

		Standard_Boolean PCurve(const TopoDS_Edge edge, const TopoDS_Face face, Handle_Geom2d_Curve & C2d, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean orient=true) const;
		%feature("autodoc","PCurve(const edge, const surface, const location, Standard_Boolean orient=true) -> [Standard_Real, Standard_Real]");

		Standard_Boolean PCurve(const TopoDS_Edge edge, const Handle_Geom_Surface &surface, const TopLoc_Location &location, Handle_Geom2d_Curve & C2d, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean orient=true) const;
		%feature("autodoc", "1");
		...
		%feature("autodoc","CheckVertexTolerance(const edge) -> [Standard_Real, Standard_Real]");
...
class ShapeAnalysis_Curve {
	public:
		%feature("autodoc", "1");
		ShapeAnalysis_Curve();
		%feature("autodoc","Project(const C3D, const P3D, Standard_Real preci, Standard_Boolean AdjustToEnds=true) -> Standard_Real");

		Standard_Real Project(const Handle_Geom_Curve &C3D, const gp_Pnt P3D, const Standard_Real preci, gp_Pnt & proj, Standard_Real &OutValue, const Standard_Boolean AdjustToEnds=true) const;
		%feature("autodoc","Project(const C3D, const P3D, Standard_Real preci, Standard_Boolean AdjustToEnds=true) -> Standard_Real");

		Standard_Real Project(const Adaptor3d_Curve &C3D, const gp_Pnt P3D, const Standard_Real preci, gp_Pnt & proj, Standard_Real &OutValue, const Standard_Boolean AdjustToEnds=true) const;
		%feature("autodoc","Project(const C3D, const P3D, Standard_Real preci, Standard_Real cf, Standard_Real cl, Standard_Boolean AdjustToEnds=true) -> Standard_Real");

		Standard_Real Project(const Handle_Geom_Curve &C3D, const gp_Pnt P3D, const Standard_Real preci, gp_Pnt & proj, Standard_Real &OutValue, const Standard_Real cf, const Standard_Real cl, const Standard_Boolean AdjustToEnds=true) const;
		...
		%feature("autodoc","NextProject(Standard_Real paramPrev, const C3D, const P3D, Standard_Real preci, Standard_Real cf, Standard_Real cl, Standard_Boolean AdjustToEnds=true) -> Standard_Real");

		Standard_Real NextProject(const Standard_Real paramPrev, const Handle_Geom_Curve &C3D, const gp_Pnt P3D, const Standard_Real preci, gp_Pnt & proj, Standard_Real &OutValue, const Standard_Real cf, const Standard_Real cl, const Standard_Boolean AdjustToEnds=true) const;
...
class ShapeAnalysis_CheckSmallFace {
	public:
		...
		%feature("autodoc","CheckPin(const F) -> [Standard_Integer, Standard_Integer]");

		Standard_Boolean CheckPin(const TopoDS_Face F, Standard_Integer &OutValue, Standard_Integer &OutValue);
		%feature("autodoc","CheckTwisted(const F) -> [Standard_Real, Standard_Real]");
...
class ShapeAnalysis_WireOrder {
	public:
		...
		%feature("autodoc", "1");
		void Perform(const Standard_Boolean closed=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc","Chain(Standard_Integer num) -> [Standard_Integer, Standard_Integer]");
		...
		%feature("autodoc","Couple(Standard_Integer num) -> [Standard_Integer, Standard_Integer]");
...
class ShapeAnalysis_Wire : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckOrder(const Standard_Boolean isClosed=true, const Standard_Boolean mode3d=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckOrder(ShapeAnalysis_WireOrder & sawo, const Standard_Boolean isClosed=true, const Standard_Boolean mode3d=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc","CheckSeam(Standard_Integer num) -> [Standard_Real, Standard_Real]");
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckOuterBound(const Standard_Boolean APIMake=true);
		%feature("autodoc","CheckNotchedEdges(Standard_Integer num, Standard_Real Tolerance=0.0) -> [Standard_Integer, Standard_Real]");
		...
		%feature("autodoc","CheckShapeConnect(const shape, Standard_Real prec=0.0) -> [Standard_Real, Standard_Real, Standard_Real, Standard_Real]");
...
class ShapeAnalysis_Shell {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckOrientedShells(const TopoDS_Shape shape, const Standard_Boolean alsofree=false, const Standard_Boolean checkinternaledges=false);
		%feature("autodoc", "1");
...
class ShapeAnalysis_FreeBoundsProperties {
	public:
		...
		%feature("autodoc", "1");
		ShapeAnalysis_FreeBoundsProperties(const TopoDS_Shape shape, const Standard_Real tolerance, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=false);
		%feature("autodoc", "1");
		ShapeAnalysis_FreeBoundsProperties(const TopoDS_Shape shape, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=false);
		%feature("autodoc", "1");
		void Init(const TopoDS_Shape shape, const Standard_Real tolerance, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=false);
		%feature("autodoc", "1");
		void Init(const TopoDS_Shape shape, const Standard_Boolean splitclosed=false, const Standard_Boolean splitopen=false);
		%feature("autodoc", "1");
		Standard_Boolean Perform();
		%feature("autodoc", "1");
		Standard_Boolean IsLoaded() const;
...
class ShapeAnalysis_WireVertex {
	public:
		...
		%feature("autodoc","Data(Standard_Integer num) -> [Standard_Real, Standard_Real]");
