...
class ShapeExtend_WireData : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		ShapeExtend_WireData(const TopoDS_Wire wire, const Standard_Boolean chained=true, const Standard_Boolean theManifoldMode=true);
		%feature("autodoc", "1");
		void Init(const Handle_ShapeExtend_WireData &other);
		%feature("autodoc", "1");
		Standard_Boolean Init(const TopoDS_Wire wire, const Standard_Boolean chained=true, const Standard_Boolean theManifoldMode=true);
		%feature("autodoc", "1");
		void Clear();
		%feature("autodoc", "1");
		void ComputeSeams(const Standard_Boolean enforce=true);
		%feature("autodoc", "1");
...
class ShapeExtend_Explorer {
	public:
		...
		%feature("autodoc", "1");
		void ListFromSeq(const Handle_TopTools_HSequenceOfShape &seqval, TopTools_ListOfShape & lisval, const Standard_Boolean clear=true) const;
		%feature("autodoc", "1");
