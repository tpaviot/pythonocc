...
class GEOMAlgo_ShapeAlgo : public GEOMAlgo_Algo {
	public:
		%feature("autodoc", "1");
		void SetContext(const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
...
class GEOMAlgo_GluerAlgo {
	public:
		...
		virtual		void Clear();
		%feature("autodoc", "1");
		const Handle_XIntTools_Context & Context();
		%feature("autodoc", "1");
		const TopTools_DataMapOfShapeListOfShape & Images() const;
		%feature("autodoc", "1");
		const TopTools_DataMapOfShapeShape & Origins() const;
...
class GEOMAlgo_Tools3D {
	public:
		...
		GEOMAlgo_Tools3D();
		%feature("autodoc", "1");
		static		Standard_Boolean IsSplitToReverse(const TopoDS_Shape theSplit, const TopoDS_Shape theShape, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		Standard_Boolean IsSplitToReverse(const TopoDS_Face theSplit, const TopoDS_Face theShape, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		Standard_Boolean IsSplitToReverse(const TopoDS_Edge theEdge, const TopoDS_Edge theSplit, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		TopAbs_State ComputeStateByOnePoint(const TopoDS_Shape theShape, const TopoDS_Solid theSolid, const Standard_Real theTol, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		TopAbs_State ComputeState(const gp_Pnt thePoint, const TopoDS_Solid theSolid, const Standard_Real theTol, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		TopAbs_State ComputeState(const TopoDS_Vertex theVertex, const TopoDS_Solid theSolid, const Standard_Real theTol, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		TopAbs_State ComputeState(const TopoDS_Edge theEdge, const TopoDS_Solid theSolid, const Standard_Real theTol, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		TopAbs_State ComputeState(const TopoDS_Face theFace, const TopoDS_Solid theSolid, const Standard_Real theTol, const TopTools_IndexedMapOfShape &theBounds, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		Standard_Boolean IsInternalFace(const TopoDS_Face theFace, const TopoDS_Edge theEdge, const TopoDS_Face theFace1, const TopoDS_Face theFace2, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		Standard_Boolean IsInternalFace(const TopoDS_Face theFace, const TopoDS_Edge theEdge, const TopTools_ListOfShape &theLF, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
		static		Standard_Boolean IsInternalFace(const TopoDS_Face theFace, const TopoDS_Solid theSolid, const TopTools_IndexedDataMapOfShapeListOfShape &theMEF, const Standard_Real theTol, const Handle_XIntTools_Context &theContext);
		%feature("autodoc", "1");
...
%nodefaultctor GEOMAlgo_RemoverWebs;
...
%feature("shadow") GEOMAlgo_RemoverWebs::~GEOMAlgo_RemoverWebs %{
def __del__(self):
	try:
		self.thisown = False
		GarbageCollector.garbage.collect_object(self)
...
class GEOMAlgo_Tools {
	public:
		...
		%feature("autodoc", "1");
		static		Standard_Integer RefineSDShapes(GEOMAlgo_IndexedDataMapOfPassKeyShapeListOfShape & aMSD, const Standard_Real aTol, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
		static		Standard_Integer FindSDShapes(const TopTools_ListOfShape &aLE, const Standard_Real aTol, TopTools_IndexedDataMapOfShapeListOfShape & aMEE, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
		static		Standard_Integer FindSDShapes(const TopoDS_Shape aE1, const TopTools_ListOfShape &aLE, const Standard_Real aTol, TopTools_ListOfShape & aLESD, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
		static		Standard_Boolean ProjectPointOnShape(const gp_Pnt aP1, const TopoDS_Shape aS, gp_Pnt & aP2, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Standard_Integer BuildPCurveForEdgeOnFace(const TopoDS_Edge aE, const TopoDS_Edge aEold, const TopoDS_Face aF, const Handle_XIntTools_Context &aCtx);
