...
class XCAFPrs {
	public:
		...
		%feature("autodoc", "1");
		static		Standard_Boolean DispatchStyles(const TopoDS_Shape shape, const XCAFPrs_DataMapOfShapeStyle &settings, XCAFPrs_DataMapOfStyleShape & items, const XCAFPrs_Style &DefStyle, const Standard_Boolean force=true, const TopAbs_ShapeEnum context=TopAbs_SHAPE);
		%feature("autodoc", "1");
