...
class StlAPI {
	public:
		...
		StlAPI();
		%feature("autodoc", "1");
		static		void Write(const TopoDS_Shape aShape, const char * aFile, const Standard_Boolean aAsciiMode=true);
		%feature("autodoc", "1");
...
class StlAPI_Writer {
	public:
		...
		%feature("autodoc", "1");
		void Write(const TopoDS_Shape aShape, const char * aFileName, const Standard_Boolean InParallel=false);
