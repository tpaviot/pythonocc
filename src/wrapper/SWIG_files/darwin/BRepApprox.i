...
class BRepApprox_Approx {
	public:
		...
		BRepApprox_Approx();
		%feature("autodoc", "1");
		void SetParameters(const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Integer DegMin, const Standard_Integer DegMax, const Standard_Integer NbIterMax, const Standard_Boolean ApproxWithTangency=true, const Approx_ParametrizationType Parametrization=Approx_ChordLength);
		%feature("autodoc", "1");
		void SetParameters(const Standard_Real Tol3d, const Standard_Real Tol2d, const Standard_Boolean RelativeTol, const Standard_Integer DegMin, const Standard_Integer DegMax, const Standard_Integer NbIterMax, const Standard_Integer NbPntMax, const Standard_Boolean ApproxWithTangency=true, const Approx_ParametrizationType Parametrization=Approx_ChordLength);
		%feature("autodoc", "1");
...
class BRepApprox_TheComputeLineBezierOfApprox {
	public:
		...
		%feature("autodoc", "1");
		BRepApprox_TheComputeLineBezierOfApprox(const Standard_Integer degreemin=4, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Tolerance2d=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Integer NbIterations=5, const Standard_Boolean cutting=true, const Approx_ParametrizationType parametrization=Approx_ChordLength, const Standard_Boolean Squares=false);
		%feature("autodoc", "1");
...
class BRepApprox_TheComputeLineOfApprox {
	public:
		...
		%feature("autodoc", "1");
		BRepApprox_TheComputeLineOfApprox(const Standard_Integer degreemin=4, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000002081668171172168513294309377670288085938e-3, const Standard_Real Tolerance2d=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Integer NbIterations=5, const Standard_Boolean cutting=true, const Approx_ParametrizationType parametrization=Approx_ChordLength, const Standard_Boolean Squares=false);
		%feature("autodoc", "1");
