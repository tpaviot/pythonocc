...
class ShapeFix_Solid : public ShapeFix_Root {
	public:
		...
		%feature("autodoc", "1");
		Standard_Integer Status(const ShapeExtend_Status status) const;
		%feature("autodoc", "1");
...
class ShapeFix_Wireframe : public ShapeFix_Root {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean MergeSmallEdges(TopTools_MapOfShape & theSmallEdges, TopTools_DataMapOfShapeListOfShape & theEdgeToFaces, TopTools_DataMapOfShapeListOfShape & theFaceWithSmall, TopTools_MapOfShape & theMultyEdges, const Standard_Boolean theModeDrop=false, const Standard_Real theLimitAngle=-0x00000000000000001);
		%feature("autodoc", "1");
...
class ShapeFix_FixSmallFace : public ShapeFix_Root {
	public:
		...
		%feature("autodoc", "1");
		TopoDS_Shape FixStripFace(const Standard_Boolean wasdone=false);
		%feature("autodoc", "1");
...
class ShapeFix_Wire : public ShapeFix_Root {
	public:
		...
		%feature("autodoc", "1");
		Standard_Boolean FixLacking(const Standard_Boolean force=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean FixLacking(const Standard_Integer num, const Standard_Boolean force=false);
		%feature("autodoc", "1");
		Standard_Boolean FixNotchedEdges();
		%feature("autodoc", "1");
		Standard_Boolean FixGap3d(const Standard_Integer num, const Standard_Boolean convert=false);
		%feature("autodoc", "1");
		Standard_Boolean FixGap2d(const Standard_Integer num, const Standard_Boolean convert=false);
		%feature("autodoc", "1");
...
class ShapeFix_Shell : public ShapeFix_Root {
	public:
		...
		Standard_Boolean Perform(const Handle_Message_ProgressIndicator &theProgress=0);
		%feature("autodoc", "1");
		Standard_Boolean FixFaceOrientation(const TopoDS_Shell shell, const Standard_Boolean isAccountMultiConex=true, const Standard_Boolean NonManifold=false);
		%feature("autodoc", "1");
		TopoDS_Shell Shell();
		%feature("autodoc", "1");
		TopoDS_Shape Shape();
...
class ShapeFix_Face : public ShapeFix_Root {
	public:
		...
		%feature("autodoc", "1");
		void Init(const Handle_Geom_Surface &surf, const Standard_Real preci, const Standard_Boolean fwd=true);
		%feature("autodoc", "1");
		void Init(const Handle_ShapeAnalysis_Surface &surf, const Standard_Real preci, const Standard_Boolean fwd=true);
		%feature("autodoc", "1");
		virtual		void SetMsgRegistrator(const Handle_ShapeExtend_BasicMsgRegistrator &msgreg);
		%feature("autodoc", "1");
		virtual		void SetPrecision(const Standard_Real preci);
