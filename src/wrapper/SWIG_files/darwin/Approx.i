...
class Approx_FitAndDivide {
	public:
		%feature("autodoc", "1");
		Approx_FitAndDivide(const AppCont_Function &Line, const Standard_Integer degreemin=3, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Real Tolerance2d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Boolean cutting=false, const AppParCurves_Constraint FirstC=AppParCurves_TangencyPoint, const AppParCurves_Constraint LastC=AppParCurves_TangencyPoint);
		%feature("autodoc", "1");
		Approx_FitAndDivide(const Standard_Integer degreemin=3, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Real Tolerance2d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Boolean cutting=false, const AppParCurves_Constraint FirstC=AppParCurves_TangencyPoint, const AppParCurves_Constraint LastC=AppParCurves_TangencyPoint);
		%feature("autodoc", "1");
...
class Approx_FitAndDivide2d {
	public:
		%feature("autodoc", "1");
		Approx_FitAndDivide2d(const AppCont_Function2d &Line, const Standard_Integer degreemin=3, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Real Tolerance2d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Boolean cutting=false, const AppParCurves_Constraint FirstC=AppParCurves_TangencyPoint, const AppParCurves_Constraint LastC=AppParCurves_TangencyPoint);
		%feature("autodoc", "1");
		Approx_FitAndDivide2d(const Standard_Integer degreemin=3, const Standard_Integer degreemax=8, const Standard_Real Tolerance3d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Real Tolerance2d=1.00000000000000008180305391403130954586231382563710212708e-5, const Standard_Boolean cutting=false, const AppParCurves_Constraint FirstC=AppParCurves_TangencyPoint, const AppParCurves_Constraint LastC=AppParCurves_TangencyPoint);
		%feature("autodoc", "1");
...
class Approx_CurveOnSurface {
	public:
		%feature("autodoc", "1");
		Approx_CurveOnSurface(const Handle_Adaptor2d_HCurve2d &C2D, const Handle_Adaptor3d_HSurface &Surf, const Standard_Real First, const Standard_Real Last, const Standard_Real Tol, const GeomAbs_Shape Continuity, const Standard_Integer MaxDegree, const Standard_Integer MaxSegments, const Standard_Boolean Only3d=false, const Standard_Boolean Only2d=false);
		%feature("autodoc", "1");
		Standard_Boolean IsDone() const;
		%feature("autodoc", "1");
		Standard_Boolean HasResult() const;
