...
class BSplSLib {
	public:
		%feature("autodoc", "1");
		BSplSLib();
		%feature("autodoc","RationalDerivative(Standard_Integer UDeg, Standard_Integer VDeg, Standard_Integer N, Standard_Integer M, Standard_Boolean All=true) -> [Standard_Real, Standard_Real]");

		static		void RationalDerivative(const Standard_Integer UDeg, const Standard_Integer VDeg, const Standard_Integer N, const Standard_Integer M, Standard_Real &OutValue, Standard_Real &OutValue, const Standard_Boolean All=true);
		%feature("autodoc", "1");
