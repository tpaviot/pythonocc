...
typedef NCollection_TListIterator<XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors> NMTDS_ListIteratorOfListOfIndexedDataMapOfShapeAncestorsSuccessors;
...
class NMTDS_InterfPool {
	public:
		...
		%feature("autodoc", "1");
		XBOPTools_CArray1OfSSInterference & SSInterferences();
		%feature("autodoc", "1");
		XBOPTools_CArray1OfESInterference & ESInterferences();
		%feature("autodoc", "1");
		XBOPTools_CArray1OfVSInterference & VSInterferences();
		%feature("autodoc", "1");
		XBOPTools_CArray1OfEEInterference & EEInterferences();
		%feature("autodoc", "1");
		XBOPTools_CArray1OfVEInterference & VEInterferences();
		%feature("autodoc", "1");
		XBOPTools_CArray1OfVVInterference & VVInterferences();
		%feature("autodoc", "1");
		void Purge();
...
class NMTDS_ShapesDataStructure : public XBooleanOperations_ShapesDataStructure {
	public:
		...
		%feature("autodoc", "1");
		void FillMap(const TopoDS_Shape aS, XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors & aMSA, XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors & aMS) const;
		%feature("autodoc", "1");
		void FillSubshapes(const TopoDS_Shape aS, XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors & aMSA, XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors & aMS) const;
		%feature("autodoc", "1");
