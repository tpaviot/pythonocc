...
typedef NCollection_DataMap<int, XBOPTools_ListOfPaveBlock, TColStd_MapIntegerHasher> NMTTools_DataMapOfIntegerListOfPaveBlock;
...
class NMTTools_PaveFiller {
	public:
		...
		%feature("autodoc", "1");
		Standard_Integer SplitsInFace(const Standard_Integer aBid, const Standard_Integer nF1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Integer SplitsInFace(const Standard_Integer nE1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Integer SplitsOnEdge(const Standard_Integer nE1, const Standard_Integer nE2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Integer SplitsOnFace(const Standard_Integer nE1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Integer SplitsOnFace(const Standard_Integer aBid, const Standard_Integer nF1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Integer SplitsFace(const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		...
		const XBOPTools_PaveBlock & RealPaveBlock(const XBOPTools_PaveBlock &aPB, TColStd_ListOfInteger & aLB, Standard_Integer &OutValue);
		%feature("autodoc", "1");
		void RealSplitsFace(const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		Standard_Boolean HasRealSplitsInOnFace(const Standard_Integer nF1, const Standard_Integer nF2);
		%feature("autodoc", "1");
		void RealSplitsInFace(const Standard_Integer aBid, const Standard_Integer nF1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		void RealSplitsInFace(const Standard_Integer nE1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		void RealSplitsInFace(const Standard_Integer nF1, XBOPTools_ListOfPaveBlock & aLPB);
		%feature("autodoc", "1");
		void RealSplitsOnEdge(const Standard_Integer nE1, const Standard_Integer nE2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		void RealSplitsOnFace(const Standard_Integer nE1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		void RealSplitsOnFace(const Standard_Integer aBid, const Standard_Integer nF1, const Standard_Integer nF2, XBOPTools_ListOfPaveBlock & aLs);
		%feature("autodoc", "1");
		void PrepareSetForFace(const Standard_Integer nF1, const Standard_Integer nF2, const XBOPTools_ListOfPaveBlock &aLPB, XBOPTools_PaveSet & aPSF);
		%feature("autodoc", "1");
		void PutPaveOnCurve(const XBOPTools_PaveSet &aPSF, const Standard_Real aTol, XBOPTools_Curve & aBC);
		%feature("autodoc", "1");
		void PutBoundPaveOnCurve(XBOPTools_Curve & aBC, XBOPTools_SSInterference & aFF);
		%feature("autodoc", "1");
		void PutBoundPaveOnCurve(const gp_Pnt aP, const Standard_Real aT, XBOPTools_Curve & aBC, XBOPTools_SSInterference & aFF);
		%feature("autodoc", "1");
		Standard_Boolean FindPave(const gp_Pnt aP, const Standard_Real aTpV, const XBOPTools_PaveSet &aPS, XBOPTools_Pave & aPV);
		%feature("autodoc", "1");
		Standard_Integer CheckIntermediatePoint(const XBOPTools_PaveBlock &aPB, const XBOPTools_PaveBlock &aPBR, const Standard_Real aTol);
		%feature("autodoc", "1");
		Standard_Boolean IsExistingPaveBlock(const XBOPTools_PaveBlock &aPB, const XBOPTools_ListOfPaveBlock &aLPB, const Standard_Real aTol);
		%feature("autodoc", "1");
		void MakePCurves();
		%feature("autodoc", "1");
		const NMTTools_IndexedDataMapOfIndexedMapOfInteger & AloneVertices() const;
		%feature("autodoc", "1");
		Standard_Boolean IsExistingPaveBlock(const XBOPTools_PaveBlock &aPB, const TopTools_ListOfShape &aLPB, const Standard_Real aTol);
		%feature("autodoc", "1");
		Standard_Boolean CheckCoincidence(const XBOPTools_PaveBlock &aPB, const XBOPTools_ListOfPaveBlock &aLPB);
		%feature("autodoc", "1");
		Standard_Integer CheckIntermediatePoint(const XBOPTools_PaveBlock &aPB, const TopoDS_Edge aE, const Standard_Real aTol);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckCoincidence(const XBOPTools_PaveBlock &aPB1, const XBOPTools_PaveBlock &aPB2);
		%feature("autodoc", "1");
		void PutClosingPaveOnCurve(XBOPTools_Curve & aBC, XBOPTools_SSInterference & aFF);
...
class NMTTools_Tools {
	public:
		...
		%feature("autodoc", "1");
		static		void FindChains(const XBOPTools_CArray1OfVVInterference &aVVs, XBOPTColStd_IndexedDataMapOfIntegerIndexedMapOfInteger & aMCX);
		%feature("autodoc", "1");
		static		void FindChains(const XBOPTools_CArray1OfSSInterference &aVVs, XBOPTColStd_IndexedDataMapOfIntegerIndexedMapOfInteger & aMCX);
		%feature("autodoc", "1");
		static		void FindChains(const XBOPTColStd_IndexedDataMapOfIntegerIndexedMapOfInteger &aMCV, XBOPTColStd_IndexedDataMapOfIntegerIndexedMapOfInteger & aMCX);
		%feature("autodoc", "1");
		static		Standard_Boolean IsSplitInOnFace(const TopoDS_Edge aE, const TopoDS_Face aF, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
		static		Standard_Boolean AreFacesSameDomain(const TopoDS_Face aF1, const TopoDS_Face aF2, const Handle_XIntTools_Context &aCtx);
		%feature("autodoc", "1");
