...
class NIS_View : public V3d_OrthographicView {
	public:
		...
		%feature("autodoc", "1");
		void SetHilightOnTop(const Standard_Boolean theTop=true);
		%feature("autodoc", "1");
		void SetDynHilightSelected(const Standard_Boolean theHilight=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Select(const Standard_Integer theX, const Standard_Integer theY, const Standard_Boolean isForceMult=false, const Standard_Boolean theRedraw=true);
		%feature("autodoc", "1");
		void Select(const Standard_Integer theXmin, const Standard_Integer theYmin, const Standard_Integer theXmax, const Standard_Integer theYmax, const Standard_Boolean isForceMult=false, const Standard_Boolean isFullyIncluded=false, const Standard_Boolean theRedraw=true);
		%feature("autodoc", "1");
		void Select(const NCollection_List<gp_XY> &thePolygon, const Standard_Boolean isForceMult=false, const Standard_Boolean isFullyIncluded=false, const Standard_Boolean theRedraw=true);
		%feature("autodoc", "1");
...
class NIS_InteractiveContext : public Standard_Transient {
	public:
		...
		%feature("autodoc", "1");
		void Display(Handle_NIS_InteractiveObject & theObj, const Handle_NIS_Drawer &theDrawer=0, const Standard_Boolean isUpdateViews=true);
		%feature("autodoc", "1");
		void DisplayOnTop(Handle_NIS_InteractiveObject & theObj, const Handle_NIS_Drawer &theDrawer=0, const Standard_Boolean isUpdateViews=true);
		%feature("autodoc", "1");
		void Erase(const Handle_NIS_InteractiveObject &theObj, const Standard_Boolean isUpdateViews=true);
		%feature("autodoc", "1");
		void Remove(const Handle_NIS_InteractiveObject &theObj, const Standard_Boolean isUpdateViews=true);
		%feature("autodoc", "1");
		void DisplayAll();
		%feature("autodoc", "1");
		void EraseAll();
		...
		%feature("autodoc", "1");
		Standard_Boolean ProcessSelection(const Handle_NIS_InteractiveObject &O, const Standard_Boolean isMultiple=false);
		%feature("autodoc", "1");
		void ProcessSelection(const TColStd_PackedMapOfInteger &map, const Standard_Boolean isMultiple=false);
		%feature("autodoc", "1");
		Standard_Boolean SetSelected(const Handle_NIS_InteractiveObject &theObj, const Standard_Boolean isSelected=true);
		%feature("autodoc", "1");
		void SetSelected(const TColStd_PackedMapOfInteger &map, const Standard_Boolean isAdded=false);
		%feature("autodoc", "1");
...
class NIS_InteractiveObject : public Standard_Transient {
	public:
		...
		%feature("autodoc", "1");
		const Handle_NIS_Drawer & SetDrawer(const Handle_NIS_Drawer &theDrawer, const Standard_Boolean setUpdated=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		virtual		void SetSelectable(const Standard_Boolean isSel=true) const;
		%feature("autodoc", "1");
