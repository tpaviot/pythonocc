...
%include BRepBuilderAPI_required_python_modules.i
...
class BRepBuilderAPI_Sewing : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		BRepBuilderAPI_Sewing(const Standard_Real tolerance=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Boolean option1=true, const Standard_Boolean option2=true, const Standard_Boolean option3=true, const Standard_Boolean option4=false);
		%feature("autodoc", "1");
		void Init(const Standard_Real tolerance=9.99999999999999954748111825886258685613938723690807819366e-7, const Standard_Boolean option1=true, const Standard_Boolean option2=true, const Standard_Boolean option3=true, const Standard_Boolean option4=false);
		%feature("autodoc", "1");
...
class BRepBuilderAPI_BndBoxTreeSelector : public Selector {
	public:
		%feature("autodoc", "1");
...
class BRepBuilderAPI_MakePolygon : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_MakePolygon(const gp_Pnt P1, const gp_Pnt P2, const gp_Pnt P3, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakePolygon(const gp_Pnt P1, const gp_Pnt P2, const gp_Pnt P3, const gp_Pnt P4, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2, const TopoDS_Vertex V3, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakePolygon(const TopoDS_Vertex V1, const TopoDS_Vertex V2, const TopoDS_Vertex V3, const TopoDS_Vertex V4, const Standard_Boolean Close=false);
		%feature("autodoc", "1");
...
class BRepBuilderAPI_NurbsConvert : public BRepBuilderAPI_ModifyShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_NurbsConvert(const TopoDS_Shape S, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		void Perform(const TopoDS_Shape S, const Standard_Boolean Copy=false);
...
class BRepBuilderAPI_Transform : public BRepBuilderAPI_ModifyShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_Transform(const TopoDS_Shape S, const gp_Trsf T, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		void Perform(const TopoDS_Shape S, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		virtual		const TopoDS_Shape  ModifiedShape(const TopoDS_Shape S) const;
...
class BRepBuilderAPI_Copy : public BRepBuilderAPI_ModifyShape {
	public:
		...
		BRepBuilderAPI_Copy();
		%feature("autodoc", "1");
		BRepBuilderAPI_Copy(const TopoDS_Shape S, const Standard_Boolean copyGeom=true);
		%feature("autodoc", "1");
		void Perform(const TopoDS_Shape S, const Standard_Boolean copyGeom=true);
...
class BRepBuilderAPI_GTransform : public BRepBuilderAPI_ModifyShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_GTransform(const TopoDS_Shape S, const gp_GTrsf T, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		void Perform(const TopoDS_Shape S, const Standard_Boolean Copy=false);
		%feature("autodoc", "1");
		virtual		const TopTools_ListOfShape & Modified(const TopoDS_Shape S);
...
class BRepBuilderAPI_MakeFace : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const TopoDS_Wire W, const Standard_Boolean OnlyPlane=false);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const gp_Pln P, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const gp_Cylinder C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const gp_Cone C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const gp_Sphere S, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const gp_Torus C, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeFace(const Handle_Geom_Surface &S, const TopoDS_Wire W, const Standard_Boolean Inside=true);
		%feature("autodoc", "1");
...
class BRepBuilderAPI_MakeShell : public BRepBuilderAPI_MakeShape {
	public:
		...
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeShell(const Handle_Geom_Surface &S, const Standard_Boolean Segment=false);
		%feature("autodoc", "1");
		BRepBuilderAPI_MakeShell(const Handle_Geom_Surface &S, const Standard_Real UMin, const Standard_Real UMax, const Standard_Real VMin, const Standard_Real VMax, const Standard_Boolean Segment=false);
		%feature("autodoc", "1");
		void Init(const Handle_Geom_Surface &S, const Standard_Real UMin, const Standard_Real UMax, const Standard_Real VMin, const Standard_Real VMax, const Standard_Boolean Segment=false);
		%feature("autodoc", "1");
		virtual		Standard_Boolean IsDone() const;
		%feature("autodoc", "1");
