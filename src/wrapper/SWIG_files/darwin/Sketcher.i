...
class Sketcher_Profile {
	public:
		...
		Sketcher_Profile();
		%feature("autodoc", "1");
		Sketcher_Profile(const char *arg0);
		%feature("autodoc", "1");
		void SetCommand(const char *arg0);
		%feature("autodoc", "1");
		TopoDS_Shape GetShape(bool* arg0=0, double* arg1=0);
		%feature("autodoc", "1");
		TCollection_AsciiString GetDump(bool* arg0=0);
...
class Sketcher_Object : public MMgt_TShared {
	public:
		...
		void DisplayPrs();
		%feature("autodoc", "1");
		void ErasePrs(Standard_Boolean =true);
		%feature("autodoc", "1");
