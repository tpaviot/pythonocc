...
class BRepOffset_MakeOffset {
	public:
		...
		%feature("autodoc", "1");
		BRepOffset_MakeOffset(const TopoDS_Shape S, const Standard_Real Offset, const Standard_Real Tol, const BRepOffset_Mode Mode=BRepOffset_Skin, const Standard_Boolean Intersection=false, const Standard_Boolean SelfInter=false, const GeomAbs_JoinType Join=GeomAbs_Arc, const Standard_Boolean Thickening=false);
		%feature("autodoc", "1");
		void Initialize(const TopoDS_Shape S, const Standard_Real Offset, const Standard_Real Tol, const BRepOffset_Mode Mode=BRepOffset_Skin, const Standard_Boolean Intersection=false, const Standard_Boolean SelfInter=false, const GeomAbs_JoinType Join=GeomAbs_Arc, const Standard_Boolean Thickening=false);
		%feature("autodoc", "1");
		void Clear();
		%feature("autodoc", "1");
...
class BRepOffset_Tool {
	public:
		...
		%feature("autodoc", "1");
		static		void Inter3D(const TopoDS_Face F1, const TopoDS_Face F2, TopTools_ListOfShape & LInt1, TopTools_ListOfShape & LInt2, const TopAbs_State Side, const TopoDS_Edge RefEdge, const Standard_Boolean IsRefEdgeDefined=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Standard_Boolean EnLargeFace(const TopoDS_Face F, TopoDS_Face & NF, const Standard_Boolean ChangeGeom, const Standard_Boolean UpDatePCurve=false, const Standard_Boolean enlargeU=true, const Standard_Boolean enlargeVfirst=true, const Standard_Boolean enlargeVlast=true);
		%feature("autodoc", "1");
...
class BRepOffset_Offset {
	public:
		...
		BRepOffset_Offset();
		%feature("autodoc", "1");
		BRepOffset_Offset(const TopoDS_Face Face, const Standard_Real Offset, const Standard_Boolean OffsetOutside=true, const GeomAbs_JoinType JoinType=GeomAbs_Arc);
		%feature("autodoc", "1");
		BRepOffset_Offset(const TopoDS_Face Face, const Standard_Real Offset, const TopTools_DataMapOfShapeShape &Created, const Standard_Boolean OffsetOutside=true, const GeomAbs_JoinType JoinType=GeomAbs_Arc);
		%feature("autodoc", "1");
		BRepOffset_Offset(const TopoDS_Edge Path, const TopoDS_Edge Edge1, const TopoDS_Edge Edge2, const Standard_Real Offset, const Standard_Boolean Polynomial=false, const Standard_Real Tol=1.00000000000000004792173602385929598312941379845142364502e-4, const GeomAbs_Shape Conti=GeomAbs_C1);
		%feature("autodoc", "1");
		BRepOffset_Offset(const TopoDS_Edge Path, const TopoDS_Edge Edge1, const TopoDS_Edge Edge2, const Standard_Real Offset, const TopoDS_Edge FirstEdge, const TopoDS_Edge LastEdge, const Standard_Boolean Polynomial=false, const Standard_Real Tol=1.00000000000000004792173602385929598312941379845142364502e-4, const GeomAbs_Shape Conti=GeomAbs_C1);
		%feature("autodoc", "1");
		BRepOffset_Offset(const TopoDS_Vertex Vertex, const TopTools_ListOfShape &LEdge, const Standard_Real Offset, const Standard_Boolean Polynomial=false, const Standard_Real Tol=1.00000000000000004792173602385929598312941379845142364502e-4, const GeomAbs_Shape Conti=GeomAbs_C1);
		%feature("autodoc", "1");
		void Init(const TopoDS_Face Face, const Standard_Real Offset, const Standard_Boolean OffsetOutside=true, const GeomAbs_JoinType JoinType=GeomAbs_Arc);
		%feature("autodoc", "1");
		void Init(const TopoDS_Face Face, const Standard_Real Offset, const TopTools_DataMapOfShapeShape &Created, const Standard_Boolean OffsetOutside=true, const GeomAbs_JoinType JoinType=GeomAbs_Arc);
		%feature("autodoc", "1");
		void Init(const TopoDS_Edge Path, const TopoDS_Edge Edge1, const TopoDS_Edge Edge2, const Standard_Real Offset, const Standard_Boolean Polynomial=false, const Standard_Real Tol=1.00000000000000004792173602385929598312941379845142364502e-4, const GeomAbs_Shape Conti=GeomAbs_C1);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		void Init(const TopoDS_Vertex Vertex, const TopTools_ListOfShape &LEdge, const Standard_Real Offset, const Standard_Boolean Polynomial=false, const Standard_Real Tol=1.00000000000000004792173602385929598312941379845142364502e-4, const GeomAbs_Shape Conti=GeomAbs_C1);
		%feature("autodoc", "1");
