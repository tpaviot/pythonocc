...
%include TransferBRep_renames.i


%include TransferBRep_required_python_modules.i
...
class TransferBRep {
	public:
		...
		%feature("autodoc", "1");
		static		Handle_TopTools_HSequenceOfShape Shapes(const Handle_Transfer_TransientProcess &TP, const Standard_Boolean rootsonly=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		void PrintResultInfo(const Handle_Message_Printer &Printer, const Message_Msg &Header, const Handle_TransferBRep_TransferResultInfo &ResultInfo, const Standard_Boolean printEmpty=true);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		Handle_TColStd_HSequenceOfTransient Checked(const Interface_CheckIterator &chl, const Standard_Boolean alsoshapes=false);
		%feature("autodoc", "1");
