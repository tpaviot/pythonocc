...
class TDF_Attribute : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		void ForgetAllAttributes(const Standard_Boolean clearChildren=true) const;
		%feature("autodoc", "1");
...
class TDF_ClosureMode {
	public:
		%feature("autodoc", "1");
		TDF_ClosureMode(const Standard_Boolean aMode=true);
		%feature("autodoc", "1");
...
class TDF_Label {
	public:
		...
		%feature("autodoc", "1");
		TDF_Label FindChild(const Standard_Integer aTag, const Standard_Boolean create=true) const;
		%feature("autodoc", "1");
...
class TDF_IDFilter {
	public:
		%feature("autodoc", "1");
		TDF_IDFilter(const Standard_Boolean ignoreMode=true);
		%feature("autodoc", "1");
...
class TDF_Transaction {
	public:
		...
		%feature("autodoc", "1");
		Handle_TDF_Delta Commit(const Standard_Boolean withDelta=false);
		%feature("autodoc", "1");
		void Abort();
		%feature("autodoc", "1");
		Handle_TDF_Data Data() const;
...
class TDF_Tool {
	public:
		...
		%feature("autodoc", "1");
		static		void RelocateLabel(const TDF_Label &aSourceLabel, const TDF_Label &fromRoot, const TDF_Label &toRoot, TDF_Label & aTargetLabel, const Standard_Boolean create=false);
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		static		void Label(const Handle_TDF_Data &aDF, const TCollection_AsciiString &anEntry, TDF_Label & aLabel, const Standard_Boolean create=false);
		%feature("autodoc", "1");
		static		void Label(const Handle_TDF_Data &aDF, const char * anEntry, TDF_Label & aLabel, const Standard_Boolean create=false);
		%feature("autodoc", "1");
		static		void Label(const Handle_TDF_Data &aDF, const TColStd_ListOfInteger &aTagList, TDF_Label & aLabel, const Standard_Boolean create=false);
		%feature("autodoc", "1");
...
class TDF_Data : public MMgt_TShared {
	public:
		...
		%feature("autodoc", "1");
		Handle_TDF_Delta Undo(const Handle_TDF_Delta &aDelta, const Standard_Boolean withDelta=false);
		%feature("autodoc", "1");
		void Destroy();
		%feature("autodoc", "1");
...
class TDF_AttributeIterator {
	public:
		...
		%feature("autodoc", "1");
		TDF_AttributeIterator(const TDF_Label &aLabel, const Standard_Boolean withoutForgotten=true);
		%feature("autodoc", "1");
		TDF_AttributeIterator(const TDF_LabelNodePtr aLabelNode, const Standard_Boolean withoutForgotten=true);
		%feature("autodoc", "1");
		void Initialize(const TDF_Label &aLabel, const Standard_Boolean withoutForgotten=true);
		%feature("autodoc", "1");
		Standard_Boolean More() const;
		%feature("autodoc", "1");
		void Next();
...
class TDF_ChildIterator {
	public:
		...
		TDF_ChildIterator();
		%feature("autodoc", "1");
		TDF_ChildIterator(const TDF_Label &aLabel, const Standard_Boolean allLevels=false);
		%feature("autodoc", "1");
		void Initialize(const TDF_Label &aLabel, const Standard_Boolean allLevels=false);
		%feature("autodoc", "1");
		Standard_Boolean More() const;
		%feature("autodoc", "1");
		void Next();
...
class TDF_RelocationTable : public MMgt_TShared {
	public:
		%feature("autodoc", "1");
		TDF_RelocationTable(const Standard_Boolean selfRelocate=false);
		%feature("autodoc", "1");
...
class TDF_ChildIDIterator {
	public:
		...
		TDF_ChildIDIterator();
		%feature("autodoc", "1");
		TDF_ChildIDIterator(const TDF_Label &aLabel, const Standard_GUID &anID, const Standard_Boolean allLevels=false);
		%feature("autodoc", "1");
		void Initialize(const TDF_Label &aLabel, const Standard_GUID &anID, const Standard_Boolean allLevels=false);
		%feature("autodoc", "1");
		Standard_Boolean More() const;
		%feature("autodoc", "1");
		void Next();
