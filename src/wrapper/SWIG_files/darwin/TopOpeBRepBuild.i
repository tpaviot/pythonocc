...
class TopOpeBRepBuild_AreaBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_AreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		virtual		void Delete();
		%feature("autodoc", "1");
		virtual		void InitAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
...
class TopOpeBRepBuild_Builder {
	public:
		...
		virtual		void Clear();
		%feature("autodoc", "1");
		void MergeEdges(const TopTools_ListOfShape &L1, const TopAbs_State TB1, const TopTools_ListOfShape &L2, const TopAbs_State TB2, const Standard_Boolean onA=false, const Standard_Boolean onB=false, const Standard_Boolean onAB=false);
		%feature("autodoc", "1");
		void MergeFaces(const TopTools_ListOfShape &S1, const TopAbs_State TB1, const TopTools_ListOfShape &S2, const TopAbs_State TB2, const Standard_Boolean onA=false, const Standard_Boolean onB=false, const Standard_Boolean onAB=false);
		%feature("autodoc", "1");
...
class TopOpeBRepBuild_Area2dBuilder : public TopOpeBRepBuild_AreaBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_Area2dBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		virtual		void InitAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
...
class TopOpeBRepBuild_FaceAreaBuilder : public TopOpeBRepBuild_Area2dBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_FaceAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		void InitFaceAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
...
class TopOpeBRepBuild_Area3dBuilder : public TopOpeBRepBuild_AreaBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_Area3dBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		virtual		void InitAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
...
class TopOpeBRepBuild_SolidAreaBuilder : public TopOpeBRepBuild_Area3dBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_SolidAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		void InitSolidAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
...
class TopOpeBRepBuild_Area1dBuilder : public TopOpeBRepBuild_AreaBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_Area1dBuilder(TopOpeBRepBuild_PaveSet & LS, TopOpeBRepBuild_PaveClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		virtual		void InitAreaBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		virtual		void ADD_Loop_TO_LISTOFLoop(const Handle_TopOpeBRepBuild_Loop &L, TopOpeBRepBuild_ListOfLoop & LOL, const Standard_Address s=0) const;
...
class TopOpeBRepBuild_SolidBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_SolidBuilder(TopOpeBRepBuild_ShellFaceSet & FS, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
...
class TopOpeBRepBuild_ShapeSet {
	public:
		%feature("autodoc", "1");
		TopOpeBRepBuild_ShapeSet(const TopAbs_ShapeEnum SubShapeType, const Standard_Boolean checkshape=true);
		%feature("autodoc", "1");
		virtual		void Delete();
		%feature("autodoc", "1");
		...
		%feature("autodoc", "1");
		Standard_Boolean CheckShape(const TopoDS_Shape S, const Standard_Boolean checkgeom=false);
		%feature("autodoc", "1");
...
class TopOpeBRepBuild_EdgeBuilder : public TopOpeBRepBuild_Area1dBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_EdgeBuilder(TopOpeBRepBuild_PaveSet & LS, TopOpeBRepBuild_PaveClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		void InitEdgeBuilder(TopOpeBRepBuild_LoopSet & LS, TopOpeBRepBuild_LoopClassifier & LC, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
		void InitEdge();
		%feature("autodoc", "1");
...
class TopOpeBRepBuild_FaceBuilder {
	public:
		...
		%feature("autodoc", "1");
		TopOpeBRepBuild_FaceBuilder(TopOpeBRepBuild_WireEdgeSet & ES, const TopoDS_Shape F, const Standard_Boolean ForceClass=false);
		%feature("autodoc", "1");
