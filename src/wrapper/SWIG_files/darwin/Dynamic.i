...
%include Dynamic_required_python_modules.i
...
class Dynamic_MethodDefinition : public Dynamic_Method {
	public:
		%feature("autodoc", "1");
		void AddVariable(const Handle_Dynamic_Parameter &aparameter, const Dynamic_ModeEnum amode, const Standard_Boolean agroup=false);
		%feature("autodoc", "1");
		%feature("autodoc", "1");
		%extend{
			std::string DumpToString() {
