...
#
TOOLKITS = {'TKernel': ['Dico', 'FSD', 'MMgt', 'Message', 'NCollection', 'OSD',
                        'Plugin', 'Quantity', 'Resource', 'SortTools',
...
COMMON_MODULES = [
           ...
           ('Poly', [], ['Poly_CoherentTriPtr', 'Poly_CoherentTriangulation',
                         'Poly_MakeLoops']),  # 650PATCH removed PolyMake_Loops
           ('GC', [], []),
           ('GProp', [], []),
           ...
           ('CDM', [], ['CDM_Document']),
           ('CGM', ['Standard', 'Quantity', 'TCollection',
                    'OSD', 'MFT', 'Aspect'], ['CGM_Driver']),
           ('CDF', ['TCollection', 'Storage'], []),
           ('TDocStd', ['Storage'], []),
           ('AppStd', ['TCollection', 'CDM', 'CDF',
                       'TDF', 'Storage', 'PCDM'], []),
           ('AppStdL', ['TCollection', 'CDM', 'CDF',
                        'TDF', 'Storage', 'PCDM'], []),
           ('MeshAlgo', ['MeshDS_BaseAllocator'],
            ['MeshAlgo_Edge', 'MeshAlgo_Vertex', 'MeshAlgo_Triangle',
             'MeshAlgo_CircleInspector', 'MeshAlgo_CellFilter']),
           ('MeshDS', [], []),
           ('MeshShape', [], ['MeshShape_Edge', 'MeshShape_Vertex',
                              'MeshShape_Triangle']),
           ('FEmTool', [], []),
           ('Intf', [], []),
           ('IntRes2d', [], []),
           ...
           ('IntPatch', [], ['IntPatch_Polyhedron', 'IntPatch_TheIWalking',
                             'IntPatch_RLine'],),
           ('IntPolyh', [], ['IntPolyh_MaillageAffinage',
                             'IntPolyh_Triangle']),
           ('IntPoly', [], []),
           ('IntAna', [], []),
           ('IntAna2d', [], []),
           ...
           ('Geom2dConvert', [], []),
           ('Geom2dGcc', ['gp'], ['Geom2dGcc_FuncTCuCuCuOfMyC2d3Tan'],
            {'Geom2dGcc_Lin2dTanObl': ['IsParallel2']}),
           ('Geom2dHatch', ['Contap', 'math', 'Intf'], [],
           ...
           ('GeomConvert', [], []),
           ('GeomFill', ['gp', 'Geom2dHatch', 'AppParCurves'],
            ['GeomFill_NSections', 'GeomFill_SweepSectionGenerator',
             'GeomFill_FunctionGuide']),
           ('GeomInt', ['gp', 'Adaptor3d'],
            ['GeomInt_WLApprox', 'GeomInt_IntSS',
           ...
           ('GeomLib', [], []),
           ('GeomLProp', [], []),
           ('AdvApp2Var', ['gp'], ['AdvApp2Var_Iso', 'AdvApp2Var_SysBase',
            'AdvApp2Var_ApproxF2var', 'AdvApp2Var_MathBase']),
           ('AdvApprox', [], []),
           ('Geom', ['BRepFill', 'gp'], []),
           ('GeomPlate', [], []),
           ('GeomProjLib', [], []),
           ...
           ('BRepAdaptor', ['math'], []),
           ('BRepPrimAPI', [], []),
           ('BRepMesh', [], ['BRepMesh_DiscretFactory',
            'BRepMesh_CircleInspector', 'BRepMesh_VertexInspector'],
           ...
           ('BRepFill', ['Geom', 'AdvApp2Var', 'Convert', 'Approx',
                         'Adaptor3d', 'Handle_math'], []),
           ('BRepGProp', ['GProp_PrincipalProps'], ['BRepGProp_VinertGK']),
           ('BRepAlgo', ['NCollection'], [],
           ...
           ('Draft', ['TopTools'], []),
           ('BRepOffsetAPI', ['TopTools', 'BRepTools',
                              'AppParCurves', 'NCollection', 'Adaptor3d',
                              'Convert', 'Handle_math'],
           ...
           ('MgtTopoDS', ['Standard'], []),
           ('MgtBRep', ['Standard'], []),
           ('TopOpeBRepDS', [], ['TopOpeBRepDS_DSS', 'TopOpeBRepDS_Dumper',
                                 'TopOpeBRepDS_HDataStructure']),
           ('TopOpeBRep', ['TopoDS', 'Geom2d'],
            ['TopOpeBRep_GeomTools', 'TopOpeBRep_LineInter'],
           ...
           ('TopOpeBRepTool', [], ['TopOpeBRepTool_STATE',
                                   'TopOpeBRepTool_mkTondgE']),
           ('math', ['Handle_TCollection'], ['math_NewtonFunctionSetRoot',
                                             'math_NewtonMinimum']),
           ...
           ('OSD', ['Quantity_Date'], ['OSD_Semaphore', 'OSD_MailBox',
                                       'OSD_Process'],
            {'OSD_Path': ['LocateExecFile'], 'OSD': ['ControlBreak']}),
           ('Font', [], []),
           ('Message', [], []),
           ('ShapeAlgo', ['TopoDS'], ['ShapeAlgo']),
           ('ShapeBuild', ['TopoDS', 'TopTools', 'TCollection',
                           'Geom', 'Message', 'Handle_Message_Algorithm'], []),
           ('ShapeConstruct', ['Geom', 'TCollection', 'Message',
                               'Handle_Message_Algorithm', 'NCollection'], []),
           ('ShapeCustom', ['Handle_TCollection', 'TopoDS', 'TopTools'], [],
            {'ShapeCustom': ['BSplineRestriction',
                             'ConvertToRevolution', 'SweptToElementary',
                             'ConvertToBSpline']}),
           ('ShapeExtend', ['BRepFill', 'gp', 'TopoDS'], []),
           ('ShapeFix', ['TopoDS_Solid', 'Geom', 'TCollection', 'Message',
                         'Handle_Message_Algorithm'],
            ['ShapeFix_WireSegment'],
            {'ShapeFix_Face': ['FixPeriodicDegeneratedMode']}),
           ('ShapeProcess', ['Geom', 'TCollection', 'Message',
                             'Handle_Message_Algorithm'], []),
           ('ShapeProcessAPI', ['Geom', 'TCollection', 'Message',
                                'Handle_Message_Algorithm'], []),
           ('ShapeUpgrade', ['Geom', 'TCollection', 'Message',
                             'Handle_Message_Algorithm'], []),
           ('ShapeAnalysis', ['Geom', 'TCollection', 'Message',
                              'Handle_Message_Algorithm'],
            ['Selector', 'ShapeAnalysis_BoxBndTreeSelector']),
           ...
           ('BinTObjDrivers', ['Standard', 'TCollection',
                               'Storage', 'PCDM'], []),
           ('BinTools', [], [], {'BinTools_Curve2dSet': ['Dump']}),
           ('BinXCAFDrivers', ['Standard', 'TCollection',
                               'Storage', 'PCDM'], []),
           ...
           ('Storage', [], ['Storage_BucketIterator',
                            'Storage_BucketOfPersistent', 'Storage_Bucket']),
           ('PCDM', [], ['PCDM_StorageDriver', 'PCDM_DOMHeaderParser'],
            {'PCDM': ['StorageDriver']}),
           ('PCDMShape', [], []),
           ...
           ('PMMgt', [], []),
           ('ObjMgt', [], []),
           ('NCollection', [], ['NCollection_UtfString<unsigned int>',
            'NCollection_UtfString<unsigned short>',
            'NCollection_UtfString<char>',
            'NCollection_UtfString<wchar_t>',
           ...
           ('PShort', [], []),
           ('Sweep', [], []),
           ('ProjLib', [], [], {'ProjLib_ProjectOnSurface': ['Load'],
            'ProjLib_ProjectedCurve': ['Load']}),
           ('Resource', [], []),
           ('Select3D', [], [],
            {'Select3D_SensitiveTriangulation': ['DetectedTriangle']}),
           ('SortTools', [], []),
           ('StdDrivers', ['Standard', 'TCollection',
                           'PCDM', 'MDF', 'Storage'], []),
           ('StdFail', [], []),
           ('StdLDrivers', ['Standard', 'TCollection',
                            'PCDM', 'MDF', 'Storage'], []),
           ...
           ('LocOpe', ['TopOpeBRepDS', 'TopOpeBRepTool'],
            ['LocOpe_Revol', 'LocOpe_RevolutionForm']),
           ('IGESToBRep', ['MoniTool', 'TCollection', 'Handle_Interface'],
            ['IGESToBRep_AlgoContainer'],
            {'IGESToBRep_TopoSurface': ['TransferPlaneSurface']}),
           ('IGESControl', ['MoniTool', 'TCollection',
                            'Handle_Interface'], []),
           ('IGESData', ['MoniTool', 'TCollection'], ['IGESData_Protocol'],
            {'IGESData_IGESReaderData': ['DirValues']}),
           ('IGESBasic', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'Interface_GraphContent'], ['IGESBasic_Protocol']),
           ('IGESDefs', ['MoniTool', 'TCollection', 'Handle_Interface',
                         'Interface_GraphContent'], ['IGESDefs_Protocol']),
           ('IGESAppli', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'Interface_GraphContent'], ['IGESAppli_Protocol']),
           ('IGESDimen', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'Interface_GraphContent'], ['IGESDimen_Protocol']),
           ('IGESGeom', ['MoniTool', 'TCollection', 'Handle_Interface',
                         'Interface_GraphContent'], ['IGESGeom_Protocol']),
           ('IGESGraph', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'Interface_GraphContent'], ['IGESGraph_Protocol']),
           ('IGESSelect', ['MoniTool', 'TCollection', 'Handle_Interface',
                           'Interface_GraphContent'],
            ['IGESSelect_Protocol'],
            {'IGESSelect_SelectBasicGeom': ['CurvesOnly']}),
           ('IGESSolid', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent'], ['IGESSolid_Protocol']),
           ('IGESCAFControl', ['MoniTool', 'TCollection', 'Handle_Interface',
                               'Interface_GraphContent'], []),
           ('IGESConvGeom', [], []),
           ('IGESFile', [], []),
           ('STEPControl', ['MoniTool', 'TCollection',
                            'Handle_Interface'], []),
           ('StepData', ['MoniTool', 'TCollection'], ['StepData_Protocol'],
           ...
           ('StepDimTol', ['MoniTool', 'TCollection', 'Handle_Interface',
                           'StepBasic'], []),
           ('STEPEdit', ['MoniTool', 'TCollection', 'Handle_Interface'], []),
           ('StepFEA', ['MoniTool', 'TCollection', 'Handle_Interface',
                        'Interface_SequenceOfCheck'],
            ['StepFEA_SymmetricTensor43d']),
           ('StepFile', ['MoniTool', 'TCollection', 'Handle_Interface'], []),
           ('STEPSelections', ['MoniTool', 'TCollection', 'Handle_Interface',
                               'Interface_SequenceOfCheck'], [],
           ...
           ('StepToTopoDS', ['MoniTool', 'TCollection', 'Handle_Interface'],
            ['StepToTopoDS_Builder']),
           ('StepElement', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_SequenceOfCheck'], []),
           ('STEPCAFControl', ['MoniTool', 'TCollection', 'Handle_Interface',
                               'Transfer', 'XSControl', 'Interface_Data',
                               'Interface_Map',
                               'Interface_Indexed'], []),
           ('StepRepr', ['MoniTool', 'TCollection', 'Handle_Interface',
                         'Interface_SequenceOfCheck'], []),
           ('StepShape', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'StepBasic'], []),
           ('StepGeom', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'StepBasic'], []),
           ('StepAP203', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'StepBasic'], []),
           ('StepVisual', ['MoniTool', 'TCollection', 'Handle_Interface',
                           'StepBasic'], []),
           ('StepAP214', ['MoniTool', 'TCollection', 'Handle_Interface',
                          'StepBasic', 'StepGeom', 'StepRepr'],
            ['StepAP214_Protocol']),
           ('RWHeaderSection', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepAP203', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepAP214', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepBasic', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepDimTol', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepElement', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepFEA', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepGeom', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepRepr', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepShape', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('RWStepVisual', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_GraphContent', 'StepBasic'], []),
           ('APIHeaderSection', ['MoniTool', 'TCollection',
                                 'Handle_Interface'], []),
           ('TransferBRep', ['MoniTool', 'TCollection', 'Handle_Interface',
            'Interface_SequenceOfCheck'],
           ...
           ('XCAFDrivers', ['Standard', 'PCDM', 'Storage',
                            'MDF', 'TCollection'], [])]
#####################################
...
WIN_MODULES = [
           ...
           ('Prs3d', ['TopoDS', 'Graphic3d', 'Bnd_Box', 'Aspect',
                      'Handle_TCollection', 'Image', 'OSD', 'Font'], []),
           ('PrsMgr', ['Graphic3d', 'gp', 'Aspect', 'Handle_TCollection',
                       'Image', 'OSD', 'Font'], []),
           ('SelectMgr', ['TCollection', 'Prs3d', 'Graphic3d', 'Aspect',
                          'Quantity', 'Image', 'OSD', 'Font'], []),
           ('StdSelect', ['TCollection', 'Prs3d', 'Graphic3d', 'Aspect',
                          'Quantity', 'SelectBasics', 'Image',
                          'OSD', 'Font'], [],
            {'StdSelect_Shape': ['Shape'], 'StdSelect_BRepOwner': ['Set']}),
           ('DsgPrs', ['Handle_Image'], [], {'DsgPrs_RadiusPresentation': ['Add']}),
           ('AIS', ['Graphic3d', 'TopoDS_Vertex', 'Aspect', 'SelectBasics',
                    'PrsMgr', 'Image', 'Font'], [],
            {"AIS_LocalContext": ["Reactivate"]}),
           ('NIS', ['Graphic3d', 'TCollection', 'Quantity', 'Viewer',
                    'TColStd', 'Aspect', 'Image', 'Visual3d', 'OSD', 'Font'],
            ['NIS_Triangulated'], {'NIS_InteractiveObject': ['SetAttribute'],
                                   'NIS_InteractiveContext': ['GetDrawers']}),
           ('Voxel', ['Quantity', 'gp', 'Graphic3d', 'Aspect',
                      'Handle_TCollection', 'Prs3d', 'PrsMgr', 'SelectMgr',
                      'SelectBasics', 'Image', 'OSD', 'Font', 'StdSelect'],
                     []),
           ('Visual3d', [], [], {'Visual3d_View': ['GetGraduatedTrihedron']}),
           ('TPrsStd', ['Aspect', 'Image', 'OSD', 'Font'], []),
           ('XCAFPrs', ['SelectMgr', 'TDF', 'Graphic3d', 'Aspect', 'Prs3d',
                        'PrsMgr', 'SelectBasics', 'Quantity', 'Image', 'OSD',
                        'Font', 'StdSelect'], []),
...
UNIX_MODULES = [
           ...
           ('Graphic3d', ['OSD', 'MFT', 'gp'], [],
            {'Graphic3d_Group': ['SetGroupPrimitivesAspect'],
             'Graphic3d_GraphicDriver': ['GetGraduatedTrihedron'],
             'Graphic3d_AspectText3d': ['Values']}),
           ('Prs3d', ['OSD', 'Font', 'MFT', 'Xw', 'Graphic3d', 'Bnd_Box',
                      'Aspect', 'Handle_TCollection', 'Image',
                      'TopoDS_Edge', 'TopoDS_Vertex', 'TopoDS_Face'], []),
           ('PrsMgr', ['OSD', 'Font', 'MFT', 'Xw', 'Graphic3d', 'gp',
                       'Aspect', 'Handle_TCollection', 'Image'], []),
           ('SelectMgr', ['OSD', 'Font', 'MFT', 'Xw', 'TCollection',
                          'Graphic3d', 'Aspect', 'Quantity', 'Image',
                          'Prs3d'], [],
            {'SelectMgr_SelectionManager': ['Status'],
             'SelectMgr_ViewerSelector': ['Status']}),
           ('StdSelect', ['OSD', 'Font', 'MFT', 'Xw', 'TCollection',
                          'Graphic3d', 'Aspect', 'Quantity', 'Image',
                          'Prs3d', 'SelectBasics', 'Image', 'OSD'], [],
            {'StdSelect_Shape': ['Shape'], 'StdSelect_BRepOwner': ['Set']}),
           ('DsgPrs', ['Image'], [], {'DsgPrs_RadiusPresentation': ['Add']}),
           ('AIS', ['OSD', 'Font', 'MFT', 'Xw', 'Graphic3d', 'TopoDS_Vertex',
                    'Aspect', 'SelectBasics', 'PrsMgr', 'Image',
                    'Select2D'], [],
            {"AIS_LocalContext": ["Reactivate"],
             'AIS_InteractiveContext': ['Status']}),
           ('Voxel', ['OSD', 'Font', 'MFT', 'Xw', 'Quantity', 'gp',
                      'Graphic3d', 'Aspect', 'Handle_TCollection', 'Prs3d',
                      'PrsMgr', 'SelectMgr', 'SelectBasics', 'Image',
                      'StdSelect', 'Handle_StdSelect'], []),
           ('Visual3d', ['OSD', 'MFT', 'Xw', 'Image'], [],
            {'Visual3d_View': ['GetGraduatedTrihedron']}),
           ('TPrsStd', ['OSD', 'Font', 'MFT', 'Xw', 'Aspect', 'Image'], []),
           ('XCAFPrs', ['Aspect', 'MFT', 'TDF', 'OSD', 'Font', 'Graphic3d',
                        'SelectBasics', 'SelectMgr', 'Xw', 'Quantity',
                        'Prs3d', 'PrsMgr', 'Image', 'StdSelect',
                        'Handle_StdSelect'], []),
           ('NIS', ['Aspect', 'TColStd', 'TCollection', 'Quantity', 'Viewer',
                    'Graphic3d', 'OSD', 'Font', 'Xw', 'Visual3d',
                    'Image', 'MFT'], ['NIS_Triangulated'],
            {'NIS_InteractiveContext': ['GetDrawers']}),
           ('MeshVS', ['OSD', 'Font', 'MFT', 'Xw', 'Graphic3d', 'Aspect',
                       'Prs3d', 'Quantity', 'PrsMgr', 'Image',
                       'StdSelect', 'Handle_StdSelect'], []),
           ('Image', [], []),
           ('AlienImage', ['Quantity', 'TCollection', 'Aspect'], [])]
...
SALOME_SMESH_MODULES = [('SMDSAbs', [], []),
          ('SMDS', [], ['SMDS_PolyhedralVolumeOfNodes',
            ...
            {'SMDS_Mesh': ['AddVolumeWithID', 'AddVolume', 'AddFaceWithID',
                           ...
                           'AddPolygonalFaceWithID', 'AddPolyhedralVolume',
                           'AddPolyhedralVolumeWithID', 'RemoveElement',
                           'FindFace', 'ChangeElementNodes', 'boundaryFaces',
                           'boundaryEdges'],
           ...
           ('SMESHDS', [], [], {'SMESHDS_Command': ['AddPolygonalFace',
                                                    'ChangePolyhedronNodes',
                                                    'AddPolyhedralVolume'],
                                'SMESHDS_Script': ['AddPolygonalFace',
                                                   'AddPolyhedralVolume',
                                                   'ChangePolyhedronNodes'],
                                'SMESHDS_Mesh': ['AddPolygonalFaceWithID',
                                                 'AddPolygonalFace',
           ...
           ('SMESH', ['SMDS', 'SelectBasics', 'Select3D',
                      'TColStd',
            ...
            {'SMESH_Algo': ['SMESH_Algo', 'GetNodeParamOnEdge',
                            'GetSortedNodesOnEdge'],
             'SMESH_Block': ['GetFaceEdgesIDs',
                             'GetEdgeVertexIDs'],
             'SMESH_Mesh': ['GetGroupSubMeshesContaining',
                            'GetGroupIds', 'GetHypotheses'],
             'SMESH_Pattern': ['Apply', 'GetMappedPoints',
                               'GetPoints'],
    ...
    SALOME_SMESH_MODULES.append(('StdMeshers', ['SMDS'],
                                ['StdMeshers_ProjectionUtils'],
                                 {'StdMeshers_Hexa_3D': ['OppositeVertex'],
                                  'StdMeshers_MEFISTO_2D': ['LoadPoints']}))
    SALOME_GEOM_MODULES.append(('Sketcher', ['TColStd', 'Visual3d',
                                             'Graphic3d', 'OSD', 'Aspect',
                                             'Font', 'Handle_TCollection',
                                             'Viewer'], ['Sketcher_GUI']),
                               )
...
def PythonOCCStats():
    """
    This function takes all *.hxx headers and returns a
    list of available packages:
    ['gp', 'Standard', 'Geom', etc.]. OpenCascade 6.3.0 is composed of
    416 such packages.
    """
