...
############################################# 
           ...
           ('BOPDS',[],[]),
           ('BOPTools',[],[],{'BOPTools_AlgoTools2D':['MakeCurveOnSurface']}),
           ('BOPTColStd',[],[]),
           ('Extrema',['Adaptor2d'],[]),
##################################
######## Approx ####################
...
#########################
           ...
           ('Draft',['TopTools'],[]),
           ('BRepOffsetAPI',['TopTools','BRepTools','AppParCurves','NCollection','Adaptor3d','Adaptor2d','Convert','math'],['BRepOffsetAPI_FindContigousEdges']),
...
#############################
            ...
            ('Viewer',[],[]),
            ('V3d',['Handle_TCollection','Aspect','Quantity','Graphic3d','MFT','OSD','Image'],[],
...
###########################
            ...
            ('PMMgt',[],[]),
            ('ObjMgt',[],[]),
            ('NCollection',[],['NCollection_ListNode','NCollection_UtfString<unsigned_short>']),
            ('PColStd',[],[]),
            ('PColgp',[],[]),
            ('PCollection',[],[]),
            ('PColPGeom2d',[],[]),
            ...
            ('StdPrs',['Image'],[],{'StdPrs_DeflectionCurve':['Match']}),
...
WIN_MODULES = [
             ...
             ('DsgPrs',['Handle_Image'],[],{'DsgPrs_RadiusPresentation':['Add']}),
             ('AIS',['Graphic3d','TopoDS_Vertex','Aspect','SelectBasics','PrsMgr','Image'],[],{"AIS_LocalContext":["Reactivate"]}),
             ...
             ('Voxel',['Quantity','gp','Graphic3d','Aspect',\
                      'Handle_TCollection','Prs3d','PrsMgr','SelectMgr','SelectBasics','Image','OSD','StdSelect'],[]),
             ('Visual3d',[],[],{'Visual3d_View':['GetGraduatedTrihedron']}),
             ('TPrsStd',['Aspect','Image','OSD','Font'],[]),
             ('XCAFPrs',['SelectMgr','TDF','Graphic3d','Aspect','Prs3d','PrsMgr','SelectBasics','Quantity','Image','OSD',  'StdSelect'],[]),
             ('Image',[],[],{'Image_PixMap':['SizePixelBytes']}),
             ('MeshVS',['Aspect','Graphic3d','PrsMgr','Prs3d','Image','OSD','StdSelect'],[]),
             ]
...
UNIX_MODULES = [
                    ...
                    ('Prs3d',['OSD','MFT','Font','Graphic3d','Bnd_Box','Aspect','Handle_TCollection','Image',
                              'TopoDS_Edge','TopoDS_Vertex','TopoDS_Face'],[]),#OCC650PATCH:Aded Image
                    ('PrsMgr',['OSD','MFT','Font','Graphic3d','gp','Aspect','Handle_TCollection','Image'],[]),#OCC650PATCH Added Image
                    ('SelectMgr',['OSD','MFT','Font','TCollection','Graphic3d','Aspect','Quantity','Image','Prs3d'],[],
                     {'SelectMgr_SelectionManager':['Status'],'SelectMgr_ViewerSelector':['Status']}),
                    ('StdSelect',['OSD','MFT','Font','TCollection','Graphic3d','Aspect','Quantity','Image','Prs3d','SelectBasics','Image','OSD'],[],
                     {'StdSelect_Shape':['Shape'],'StdSelect_BRepOwner':['Set']}),
                    ('DsgPrs',['Image'],[],{'DsgPrs_RadiusPresentation':['Add']}),
                    ('AIS',['OSD','MFT','Font','Graphic3d','TopoDS_Vertex','Aspect','SelectBasics','PrsMgr','Image'],[],
                     {"AIS_LocalContext":["Reactivate"],
                      'AIS_InteractiveContext':['Status']}), 
                    ('Voxel',['OSD','MFT','Font','Quantity','gp','Graphic3d','Aspect',\
                              'Handle_TCollection','Prs3d','PrsMgr','SelectMgr','SelectBasics','Image','StdSelect','Handle_StdSelect'],[]),#OCC650PAtH Added Image
                    ('Visual3d',['OSD','MFT','Font','Image'],[],{'Visual3d_View':['GetGraduatedTrihedron']}),
                    ('TPrsStd',['OSD','MFT','Font','Aspect','Image'],[]),
                    ('XCAFPrs',['Aspect','MFT','Font','TDF','OSD','Graphic3d',\
                                'SelectBasics','SelectMgr','Quantity','Prs3d','PrsMgr','Image',\
                                'StdSelect','Handle_StdSelect'],[]),
                    ('NIS',['Aspect','Font','TColStd','TCollection','Quantity','Viewer','Graphic3d','OSD',
...
if sys.platform!='win32':
    ...
    SALOME_GEOM_MODULES.append(('Sketcher',['TColStd','Visual3d','Graphic3d','OSD','Xw','MFT','Aspect','Handle_TCollection','Viewer'],[]),
                       )
else:
    ...
    SALOME_GEOM_MODULES.append(('Sketcher',['TColStd','Visual3d','Graphic3d','OSD','Aspect','Handle_TCollection','Viewer'],['Sketcher_GUI']),
                       )
