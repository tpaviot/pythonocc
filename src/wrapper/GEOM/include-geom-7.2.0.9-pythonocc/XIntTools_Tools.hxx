...
#ifndef _XIntTools_Tools_HeaderFile
#define _XIntTools_Tools_HeaderFile
...
//! otherwise returns False <br>
  Standard_EXPORT   static  Standard_Boolean IsVertex(const XIntTools_CommonPrt& aCmnPrt) ;
...
//! otherwise returns zero. <br>
  Standard_EXPORT   static  Standard_Integer SplitCurve(const XIntTools_Curve& aC,XIntTools_SequenceOfCurves& aS) ;
  
//! Puts curves from aSIn to aSOut except those curves that <br>
//! are coincide with first curve from aSIn. <br>
  Standard_EXPORT   static  void RejectLines(const XIntTools_SequenceOfCurves& aSIn,XIntTools_SequenceOfCurves& aSOut) ;
