...
#define _XBOPTColStd_IndexedDataMapOfIntegerInteger_HeaderFile
...
class XBOPTColStd_IndexedDataMapNodeOfIndexedDataMapOfIntegerInteger;



class XBOPTColStd_IndexedDataMapOfIntegerInteger  : public TCollection_BasicMap {
public:
  ...
  Standard_EXPORT   XBOPTColStd_IndexedDataMapOfIntegerInteger(const Standard_Integer NbBuckets = 1);
  
  Standard_EXPORT     XBOPTColStd_IndexedDataMapOfIntegerInteger& Assign(const XBOPTColStd_IndexedDataMapOfIntegerInteger& Other) ;
    XBOPTColStd_IndexedDataMapOfIntegerInteger& operator =(const XBOPTColStd_IndexedDataMapOfIntegerInteger& Other) 
{
  return Assign(Other);
}
...
~XBOPTColStd_IndexedDataMapOfIntegerInteger()
{
  Clear();
}
...
private:
  ...
  Standard_EXPORT   XBOPTColStd_IndexedDataMapOfIntegerInteger(const XBOPTColStd_IndexedDataMapOfIntegerInteger& Other);
