...
#ifndef _XBOP_WireEdgeClassifier_HeaderFile
#define _XBOP_WireEdgeClassifier_HeaderFile
...
#endif
#ifndef _XBOP_CompositeClassifier_HeaderFile
#include <XBOP_CompositeClassifier.hxx>
#endif
...
class XBOP_WireEdgeClassifier  : public XBOP_CompositeClassifier {
public:
...
//! Used to compare edges and wires on the edge <F>. <br>
  Standard_EXPORT   XBOP_WireEdgeClassifier(const TopoDS_Face& F,const XBOP_BlockBuilder& BB);
  
//! Classify loop <L1> with  <L2> <br>
  Standard_EXPORT   virtual  TopAbs_State Compare(const Handle(XBOP_Loop)& L1,const Handle(XBOP_Loop)& L2) ;
  
//! Internal usage <br>
  Standard_EXPORT     TopoDS_Shape LoopToShape(const Handle(XBOP_Loop)& L) ;
