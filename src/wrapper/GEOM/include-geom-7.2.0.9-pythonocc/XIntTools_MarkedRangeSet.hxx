...
#define _XIntTools_MarkedRangeSet_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_MarkedRangeSet();
  
//! build set of ranges which consists of one range with <br>
//! boundary values theFirstBoundary and theLastBoundary <br>
  Standard_EXPORT   XIntTools_MarkedRangeSet(const Standard_Real theFirstBoundary,const Standard_Real theLastBoundary,const Standard_Integer theInitFlag);
  
//! Build set of ranges based on the array of progressive sorted values <br>
  Standard_EXPORT   XIntTools_MarkedRangeSet(const XIntTools_CArray1OfReal& theSortedArray,const Standard_Integer theInitFlag);
...
//! Build set of ranges based on the array of progressive sorted values <br>
  Standard_EXPORT     void SetRanges(const XIntTools_CArray1OfReal& theSortedArray,const Standard_Integer theInitFlag) ;
...
//! Returns True if the range is inside the initial boundaries, <br>
//! otherwise or in case of some error returns False <br>
  Standard_EXPORT     Standard_Boolean InsertRange(const XIntTools_Range& theRange,const Standard_Integer theFlag) ;
...
//! Returns True if the range is inside the initial boundaries, <br>
//! otherwise or in case of some error returns False <br>
  Standard_EXPORT     Standard_Boolean InsertRange(const XIntTools_Range& theRange,const Standard_Integer theFlag,const Standard_Integer theIndex) ;
...
//! the Index can be from 1 to Length() <br>
  Standard_EXPORT     XIntTools_Range Range(const Standard_Integer theIndex) const;
...
#include <XIntTools_MarkedRangeSet.lxx>
