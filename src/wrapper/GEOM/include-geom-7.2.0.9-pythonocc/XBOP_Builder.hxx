...
#define _XBOP_Builder_HeaderFile
...
Standard_EXPORT virtual ~XBOP_Builder(){Destroy();}
...
//! <br>
  ...
  Standard_EXPORT     Handle_XBOP_HistoryCollector GetHistoryCollector() const;
...
Handle_XBOP_HistoryCollector myHistory;
