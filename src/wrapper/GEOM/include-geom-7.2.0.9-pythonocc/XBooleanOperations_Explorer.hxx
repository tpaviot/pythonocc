...
#define _XBooleanOperations_Explorer_HeaderFile
...
public:
  ...
  Standard_EXPORT   XBooleanOperations_Explorer(const XBooleanOperations_ShapesDataStructure& SDS);
  
  Standard_EXPORT   virtual  void Delete() ;
Standard_EXPORT virtual ~XBooleanOperations_Explorer()  {Delete();}
...
XBooleanOperations_PShapesDataStructure myShapesDataStructure;
