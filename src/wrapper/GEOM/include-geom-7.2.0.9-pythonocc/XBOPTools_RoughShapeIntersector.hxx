...
#ifndef _XBOPTools_RoughShapeIntersector_HeaderFile
#define _XBOPTools_RoughShapeIntersector_HeaderFile
...
class XBOPTools_RoughShapeIntersector  {
public:
...
//! Initializes algorithm by shapes data structure <br>
  Standard_EXPORT   XBOPTools_RoughShapeIntersector(const XBooleanOperations_PShapesDataStructure& PDS);
...
//! subshapes of Tool of myPDS. <br>
  Standard_EXPORT    const Handle_XBOPTools_HArray2OfIntersectionStatus& TableOfStatus() const;
...
private:
  ...
  Standard_EXPORT     void PropagateForSuccessors1(const Standard_Integer AncestorsIndex1,const Standard_Integer AncestorsIndex2,const XBOPTools_IntersectionStatus theStatus) ;
  
  Standard_EXPORT     void PropagateForSuccessors2(const Standard_Integer AncestorsIndex1,const Standard_Integer AncestorsIndex2,const XBOPTools_IntersectionStatus theStatus) ;
