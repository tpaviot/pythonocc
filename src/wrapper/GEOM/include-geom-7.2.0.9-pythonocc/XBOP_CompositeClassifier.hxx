...
#define _XBOP_CompositeClassifier_HeaderFile
...
#include <XBOP_LoopClassifier.hxx>
#endif
...
//! <br>
class XBOP_CompositeClassifier  : public XBOP_LoopClassifier {
public:
...
//! Initializing the object with BlockBuilder; <br>
  Standard_EXPORT   XBOP_CompositeClassifier(const XBOP_BlockBuilder& BB);
