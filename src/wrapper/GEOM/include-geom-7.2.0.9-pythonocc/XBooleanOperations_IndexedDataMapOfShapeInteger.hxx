...
#define _XBooleanOperations_IndexedDataMapOfShapeInteger_HeaderFile
...
#endif
#ifndef _Handle_XBooleanOperations_IndexedDataMapNodeOfIndexedDataMapOfShapeInteger_HeaderFile
...
class XBooleanOperations_IndexedDataMapNodeOfIndexedDataMapOfShapeInteger;



class XBooleanOperations_IndexedDataMapOfShapeInteger  : public TCollection_BasicMap {
public:
  ...
  Standard_EXPORT   XBooleanOperations_IndexedDataMapOfShapeInteger(const Standard_Integer NbBuckets = 1);
  
  Standard_EXPORT     XBooleanOperations_IndexedDataMapOfShapeInteger& Assign(const XBooleanOperations_IndexedDataMapOfShapeInteger& Other) ;
    XBooleanOperations_IndexedDataMapOfShapeInteger& operator =(const XBooleanOperations_IndexedDataMapOfShapeInteger& Other) 
{
  return Assign(Other);
}
...
~XBooleanOperations_IndexedDataMapOfShapeInteger()
{
  Clear();
}
...
private:
  ...
  Standard_EXPORT   XBooleanOperations_IndexedDataMapOfShapeInteger(const XBooleanOperations_IndexedDataMapOfShapeInteger& Other);
