...
#ifndef _XBOP_ArgumentAnalyzer_HeaderFile
#define _XBOP_ArgumentAnalyzer_HeaderFile
...
public:
  ...
  Standard_EXPORT   XBOP_ArgumentAnalyzer();
  ...
  //! returns ref <br>
  Standard_EXPORT     XBOP_Operation& OperationType() ;
  //! returns ref <br>
...
//!          checking of problem of merging edges. <br>
  ...
  Standard_EXPORT    const XBOP_ListOfCheckResult& GetCheckResult() const;
...
XBOP_ListOfCheckResult myResult;


};


#include <XBOP_ArgumentAnalyzer.lxx>
