...
#ifndef _XBOP_SDFWESFiller_HeaderFile
#define _XBOP_SDFWESFiller_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XBOP_SDFWESFiller();
  
//! Constructor <br>
//! nF1, nF2 - indices of faces in the DataStructue (DS) <br>
  Standard_EXPORT   XBOP_SDFWESFiller(const Standard_Integer nF1,const Standard_Integer nF2,const XBOPTools_DSFiller& aDSF);
...
//! Modifier <br>
  Standard_EXPORT     void SetDSFiller(const XBOPTools_DSFiller& aDSF) ;
  
//! Modifier <br>
  Standard_EXPORT     void SetOperation(const XBOP_Operation anOp) ;
...
//! Performs the algorithm <br>
  Standard_EXPORT     void Do(const XBOP_WireEdgeSet& aWES) ;
  
//! Selector <br>
  Standard_EXPORT    const XBOPTools_DSFiller& DSFiller() const;
...
//! Selector <br>
  Standard_EXPORT     XBOP_Operation Operation() const;
...
//! Internal Purpose <br>
  Standard_EXPORT     void PrepareOnParts(const Standard_Integer nF1,const Standard_Integer nF2,const XBOP_Operation Op) ;
