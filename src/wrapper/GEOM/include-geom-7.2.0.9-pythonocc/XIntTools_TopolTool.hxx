...
#ifndef _XIntTools_TopolTool_HeaderFile
#define _XIntTools_TopolTool_HeaderFile
...
#endif
#ifndef _Handle_XIntTools_TopolTool_HeaderFile
#include <Handle_XIntTools_TopolTool.hxx>
#endif
...
class XIntTools_TopolTool : public Adaptor3d_TopolTool {

public:

  
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_TopolTool();
  
//! Initializes me by surface <br>
  Standard_EXPORT   XIntTools_TopolTool(const Handle(Adaptor3d_HSurface)& theSurface);
...
//! theNUmin, theNVmin are minimal nb points for U and V. <br>
  ...
  DEFINE_STANDARD_RTTI(XIntTools_TopolTool)
