...
#define _XBOPTools_CoupleOfInteger_HeaderFile
...
//! Empty Constructor <br>
  Standard_EXPORT   XBOPTools_CoupleOfInteger();
  
//! Constructor <br>
  Standard_EXPORT   XBOPTools_CoupleOfInteger(const Standard_Integer aFirst,const Standard_Integer aSecond);
...
//! Selector <br>
  ...
  Standard_EXPORT     Standard_Boolean IsEqual(const XBOPTools_CoupleOfInteger& aOther) const;
