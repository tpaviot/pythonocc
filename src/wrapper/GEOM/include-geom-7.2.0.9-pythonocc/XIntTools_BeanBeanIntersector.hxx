...
#ifndef _XIntTools_BeanBeanIntersector_HeaderFile
#define _XIntTools_BeanBeanIntersector_HeaderFile
...
public:
  ...
  Standard_EXPORT   XIntTools_BeanBeanIntersector();
  
//! Initializes the algorithm <br>
  Standard_EXPORT   XIntTools_BeanBeanIntersector(const TopoDS_Edge& theEdge1,const TopoDS_Edge& theEdge2);
  
//! Initializes the algorithm <br>
  Standard_EXPORT   XIntTools_BeanBeanIntersector(const BRepAdaptor_Curve& theCurve1,const BRepAdaptor_Curve& theCurve2,const Standard_Real theBeanTolerance1,const Standard_Real theBeanTolerance2);
  
//! Initializes the algorithm <br>
  Standard_EXPORT   XIntTools_BeanBeanIntersector(const BRepAdaptor_Curve& theCurve1,const BRepAdaptor_Curve& theCurve2,const Standard_Real theFirstParOnCurve1,const Standard_Real theLastParOnCurve1,const Standard_Real theFirstParOnCurve2,const Standard_Real theLastParOnCurve2,const Standard_Real theBeanTolerance1,const Standard_Real theBeanTolerance2);
...
private:
  ...
  Standard_EXPORT     void ComputeUsingExtrema(const XIntTools_Range& theRange2) ;
  
  Standard_EXPORT     void ComputeNearRangeBoundaries(const XIntTools_Range& theRange2) ;
  
  Standard_EXPORT     void ComputeRangeFromStartPoint(const Standard_Boolean ToIncreaseParameter,const Standard_Real theParameter,const Standard_Integer theIndex,const Standard_Real theParameter2,const XIntTools_Range& theRange2) ;
...
#include <XIntTools_BeanBeanIntersector.lxx>
