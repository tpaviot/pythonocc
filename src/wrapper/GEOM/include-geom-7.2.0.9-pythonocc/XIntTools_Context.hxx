...
#ifndef _XIntTools_Context_HeaderFile
#define _XIntTools_Context_HeaderFile
...
//!  instance. <br>
class XIntTools_Context : public MMgt_TShared {

public:

  
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_Context();
Standard_EXPORT virtual ~XIntTools_Context();
  
//! Returns a reference to point classifier <br>
//! for given face <br>
  Standard_EXPORT     XIntTools_FClass2d& FClass2d(const TopoDS_Face& aF) ;
...
//! for given face <br>
  Standard_EXPORT     XIntTools_SurfaceRangeLocalizeData& SurfaceData(const TopoDS_Face& aF) ;
...
//! parameters aT1 and aT2 <br>
  Standard_EXPORT     Standard_Boolean IsValidBlockForFace(const Standard_Real aT1,const Standard_Real aT2,const XIntTools_Curve& aIC,const TopoDS_Face& aF,const Standard_Real aTol) ;
  
//! Returns true if IsValidBlockForFace returns true <br>
//! for both faces aF1 and aF2 <br>
  Standard_EXPORT     Standard_Boolean IsValidBlockForFaces(const Standard_Real aT1,const Standard_Real aT2,const XIntTools_Curve& aIC,const TopoDS_Face& aF1,const TopoDS_Face& aF2,const Standard_Real aTol) ;
...
//! <br>
  Standard_EXPORT     Standard_Boolean IsVertexOnLine(const TopoDS_Vertex& aV,const XIntTools_Curve& aIC,const Standard_Real aTolC,Standard_Real& aT) ;
...
//! returns false (in this case aT isn't significant) <br>
//! <br>
  Standard_EXPORT     Standard_Boolean IsVertexOnLine(const TopoDS_Vertex& aV,const Standard_Real aTolV,const XIntTools_Curve& aIC,const Standard_Real aTolC,Standard_Real& aT) ;
...
//! other wiese returns true. <br>
  ...
  DEFINE_STANDARD_RTTI(XIntTools_Context)
...
XIntTools_IndexedDataMapOfTransientAddress myProjPTMap;
