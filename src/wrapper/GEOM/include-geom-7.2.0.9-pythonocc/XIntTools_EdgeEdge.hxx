...
#ifndef _XIntTools_EdgeEdge_HeaderFile
#define _XIntTools_EdgeEdge_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_EdgeEdge();
...
//! i.e.  |f(t2)-f(t1)|<anEpsNull will mean that f(t2)=f(t1) <br>
  ...
  Standard_EXPORT     void SetRange1(const XIntTools_Range& aRange) ;
  
  Standard_EXPORT     void SetRange2(const XIntTools_Range& aRange) ;
...
//! Returns the common parts (Output) <br>
  ...
  Standard_EXPORT    const XIntTools_Range& Range1() const;
  
  Standard_EXPORT    const XIntTools_Range& Range2() const;
...
//! to  the  given  range on the curve Curve-From. <br>
  Standard_EXPORT     Standard_Integer FindRangeOnCurve2(XIntTools_CommonPrt& aCP) ;
...
//! Curve-From. <br>
  ...
  Standard_EXPORT     Standard_Integer TreatVertexType(const Standard_Real am1,const Standard_Real am2,XIntTools_CommonPrt& aCP) ;
...
//! the DistanceFunction D(t). <br>
  ...
  Standard_EXPORT     Standard_Boolean CheckTouch(const XIntTools_CommonPrt& aCP,Standard_Real& t1,Standard_Real& t2) ;
  
  Standard_EXPORT     Standard_Boolean CheckTouchVertex(const XIntTools_CommonPrt& aCP,Standard_Real& t1,Standard_Real& t2) const;
...
XIntTools_Range myRange1;
XIntTools_Range myRange2;
