...
#define _XIntTools_CommonPrt_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_CommonPrt();
  
//! Copy  constructor <br>
  Standard_EXPORT   XIntTools_CommonPrt(const XIntTools_CommonPrt& aCPrt);
  
  Standard_EXPORT     XIntTools_CommonPrt& Assign(const XIntTools_CommonPrt& Other) ;
    XIntTools_CommonPrt& operator =(const XIntTools_CommonPrt& Other) 
{
  return Assign(Other);
}
...
//! Sets the range of first edge. <br>
  Standard_EXPORT     void SetRange1(const XIntTools_Range& aR) ;
  
//! Sets the range of first edge. <br>
  Standard_EXPORT     void SetRange1(const Standard_Real tf,const Standard_Real tl) ;
  
//! Appends the range of second edge. <br>
  Standard_EXPORT     void AppendRange2(const XIntTools_Range& aR) ;
...
//! Returns the  ranges of second edge. <br>
  Standard_EXPORT    const XIntTools_SequenceOfRanges& Ranges2() const;
  
//! Returns the  ranges of second edge. <br>
  Standard_EXPORT     XIntTools_SequenceOfRanges& ChangeRanges2() ;
...
//! Copies me to anOther <br>
  Standard_EXPORT     void Copy(XIntTools_CommonPrt& anOther) const;
...
XIntTools_SequenceOfRanges myRanges2;
