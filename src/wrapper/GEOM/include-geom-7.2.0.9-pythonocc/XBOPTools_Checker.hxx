...
#ifndef _XBOPTools_Checker_HeaderFile
#define _XBOPTools_Checker_HeaderFile
...
class XBOPTools_Checker  : public XBOPTools_PaveFiller {
public:
...
//! Empty Contructor <br>
  Standard_EXPORT   XBOPTools_Checker();
  
//! Contructs the object using the shape <aS> to check <br>
  Standard_EXPORT   XBOPTools_Checker(const TopoDS_Shape& aS);
  
//! Contructs the object using the <InterferencePool> <br>
  Standard_EXPORT   XBOPTools_Checker(const XBOPTools_InterferencePool& aIP);
  
//! Destructor <br>
  Standard_EXPORT   virtual  void Destroy() ;
Standard_EXPORT virtual ~XBOPTools_Checker(){Destroy();}
...
//! Selector <br>
  ...
  Standard_EXPORT    const XBOPTools_ListOfCheckResults& GetCheckResult() const;
...
XBOPTools_ListOfCheckResults myCheckResults;
