...
#define _XBOPTColStd_CArray1OfInteger_HeaderFile
...
class XBOPTColStd_CArray1OfInteger  {
public:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfInteger(const Standard_Integer Length = 0,const Standard_Integer BlockLength = 5);
  
  Standard_EXPORT     void Resize(const Standard_Integer theNewLength) ;
  
  Standard_EXPORT     void Destroy() ;
~XBOPTColStd_CArray1OfInteger()
{
  Destroy();
}
...
private:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfInteger(const XBOPTColStd_CArray1OfInteger& AnArray);
  
  Standard_EXPORT     XBOPTColStd_CArray1OfInteger& Assign(const XBOPTColStd_CArray1OfInteger& Other) ;
    XBOPTColStd_CArray1OfInteger& operator =(const XBOPTColStd_CArray1OfInteger& Other) 
{
  return Assign(Other);
}
