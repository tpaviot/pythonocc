...
#ifndef _XBOPTColStd_CArray1OfPnt2d_HeaderFile
#define _XBOPTColStd_CArray1OfPnt2d_HeaderFile
...
class XBOPTColStd_CArray1OfPnt2d  {
public:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfPnt2d(const Standard_Integer Length = 0,const Standard_Integer BlockLength = 5);
  
  Standard_EXPORT     void Resize(const Standard_Integer theNewLength) ;
  
  Standard_EXPORT     void Destroy() ;
~XBOPTColStd_CArray1OfPnt2d()
{
  Destroy();
}
...
private:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfPnt2d(const XBOPTColStd_CArray1OfPnt2d& AnArray);
  
  Standard_EXPORT     XBOPTColStd_CArray1OfPnt2d& Assign(const XBOPTColStd_CArray1OfPnt2d& Other) ;
    XBOPTColStd_CArray1OfPnt2d& operator =(const XBOPTColStd_CArray1OfPnt2d& Other) 
{
  return Assign(Other);
}
