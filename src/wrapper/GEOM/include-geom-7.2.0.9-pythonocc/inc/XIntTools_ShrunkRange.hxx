...
#define _XIntTools_ShrunkRange_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_ShrunkRange();
  
  Standard_EXPORT   XIntTools_ShrunkRange(const TopoDS_Edge& aE,const TopoDS_Vertex& aV1,const TopoDS_Vertex& aV2,const XIntTools_Range& aR,const Handle(XIntTools_Context)& ICtx);
...
//! Sets an shrunk range <br>
  Standard_EXPORT     void SetShrunkRange(const XIntTools_Range& aR) ;
  
//! Returns shrunk range <br>
  Standard_EXPORT    const XIntTools_Range& ShrunkRange() const;
