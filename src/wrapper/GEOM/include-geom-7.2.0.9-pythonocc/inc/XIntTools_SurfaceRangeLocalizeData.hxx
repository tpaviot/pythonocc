...
#ifndef _XIntTools_SurfaceRangeLocalizeData_HeaderFile
#define _XIntTools_SurfaceRangeLocalizeData_HeaderFile
...
public:
  ...
  Standard_EXPORT   XIntTools_SurfaceRangeLocalizeData();
  
  Standard_EXPORT   XIntTools_SurfaceRangeLocalizeData(const Standard_Integer theNbSampleU,const Standard_Integer theNbSampleV,const Standard_Real theMinRangeU,const Standard_Real theMinRangeV);
  
  Standard_EXPORT   XIntTools_SurfaceRangeLocalizeData(const XIntTools_SurfaceRangeLocalizeData& Other);
  
  Standard_EXPORT     XIntTools_SurfaceRangeLocalizeData& Assign(const XIntTools_SurfaceRangeLocalizeData& Other) ;
    XIntTools_SurfaceRangeLocalizeData& operator =(const XIntTools_SurfaceRangeLocalizeData& Other) 
{
  return Assign(Other);
}
  ...
  Standard_EXPORT     void AddOutRange(const XIntTools_SurfaceRangeSample& theRange) ;
  
  Standard_EXPORT     void AddBox(const XIntTools_SurfaceRangeSample& theRange,const Bnd_Box& theBox) ;
  
  Standard_EXPORT     Standard_Boolean FindBox(const XIntTools_SurfaceRangeSample& theRange,Bnd_Box& theBox) const;
  
  Standard_EXPORT     Standard_Boolean IsRangeOut(const XIntTools_SurfaceRangeSample& theRange) const;
  
  Standard_EXPORT     void ListRangeOut(XIntTools_ListOfSurfaceRangeSample& theList) const;
...
XIntTools_MapOfSurfaceSample myMapRangeOut;
XIntTools_DataMapOfSurfaceSampleBox myMapBox;
...
#include <XIntTools_SurfaceRangeLocalizeData.lxx>
