...
#define _XIntTools_ListIteratorOfListOfBox_HeaderFile
...
public:
  ...
  Standard_EXPORT   XIntTools_ListIteratorOfListOfBox();
  
  Standard_EXPORT   XIntTools_ListIteratorOfListOfBox(const XIntTools_ListOfBox& L);
  
  Standard_EXPORT     void Initialize(const XIntTools_ListOfBox& L) ;
