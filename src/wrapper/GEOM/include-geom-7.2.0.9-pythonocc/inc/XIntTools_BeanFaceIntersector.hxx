...
#ifndef _XIntTools_BeanFaceIntersector_HeaderFile
#define _XIntTools_BeanFaceIntersector_HeaderFile
...
#endif
#ifndef _XIntTools_MarkedRangeSet_HeaderFile
#include <XIntTools_MarkedRangeSet.hxx>
#endif
...
//! Sets the intersecton context <br>
  Standard_EXPORT     void SetContext(const Handle(XIntTools_Context)& theContext) ;
...
//! Launches the algorithm <br>
  ...
  Standard_EXPORT    const XIntTools_SequenceOfRanges& Result() const;
  
  Standard_EXPORT     void Result(XIntTools_SequenceOfRanges& theResults) const;
...
private:
  ...
  Standard_EXPORT     Standard_Boolean LocalizeSolutions(const XIntTools_CurveRangeSample& theCurveRange,const Bnd_Box& theBoxCurve,const XIntTools_SurfaceRangeSample& theSurfaceRange,const Bnd_Box& theBoxSurface,XIntTools_CurveRangeLocalizeData& theCurveData,XIntTools_SurfaceRangeLocalizeData& theSurfaceData,XIntTools_ListOfCurveRangeSample& theListCurveRange,XIntTools_ListOfSurfaceRangeSample& theListSurfaceRange) ;
...
XIntTools_MarkedRangeSet myRangeManager;
Standard_Real myDeflection;
Handle_XIntTools_Context myContext;
XIntTools_SequenceOfRanges myResults;
...
#include <XIntTools_BeanFaceIntersector.lxx>
