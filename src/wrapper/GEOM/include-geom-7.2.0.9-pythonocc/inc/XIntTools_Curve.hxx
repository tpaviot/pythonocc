...
#define _XIntTools_Curve_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XIntTools_Curve();
  
//! Initializes me by a 3d curve <br>
//! and two 2d curves <br>
  Standard_EXPORT   XIntTools_Curve(const Handle(Geom_Curve)& Curve3d,const Handle(Geom2d_Curve)& FirstCurve2d,const Handle(Geom2d_Curve)& SecondCurve2d);
