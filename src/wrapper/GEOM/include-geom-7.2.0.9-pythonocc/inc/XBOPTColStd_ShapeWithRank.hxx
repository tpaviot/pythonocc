...
#define _XBOPTColStd_ShapeWithRank_HeaderFile
...
//! <br>
  Standard_EXPORT   XBOPTColStd_ShapeWithRank();
...
//! <br>
  Standard_EXPORT     Standard_Boolean IsEqual(const XBOPTColStd_ShapeWithRank& Other) const;
