...
#define _XBooleanOperations_AncestorsAndSuccessors_HeaderFile
...
//!          its vertices. <br>
class XBooleanOperations_AncestorsAndSuccessors  {
public:
  ...
  Standard_EXPORT   XBooleanOperations_AncestorsAndSuccessors();
  //! allocates space and fills it with the data of AncSuccessors. <br>
  Standard_EXPORT   XBooleanOperations_AncestorsAndSuccessors(const XBooleanOperations_AncestorsSeqAndSuccessorsSeq& AncSuccessors,const Standard_Integer shift);
  
  Standard_EXPORT     void Destroy() ;
~XBooleanOperations_AncestorsAndSuccessors()
{
  Destroy();
}
...
#include <XBooleanOperations_AncestorsAndSuccessors.lxx>
