...
#define _XBOP_CheckResult_HeaderFile
...
public:
  ...
  Standard_EXPORT   XBOP_CheckResult();
  ...
  Standard_EXPORT     void SetCheckStatus(const XBOP_CheckStatus TheStatus) ;
  //! gets status of faulty <br>
  Standard_EXPORT     XBOP_CheckStatus GetCheckStatus() const;
