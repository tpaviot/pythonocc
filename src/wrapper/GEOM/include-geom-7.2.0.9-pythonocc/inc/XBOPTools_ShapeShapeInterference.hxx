...
#define _XBOPTools_ShapeShapeInterference_HeaderFile
...
//! Empty constructor <br>
  Standard_EXPORT   XBOPTools_ShapeShapeInterference();
  
//! Constructor <br>
  Standard_EXPORT   XBOPTools_ShapeShapeInterference(const Standard_Integer anIndex1,const Standard_Integer anIndex2);
