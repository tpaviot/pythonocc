...
#define _XBOPTools_CheckResult_HeaderFile
...
#include <XBOPTools_CheckStatus.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   XBOPTools_CheckResult();
  ...
  Standard_EXPORT     void SetCheckStatus(const XBOPTools_CheckStatus TheStatus) ;
  //! gets faulty status for shapes <br>
  Standard_EXPORT     XBOPTools_CheckStatus GetCheckStatus() const;
...
XBOPTools_CheckStatus myStatus;
