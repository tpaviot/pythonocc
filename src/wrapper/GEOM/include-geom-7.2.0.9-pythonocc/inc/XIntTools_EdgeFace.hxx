...
#ifndef _XIntTools_EdgeFace_HeaderFile
#define _XIntTools_EdgeFace_HeaderFile
...
#endif
#ifndef _XIntTools_FClass2d_HeaderFile
#include <XIntTools_FClass2d.hxx>
#endif
#ifndef _XIntTools_CArray1OfReal_HeaderFile
#include <XIntTools_CArray1OfReal.hxx>
#endif
...
//! Empty Constructor <br>
  Standard_EXPORT   XIntTools_EdgeFace();
...
//! The algorithm processes edge inside these boundaries. <br>
  Standard_EXPORT     void SetRange(const XIntTools_Range& aRange) ;
...
//! Returns results <br>
  Standard_EXPORT    const XIntTools_SequenceOfCommonPrts& CommonParts() const;
...
private:
  ...
  Standard_EXPORT     void AddDerivativePoints(const XIntTools_CArray1OfReal& t,const XIntTools_CArray1OfReal& f) ;
  ...
  Standard_EXPORT     Standard_Integer MakeType(XIntTools_CommonPrt& aCP) ;
  
  Standard_EXPORT     void IsIntersection(const Standard_Real ta,const Standard_Real tb) ;
  
  Standard_EXPORT     void FindDerivativeRoot(const XIntTools_CArray1OfReal& t,const XIntTools_CArray1OfReal& f) ;
  
  Standard_EXPORT     void RemoveIdenticalRoots() ;
  
  Standard_EXPORT     Standard_Boolean CheckTouch(const XIntTools_CommonPrt& aCP,Standard_Real& aTX) ;
  
  Standard_EXPORT     Standard_Boolean CheckTouchVertex(const XIntTools_CommonPrt& aCP,Standard_Real& aTX) ;
...
XIntTools_SequenceOfRanges myProjectableRanges;
XIntTools_FClass2d myFClass2d;
XIntTools_CArray1OfReal myFuncArray;
XIntTools_CArray1OfReal myArgsArray;
XIntTools_SequenceOfRoots mySequenceOfRoots;
XIntTools_SequenceOfCommonPrts mySeqOfCommonPrts;
