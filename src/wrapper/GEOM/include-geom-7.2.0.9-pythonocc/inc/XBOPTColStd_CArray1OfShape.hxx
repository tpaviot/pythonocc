...
#ifndef _XBOPTColStd_CArray1OfShape_HeaderFile
#define _XBOPTColStd_CArray1OfShape_HeaderFile
...
class XBOPTColStd_CArray1OfShape  {
public:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfShape(const Standard_Integer Length = 0,const Standard_Integer BlockLength = 5);
  
  Standard_EXPORT     void Resize(const Standard_Integer theNewLength) ;
  
  Standard_EXPORT     void Destroy() ;
~XBOPTColStd_CArray1OfShape()
{
  Destroy();
}
...
private:
  ...
  Standard_EXPORT   XBOPTColStd_CArray1OfShape(const XBOPTColStd_CArray1OfShape& AnArray);
  
  Standard_EXPORT     XBOPTColStd_CArray1OfShape& Assign(const XBOPTColStd_CArray1OfShape& Other) ;
    XBOPTColStd_CArray1OfShape& operator =(const XBOPTColStd_CArray1OfShape& Other) 
{
  return Assign(Other);
}
