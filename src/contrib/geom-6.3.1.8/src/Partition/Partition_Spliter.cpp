...
//  Module : GEOM
//  $Header: /home/server/cvs/GEOM/GEOM_SRC/src/PARTITION/Partition_Spliter.cxx,v 1.8 2006/06/01 11:32:39 jfa Exp $
...
void Partition_Spliter::Clear()
{
  ...
  //fix to compile with gcc version 4.1.2
  //myInter3d = Partition_Inter3d(myAsDes);
  Partition_Inter3d	aInter3d(myAsDes);
  myInter3d = aInter3d;
