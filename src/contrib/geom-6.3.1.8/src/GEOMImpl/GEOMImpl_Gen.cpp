...
//=============================================================================
/*!
 * GetISketcherOperations
 */
//=============================================================================
GEOMImpl_ISketcherOperations* GEOMImpl_Gen::GetISketcherOperations(int theDocID)
{
  if(_mapOfSketcherOperations.find(theDocID) == _mapOfSketcherOperations.end()) {
    _mapOfSketcherOperations[theDocID] = new GEOMImpl_ISketcherOperations(GEOM_Engine::GetEngine(), theDocID);
  }
  return _mapOfSketcherOperations[theDocID];
}
