                                             ...
                                             bool theHexMesh)
{
  ...
  if (theHexMesh) {
    ...
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << ", " << aListRes.ToCString() << "] = MakePipeTShape("
   ...
   */
    ...
    //Make a Python command
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << "] = MakePipeTShape(" << theR1 << ", " << theW1 << ", "
      << theL1 << ", " << theR2 << ", " << theW2 << ", " << theL2 << ", " << (int)theHexMesh << ")";
  }
                                                         ...
                                                         Handle(GEOM_Object) theP3)
{
  ...
  if (theHexMesh) {
    ...
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << ", " << aListRes.ToCString() << "] = MakePipeTShape("
      << theR1 << ", " << theW1 << ", " << theL1 << ", " << theR2 << ", " << theW2 << ", " << theL2 << ", "
      << (int)theHexMesh << ", " << theP1 << ", " << theP2 << ", " << theP3 << ")";
  }
  //
  // Get the groups: END
  //
    ...
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << "] = MakePipeTShape(" << theR1 << ", " << theW1 << ", "
      << theL1 << ", " << theR2 << ", " << theW2 << ", " << theL2 << ", " << (int)theHexMesh << ", " << theP1
      << ", " << theP2 << ", " << theP3 << ")";
  }
                                                    ...
                                                    bool theHexMesh)
{
  ...
  if (theHexMesh) {
    ...
    //  //Make a Python command
    //  GEOM::TPythonDump(aFunction)
    //    << "[" << aShape << "] = MakePipeTShapeChamfer(" << theR1 << ", " << theW1
    ...
    GEOM::TPythonDump(aFunction)
      ...
      << "] = MakePipeTShapeChamfer(" << theR1 << ", " << theW1 << ", " << theL1 << ", " << theR2
      << ", " << theW2 << ", " << theL2 << ", " << theH << ", " << theW << ", " << (int)theHexMesh << ")";
    //}
  }
  //
  //     Get the groups: END
                                                   ...
                                                   double theRF, bool theHexMesh)
{
  ...
  if (theHexMesh) {
    ...
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << ", " << aListRes.ToCString()
      << "] = MakePipeTShapeFillet(" << theR1 << ", " << theW1 << ", " << theL1 << ", " << theR2
      << ", " << theW2 << ", " << theL2 << ", " << theRF << ", " << (int)theHexMesh << ")";
  }
  /*
   * Get the groups: END
   */
    ...
    //Make a Python command
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << "] = MakePipeTShapeFillet(" << theR1 << ", " << theW1
                                                               ...
                                                               Handle(GEOM_Object) theP3)
{
  ...
  if (theHexMesh) {
    ...
    GEOM::TPythonDump(aFunction)
      << "[" << aShape << ", " << aListRes.ToCString()
      << "] = MakePipeTShapeFillet(" << theR1 << ", " << theW1 << ", " << theL1 << ", " << theR2
      << ", " << theW2 << ", " << theL2 << ", " << theRF << ", " << (int)theHexMesh << ", " << theP1 << ", "
      << theP2 << ", " << theP3 << ")";
  }
  /*
   * Get the groups: END
