                     ...
                     const PointLocation theLocation)
{
  ...
  switch( theLocation )
    ...
    case PointOn_SurfaceByParam:
      ...
      SETPARAM(aPI.SetParameter, theParam1);
      SETPARAM(aPI.SetParameter2, theParam2);
      break;
                                  ...
                                  (const Handle(GEOM_Object)& theShape)
{
  ...
  //Make a Python command
  GEOM::TPythonDump(aFunction) << aMarker << " = MakeMarkerFromShape(" << theShape << ")";
                                               ...
                                               const Handle(GEOM_Object)& theYVec)
{
  ...
  //Make a Python command
  GEOM::TPythonDump(aFunction) << aMarker << " = MakeMarkerPntTwoVec("
