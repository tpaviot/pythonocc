...
class GEOMImpl_Block6Explorer
{
 public:
  ...
  //! Constructor.
  SALOME_WNT_EXPORT GEOMImpl_Block6Explorer ();
  ...
  SALOME_WNT_EXPORT void InitByBlock (const TopoDS_Shape& theBlock);
  ...
  SALOME_WNT_EXPORT void InitByBlockAndFace (const TopoDS_Shape& theBlock,
  ...
  SALOME_WNT_EXPORT void InitByBlockAndEdges (const TopoDS_Shape& theBlock,
  ...
  SALOME_WNT_EXPORT void InitByBlockAndVertices (const TopoDS_Shape& theBlock,
  ...
  SALOME_WNT_EXPORT void InitByTwoFaces (const TopoDS_Shape& theFace1,
                                         const TopoDS_Shape& theFace2);

  //! Access to vertices
  SALOME_WNT_EXPORT TopoDS_Shape GetVertex (const Standard_Integer theVertexID); // [1-8]

  //! Access to vertices
  SALOME_WNT_EXPORT Standard_Integer GetVertexID (const TopoDS_Shape& theVertex);

  //! Access to vertices
  SALOME_WNT_EXPORT Standard_Integer GetVertexID (const Standard_Integer theFaceID, // [1-6]
                                                const Standard_Integer theVertexNB); // [1-4]

  //! Access to vertices
  SALOME_WNT_EXPORT Standard_Integer GetVertexOnEdgeID (const Standard_Integer theEdgeID, // [1-12]
                                                        const Standard_Integer theVertexNB); // [1-2]

  //! Access to edges
  SALOME_WNT_EXPORT TopoDS_Shape GetEdge (const Standard_Integer theEdgeID, // [1-12]
                                          const Standard_Boolean doMake = Standard_False);

  //! Access to edges
  SALOME_WNT_EXPORT Standard_Integer GetEdgeID (const TopoDS_Shape& theEdge);

  //! Access to edges
  SALOME_WNT_EXPORT Standard_Integer GetEdgeID (const Standard_Integer theFaceID, // [1-6]
                                                const Standard_Integer theEdgeNB); // [1-4]

  //! Access to edges
  SALOME_WNT_EXPORT Standard_Integer FindEdgeID (const Standard_Integer theVertex1ID,
                                                 const Standard_Integer theVertex2ID);

  //! Access to edges
  SALOME_WNT_EXPORT Standard_Integer FindCommonEdgeID (const Standard_Integer theFace1ID,
                                                       const Standard_Integer theFace2ID);

  //! Access to faces
  SALOME_WNT_EXPORT TopoDS_Shape GetFace (const Standard_Integer theFaceID, // [1-6]
                                          const Standard_Boolean doMake = Standard_False);

  //! Access to faces
  SALOME_WNT_EXPORT Standard_Integer GetFaceID (const TopoDS_Shape& theFace);

  //! Access to faces
  SALOME_WNT_EXPORT Standard_Integer FindFaceID (const Standard_Integer theEdge1ID,
                                                 const Standard_Integer theEdge2ID);

  //! Access to faces
  SALOME_WNT_EXPORT Standard_Integer GetOppositeFaceID (const Standard_Integer theFaceID);

  //! Check Block
  //! returns true, if theFace1, transformed
  //! by theTransformation, coincides with theFace2
  SALOME_WNT_EXPORT Standard_Boolean IsSimilarFaces (const Standard_Integer theFace1ID,
                                                     const Standard_Integer theFace2ID,
 ...
 public:
  ...
  SALOME_WNT_EXPORT static void MapShapesAndAncestors (const TopoDS_Shape& S,
                                                       const TopAbs_ShapeEnum TS,
                                                       const TopAbs_ShapeEnum TA,
                                                       TopTools_IndexedDataMapOfShapeListOfShape& M);

  SALOME_WNT_EXPORT static Standard_Boolean IsSimilarEdges (const TopoDS_Shape& E1,
                                                            const TopoDS_Shape& E2);
  //! returns number of found edges
  SALOME_WNT_EXPORT static Standard_Integer FindEdge (TopoDS_Shape&       theResult,
  ...
  SALOME_WNT_EXPORT static Standard_Integer FindFace (TopoDS_Shape&       theResult,
                                                      const TopoDS_Shape& V1,
                                                      const TopoDS_Shape& V2,
  ...
  SALOME_WNT_EXPORT static void MakeFace (const TopoDS_Wire&     theWire,
