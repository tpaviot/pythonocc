...
//!Rotation of the parametric space of the sphere in order
...
//!Sets the tolerance for recognition of geometry
Standard_EXPORT   void SetTolerance(const Standard_Real Toler) ;

/**	Returns Standard_True if the face <F> has  been modified. In this case, <S>
*	is the new geometric support of the face, <L> the new location,  <Tol>
*   the new tolerance.  Otherwise, returns Standard_False, and <S>, <L>, <Tol> are  not significant.*/
