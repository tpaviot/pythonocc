...
class TestTopologyLocalOperations(unittest.TestCase):
    def test_extrusion(self):
        ...
        Pln = Pl.GetObject()
        #
        # Get the normal of this plane. This will be the
    ...
    def test_offset_cube(self):
        ...
        offsetB = BRepOffsetAPI_MakeOffsetShape(S2, -20, 0.01,
    ...
    def test_glue_solids_edges(self):
        ...
        ex3 = TopExp_Explorer(S3, TopAbs_FACE)
        ex4 = TopExp_Explorer(S4, TopAbs_FACE)
        for a in range(5):
            ex3.Next()
        for b in range(4):
            ex4.Next()
    ...
    def test_brep_feat_rib(self):
        ...
        aform = BRepFeat_MakeLinearForm(S.Shape(), W.Wire(),
                                        aplane.GetHandle(),
                                        gp_Vec(0., 10., 0.),
                                        gp_Vec(0., 0., 0.),
                                        1, True
