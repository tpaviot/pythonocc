...
class TestTopologyOperations(unittest.TestCase):
    def test_fuse(self):
        ...
        fuse_result = BRepAlgoAPI_Fuse(box1, box2).Shape()
        self.assertFalse(fuse_result.IsNull())
    ...
    def test_slicer(self):
        ...
        # Note: the shape can also come from a shape selected
    ...
    def test_variable_filleting(self):
        ...
        # Create Cylinder
        Cylinder = BRepPrimAPI_MakeCylinder(gp_Ax2(gp_Pnt(-300, 0, 0),
                                                   gp_Dir(0, 0, 1)), 100, 200).Shape()
