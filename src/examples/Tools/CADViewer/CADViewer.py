...
class AppFrame(wx.Frame):
    ...
    def LoadFile(self,filename):
        ...
        if extension =="step" or extension == "stp":
            from OCC.Utils.DataExchange import STEPImporter
            stepReader = STEPImporter(str(filename))#Control.STEPControl_Reader()
            shape = stepReader.ReadFile().GetShapes()#stepReader.ReadFile(str(filename))
